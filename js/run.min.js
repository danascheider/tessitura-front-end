...
var UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],klass:"UserModelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","ModelView")},events:{"dblclick span.p":"displayInput","keypress input":"triageKeypress"},displayInput:function(e){this.$(".input").hide(),this.$(".p").show(),span=$(e.target)[0]&&$(e.target)[0].className.match(/profile-field/)?$(e.target):$(e.target).closest("span.profile-field"),span.find(".p").hide(),span.find(".input").show(),span.find("input").focus().select()},renderOnSync:function(){this.render()},submitUpdate:function(e){e.preventDefault();var t={};t[$(e.target).attr("name")]=$(e.target)[0].value,this.model.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},error:function(e,t,s){console.log(t)},success:function(){$(e.target).closest("span.input").hide()}})},triageKeypress:function(e){var t=13===e.keyCode,s=$(e.target).attr("name"),i=$(e.target)[0].value;t&&this.hideInputs(),t&&i!==this.model.get(s)&&""!==i&&this.submitUpdate(e)},hideInputs:function(){this.$("span.input").hide(),this.$("span.p").show()},initialize:function(){this.listenTo(this.model,"sync",this.renderOnSync)},render:function(){var e=this;return this.$el.html(this.template({model:e.model})),this}});module.exports=UserModelView;

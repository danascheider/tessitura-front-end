...
},{"../templates/jst.js":46,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":73,"./api.js":5,"./utils.js":19,"./views/backboneViewMods.js":23,"backbone":39,"bootstrap-sass":40,"buffer":1,"jquery":42,"jquery.cookie":41,"underscore":44}],10:[function(require,module,exports){
...
},{"../../vendor/backbone-route-filter.js":72}],17:[function(require,module,exports){
(function (global){
...
},{"backbone":39,"underscore":44}],24:[function(require,module,exports){
...
var UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],klass:"UserModelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","ModelView")},events:{"dblclick span.p":"displayInput","keydown input":"triageKeypress"},displayInput:function(e){span=$(e.target).attr("class")&&$(e.target).attr("class").match(/profile-field/)?$(e.target):$(e.target).closest("span.profile-field"),span.find(".p").hide(),span.find(".input").show(),this.resizeInputs(span),span.find("input").focus().select()},submitUpdate:function(e){e.preventDefault();var t={};t[$(e.target).attr("name")]=$(e.target)[0].value,this.model.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},error:function(e,t,s){console.log(t)},success:function(){$(e.target).closest("span.input").hide()}})},triageKeypress:function(e){var t=13===e.keyCode,s=9===e.keyCode,i=$(e.target).attr("name"),n=$(e.target)[0].value;if(t&&(this.hideInputs(),n!==this.model.get(i)&&""!==n&&this.submitUpdate(e)),s){e.preventDefault();var a,a=$(e.target).closest("tr").next().find("td > span.profile-field");a="first_name"===$(e.target).closest(".profile-field").attr("id")?this.$("#last_name"):a,(n===this.model.get(i)||""===n)&&this.hideInputs(),(n===this.model.get(i)||""===n)&&this.hideInputs(),a.find(".p").hide(),a.find(".input").show(),this.resizeInputs(a),a.find("input").focus().select()}},hideInputs:function(){this.$("span.input").hide(),this.$("span.p").show()},resizeInputs:function(e){if(["first_name","last_name"].indexOf(e.attr("id"))>-1){var t=parseInt(e.find(".p").css("width").match(/\d*/)[0])+10;e.find("input").css("width",t+"px")}},initialize:function(){this.listenTo(this.model,"sync",this.render)},render:function(){var e=this;return Tessitura.View.prototype.render.call(e,e.template({model:e.model}))}});module.exports=UserModelView;
},{}],29:[function(require,module,exports){
var UserProfileView=Tessitura.View.extend({className:"user-profile",id:"page-wrapper",template:JST["users/profile"],events:{click:"hideInputs"},klass:"UserProfileView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","DashboardProfileView")},hideInputs:function(e){$(e.target).is("input")||this.modelView.hideInputs()},setUser:function(e){return this.model=e,this.modelView=new Tessitura.UserModelView({model:e}),this.childViews=[this.modelView],this},initialize:function(e){e=e||{},e.model&&this.setUser(e.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template({model:e.model}),function(){e.modelView.render(),e.$("#profile-tab > h4").first().after(e.modelView.$el)})}});module.exports=UserProfileView;
...
},{"moment":43}],31:[function(require,module,exports){
...
require("../../js/dependencies.js");var testing=require("../../js/apiOptions.js").useTestRouter,TestRouter=Tessitura.Router.extend({});module.exports=TestRouter;
},{"../../js/apiOptions.js":6,"../../js/dependencies.js":9}],46:[function(require,module,exports){
...
},{"backbone":39,"underscore":44}],73:[function(require,module,exports){

...
Tessitura.ErrorPanelView=Tessitura.View.extend({className:"panel panel-danger",id:"error-panel",template:_.template(JST["partials/errorPanel"]),initialize:function(e){this.errors=e},render:function(){var e=this.template({errors:this.errors});return Tessitura.View.prototype.render.call(this,e)}}),module.exports=Tessitura.ErrorPanelView;

...
Tessitura.TaskPanelView=Tessitura.DashWidgetView.extend({id:"task-panel",template:JST["partials/taskPanel"],klass:"TaskPanelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.DashWidgetView.prototype.types().concat(["TaskPanelView","TaskPanel","TaskView","PartialView"])},crossOff:function(e){if("Complete"===e.get("status")){var i=this,t=this.retrieveViewForModel(e);setTimeout(function(){t&&(i.childViews.splice(i.childViews.indexOf(t),1),t.destroy()),i.collection.remove(e)},750)}},filterCollection:function(){var e=_.filter(this.collection.models,function(e){return"Blocking"!==e.get("status")&&!e.get("backlog")});return e},removeChildAndRender:function(e){var i=this.retrieveViewForModel(e),t=this.childViews.indexOf(i);this.childViews.slice(t,1),this.render()},retrieveViewForModel:function(e){if(this.childViews.length){var i=_.filter(this.childViews,function(i){return i.model===e});return i[0]}},showTaskCreateForm:function(e){this.trigger("showTaskCreateForm",{collection:this.collection})},renderCollection:function(){var e=this,i=0,t=document.createDocumentFragment();return this.collection.each(function(s){if(!(i>9||"Blocking"===s.get("status")||"Complete"===s.get("status")||s.get("backlog"))){var o=e.retrieveViewForModel(s)||new Tessitura.TaskListItemView({model:s});-1===e.childViews.indexOf(o)&&e.childViews.push(o),o.render(),t.appendChild(o.el),i++}}),this.$("ul.task-list").append(t),this},initialize:function(e){this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection}),this.childViews=[this.quickAddForm],this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"change:backlog",this.render),this.listenTo(this.collection,"drop",this.removeStyles),this.listenTo(this.collection,"remove",this.removeChildAndRender),this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderCollection(),e.$("ul").sortable({items:">*:not(.not-sortable)"})})}}),module.exports=Tessitura.TaskPanelView;

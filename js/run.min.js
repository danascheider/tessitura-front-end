...
Tessitura.DashboardLocalView=Tessitura.View.extend({id:"page-wrapper",template:JST["partials/dashLocal"],setUser:function(e){this.user=e},initialize:function(e){e=e||{},e.user&&this.setUser(e.user)},render:function(){var e=this.template({model:this.user});return Tessitura.View.prototype.render.call(this,e)}}),module.exports=Tessitura.DashboardLocalView;

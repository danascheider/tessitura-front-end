...
Tessitura.KanbanColumnView=Tessitura.View.extend({template:JST["partials/kanbanCol"],className:"panel dash-widget kanban-column",crossOff:function(e){"Complete"!==e.get("status")&&this.collection.remove(e);var t=this,i=this.retrieveViewForModel(e);setTimeout(function(){i&&(t.childViews.splice(t.childViews.indexOf(i),1),i.destroy()),t.collection.remove(e)},750)},removeTask:function(e){this.groupedBy.backlog&&e.get("backlog")||this.collection.remove(e)},updateAndRender:function(e){var t=this.groupedBy;!this.groupedBy.backlog&&e.get("backlog")&&(t.backlog=!1),e.save(t)},renderModels:function(){for(var e=this,t=document.createDocumentFragment(),i=Object.keys(this.groupedBy)[0],s=0;s<this.collection.length;s++){var o=this.collection.models[s];if(!o.get("backlog")||"backlog"===i){var n=e.retrieveViewForModel(o)||new Tessitura.TaskListItemView({model:o,width:30});-1===e.childViews.indexOf(n)&&e.childViews.push(n),n.render(),t.appendChild(n.el)}}return this.$("ul.task-list").append(t),this},retrieveViewForModel:function(e){if(this.childViews.length){var t;return _.each(this.childViews,function(i){i.model&&i.model.get("id")===e.get("id")&&(t=i)}),t}},initialize:function(e){e=e||{},_.extend(this,e),_.extend(this.models,Backbone.Events),this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection,groupedBy:this.groupedBy}),this.childViews=[this.quickAddForm],this.$el.addClass("panel-"+this.color),this.listenTo(this.collection,"add",this.updateAndRender),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.collection,"change:status",this.crossOff)},remove:function(){this.childViews.length&&_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;Tessitura.View.prototype.render.call(this,this.template({data:this}),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderModels(),e.$("ul.task-list").sortable({items:">*:not(.not-sortable)"})})}}),module.exports=Tessitura.KanbanColumnView;

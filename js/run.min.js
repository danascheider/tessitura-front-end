...
Tessitura.OrganizationCollectionView=Tessitura.View.extend({id:"organization-list",initialize:function(){this.childViews=[]}}),module.exports=Tessitura.OrganizationCollectionView;
...
Tessitura.DashboardLocalView=Tessitura.View.extend({id:"page-wrapper",template:JST["partials/dashLocal"],setUser:function(e){this.user=e},events:{"submit #location-form":"updateProfile"},updateProfile:function(e){e.preventDefault();var t={},s=this,t=Tessitura.Utils.getAttributes($(e.target));this.user.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},success:function(){s.$("#location-form").closest(".alert").hide()},error:function(e,t){console.log("Unable to update user profile - error ",t)}})},setUser:function(e){this.user=e},initialize:function(e){e=e||{},e.user&&this.setUser(e.user)},render:function(){var e=this.template({model:this.user});return Tessitura.View.prototype.render.call(this,e)}}),module.exports=Tessitura.DashboardLocalView;
...
},{"backbone":49,"underscore":54}],78:[function(require,module,exports){

...
},{"../templates/jst.js":55,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":81,"./api.js":5,"./utils.js":19,"./views/backboneViewMods.js":23,"backbone":47,"bootstrap-sass":48,"buffer":1,"jquery":50,"jquery.cookie":49,"underscore":52}],10:[function(require,module,exports){
...
},{"../../vendor/backbone-route-filter.js":80}],17:[function(require,module,exports){
(function (global){
...
},{"moment":51}],30:[function(require,module,exports){
...
var UserProfileView=Tessitura.View.extend({className:"user-profile",template:_.template("<div></div>"),klass:"UserProfileView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","DashboardProfileView")},setUser:function(e){return this.model=e,this.modelView=new Tessitura.UserModelView({model:e}),this.childViews=[this.modelView],this},initialize:function(e){e=e||{},e.model&&this.setUser(e.model)},render:function(){return this.$el.html(this.template()),this}});module.exports=UserProfileView;
...
},{"backbone":47,"underscore":52}],81:[function(require,module,exports){

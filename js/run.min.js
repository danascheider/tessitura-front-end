...
Tessitura.TaskCreateFormView=Tessitura.View.extend({tagName:"form",id:"task-create-form",template:JST["tasks/createForm"],events:{submit:"createTask"},createTask:function(e){e.preventDefault();var t=Tessitura.Utils.getAttributes(this.$el),r=this;return t.title?void r.collection.create(t,{success:function(){r.trigger("hideShade")}}):void this.$("input[name=title]").closest(".form-group").addClass("has-error")},setCollection:function(e){return this.collection=e,this},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.TaskCreateFormView;

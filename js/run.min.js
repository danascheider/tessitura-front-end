...
},{"backbone":40,"underscore":45}],8:[function(require,module,exports){
...
Tessitura.DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,klass:"DashboardView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardView","MainDashboardView","Dashboard","MainDashboard","TopLevelView"])},events:{click:"hideDropdownMenus","click .internal-link":"followLink",dblclick:"hideSidebar","click .navbar-header":"toggleSidebar"},emitRedirect:function(e){"dashboard"===e.destination?this.redirectToDashboard():"tasks"===e.destination?this.redirectToTaskPage():this.redirectToProfile()},followLink:function(e){var i=$(e.target).closest(".internal-link"),s=i.attr("data-target");this.emitRedirect({destination:s})},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},hideSidebar:function(e){var i=$(e.target);i!=this.sidebarView.$el&&0===this.$(".navbar-static-side").has(i).length&&this.sidebarView.$el.is(":visible")&&this.$(".sidebar-collapse").hide()},redirectToDashboard:function(){this.trigger("redirect",{destination:"dashboard"}),this.$(".sidebar-collapse").slideUp()},redirectToProfile:function(){this.trigger("redirect",{destination:"profile"}),this.$(".sidebar-collapse").slideUp()},redirectToTaskPage:function(){this.trigger("redirect",{destination:"tasks"}),this.$(".sidebar-collapse").slideUp()},toggleSidebar:function(){this.$("li.dropdown").removeClass("open"),this.$(".sidebar-collapse").slideToggle()},setUser:function(e){this.user=e,this.homeView.setUser(e),this.profileView.setUser(e),this.taskView.setUser(e)},showHomeView:function(){this.$el.is(":visible")||this.render(),_.each(this.childViews,function(e){e.$el.is(":visible")&&e!==this.sidebarView&&e!==this.homeView&&e.remove()}),this.homeView.render(),this.$("nav").after(this.homeView.$el)},showProfileView:function(){this.$el.is(":visible")||this.render(),_.each(this.childViews,function(e){e.$el.is(":visible")&&e!==this.sidebarView&&e!==this.profileView&&e.remove()}),this.profileView.render(),this.$("nav").after(this.profileView.$el)},showTaskView:function(){this.$el.is(":visible")||this.render(),_.each(this.childViews,function(e){e.$el.is(":visible")&&e!==this.sidebarView&&e!==this.taskView&&e.remove()}),this.taskView.render(),this.$("nav").after(this.taskView.$el)},initialize:function(e){e=e||{},this.sidebarView=new Tessitura.DashboardSidebarView,this.homeView=new Tessitura.DashboardHomeView,this.profileView=new Tessitura.DashboardProfileView,this.taskView=new Tessitura.DashboardTaskView,this.childViews=[this.sidebarView,this.homeView,this.profileView,this.taskView],e.user&&this.setUser(e.user),this.listenTo(this.homeView,"all",this.emitRedirect)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(e.user.attributes),function(){e.sidebarView.render(),e.$("div.sidebar-collapse").html(e.sidebarView.$el)})}}),module.exports=Tessitura.DashboardView;
...
},{"../../../models/taskModel.js":11}],27:[function(require,module,exports){
...
Tessitura.UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],klass:"UserModelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","ModelView")},events:{"dblclick span.p":"displayInput","keydown input":"triageKeypress"},displayInput:function(t){var e=t.target?$(t.target).attr("class")&&$(t.target).attr("class").match(/profile-field/)?$(t.target):$(t.target).closest(".profile-field"):$(t);e.find(".p").hide(),e.find(".input").show(),this.resizeInputs(e),e.find("input").focus().select()},submitUpdate:function(t){var e={};e[$(t.target).attr("name")]=$(t.target)[0].value,this.model.save(e,{beforeSend:function(t){t.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},error:function(t,e,i){console.log(e)},success:function(){$(t.target).closest("span.input").hide()}})},triageKeypress:function(t){var e=13===t.keyCode,i=9===t.keyCode,s=$(t.target).attr("name"),a=$(t.target)[0].value;if(e&&(this.hideInputs(),a!==this.model.get(s)&&""!==a&&this.submitUpdate(t)),i){t.preventDefault();var n="first_name"===$(t.target).closest(".profile-field").attr("id")?this.$("#last_name"):$(t.target).closest("tr").next().find("td > span.profile-field");this.model.get(s)!==a&&""!==a&&this.submitUpdate(t),this.displayInput(n)}},updateDisplay:function(){var t=this;this.$(".profile-field").each(function(e,i){var s=$(i).attr("id"),a=t.model.get(s);$(i).find(".p").html(a||"N/A"),$(i).find("input").attr("value",a)})},hideInputs:function(){this.$("span.input").hide(),this.$("span.p").show()},resizeInputs:function(t){if(["first_name","last_name"].indexOf(t.attr("id"))>-1){var e=parseInt(t.find(".p").css("width").match(/\d*/)[0])+10;t.find("input").css("width",e+"px")}},initialize:function(){this.listenTo(this.model,"sync",this.updateDisplay)},render:function(){var t=this;return Tessitura.View.prototype.render.call(t,t.template({model:t.model}))}}),module.exports=Tessitura.UserModelView;
...
},{"moment":44}],31:[function(require,module,exports){
...
},{"./modelTemplates/taskTemplates/quickAddFormTemplate.js":47,"./modelTemplates/taskTemplates/taskListItemTemplate.js":48,"./modelTemplates/userTemplates/userModelTemplate.js":49,"./modelTemplates/userTemplates/userProfileTemplate.js":50,"./partialTemplates/calendarTemplate.js":51,"./partialTemplates/dashboardHomeTemplate.js":52,"./partialTemplates/dashboardProfileTemplate.js":53,"./partialTemplates/dashboardSidebarTemplate.js":54,"./partialTemplates/dashboardTaskTemplate.js":55,"./partialTemplates/dashboardTopWidgetTemplate.js":56,"./partialTemplates/kanbanColumnTemplate.js":57,"./partialTemplates/loginFormTemplate.js":58,"./partialTemplates/registrationFormTemplate.js":59,"./partialTemplates/taskPanelTemplate.js":60,"./specTemplates/dashboardHomeSpecTemplate.js":61,"./specTemplates/dashboardSidebarSpecTemplate.js":62,"./specTemplates/dashboardSpecTemplate.js":63,"./specTemplates/dashboardTaskSpecTemplate.js":64,"./specTemplates/dashboardTopWidgetSpecTemplate.js":65,"./specTemplates/homepageSpecTemplate.js":66,"./specTemplates/taskCollectionSpecTemplate.js":67,"./specTemplates/taskListItemSpecTemplate.js":68,"./specTemplates/taskPanelSpecTemplate.js":69,"./topLevelTemplates/dashboardTemplate.js":70,"./topLevelTemplates/homepageTemplate.js":71,"underscore":45}],47:[function(require,module,exports){
...
},{"backbone":40,"underscore":45}],73:[function(require,module,exports){

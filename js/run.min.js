...
Tessitura.RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},reqdFields:["username","password","email","first_name","last_name"],createUser:function(r){r.preventDefault();var s=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(s)!==!0)return void(this.errorPanelView.errors=this.errors);var e=new Tessitura.UserModel,a=btoa(s.username+":"+s.password),t=this;delete s.passwordConfirmation,delete s.emailConfirmation,e.save(s,{success:function(r){$.cookie("auth",a),$.cookie("userID",r.id),t.trigger("userCreated",{user:e})}})},removeError:function(){this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){var r=!this.$("input[name=acceptTerms]").prop("checked");this.$("input[name=acceptTerms]").prop(r),this.removeError()},validateForm:function(r){var s,e,a;return s=!!r.acceptTerms,s||(this.$("fieldset.form-group.terms").addClass("has-error"),s=!1),e=this.validCreds(r.username,r.password,r.passwordConfirmation,r.email,r.emailConfirmation),a=this.validName(r.first_name,r.last_name),delete r.acceptTerms,s&&e&&a},validCreds:function(r,s,e,a,t){this.errors=this.errors||[];var i=this.validPassword(s,e),o=this.validUsername(r),n=this.validEmail(a,t);return s&&-1!==s.indexOf(r)&&(this.errors.push("Password cannot contain username"),i=!1),i&&o&&n},validEmail:function(r,s){this.errors=this.errors||[];var e=!0,a=!0;return r||(this.errors.push("E-mail is required"),e=!1),s||(this.errors.push("E-mail confirmation is required"),a=!1),r&&!r.match(/(\S+)@(\S+)\.(\S+)/)&&(this.errors.push("Not a valid e-mail address"),e=!1),r&&s&&r!==s&&(this.errors.push("E-mail and e-mail confirmation don't match"),e=!1,a=!1),e||this.$("input[name=email]").addClass("has-error"),a||this.$("input[name=emailConfirmation]").addClass("has-error"),e&&a},validName:function(r,s){this.errors=this.errors||[];var e=!0,a=!0;return r||(this.errors.push("First name is required"),e=!1),s||(this.errors.push("Last name is required"),a=!1),r&&r.length<2&&(this.errors.push("First name must be at least 2 characters long"),e=!1),s&&s.length<2&&(this.errors.push("Last name must be at least 2 characters long"),a=!1),r&&!r.match(/^[A-Za-z\-' ]*$/)&&(this.errors.push("First name may only contain letters, spaces, ', and -"),e=!1),s&&!s.match(/^[A-Za-z\-' ]*$/)&&(this.errors.push("Last name may only contain letters, spaces, ', and -"),a=!1),e||this.$("input[name=first_name]").addClass("has-error"),a||this.$("input[name=last_name]").addClass("has-error"),e&&a},validPassword:function(r,s){this.errors=this.errors||[];var e=!0,a=!0;return r||(this.errors.push("Password is required"),e=!1),s||(this.errors.push("Password confirmation is required"),a=!1),r&&r.length<8&&(this.errors.push("Password must be at least 8 characters long"),e=!1,a=!1),!r||r.match(/[A-Za-z]/)&&r.match(/[0-9]/)||(this.errors.push("Password must contain at least 1 letter and 1 number"),e=!1,a=!1),r&&s&&r!==s&&(this.errors.push("Password and password confirmation don't match"),e=!1,a=!1),e||this.$("input[name=password]").addClass("has-error"),e||this.$("input[name=password]").addClass("has-error"),e&&a},validUsername:function(r){this.errors=this.errors||[];var s=!0;return r||(s=!1,this.errors.push("Username is required")),r&&r.length<6&&(s=!1,this.errors.push("Username must be at least 6 characters long")),r&&!r.match(/^[A-Za-z0-9_\- ]*$/)&&(s=!1,this.errors.push("Username may contain only alphanumeric characters, spaces, _, and -")),s||this.$("input[name=username]").addClass("has-error"),s},initialize:function(){this.errorPanelView=new Tessitura.ErrorPanelView},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.RegistrationFormView;

...
var opts={useTestRouter:!1,useTestAPI:!1};module.exports=opts;
},{}],7:[function(require,module,exports){
Tessitura=Tessitura||require("../dependencies.js");var ProtectedCollection=Backbone.Collection.extend({token:function(){return"Basic "+$.cookie("auth")},klass:"ProtectedCollection",family:"Backbone.Collection",superFamily:"Backbone.Collection",destroy:function(){this.reset([]),this.stopListening()},isA:function(e){return["Backbone.Collection","ProtectedCollection"].indexOf(e)>-1?!0:!1},fetch:function(e){e=e||{};var t=this;e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",t.token())},Backbone.Collection.prototype.fetch.call(this,e)}});module.exports=ProtectedCollection;
},{"../dependencies.js":9}],8:[function(require,module,exports){
var TaskCollection=Tessitura.ProtectedCollection.extend({model:Tessitura.TaskModel,comparator:"position",url:function(){return Tessitura.API.tasks.collection($.cookie("userID"))},klass:"TaskCollection",family:"ProtectedCollection",superFamily:"Backbone.Collection",isA:function(e){var o=["TaskCollection","Backbone.Collection","ProtectedCollection"];return o.indexOf(e)>-1?!0:!1},fetch:function(e){e=e||{},e.url||(e.url=e.all===!0?Tessitura.API.tasks.fullCollection($.cookie("userID")):this.url()),delete e.all,Tessitura.ProtectedCollection.prototype.fetch.call(this,e)}});module.exports=TaskCollection;
},{}],9:[function(require,module,exports){
(function (global,Buffer){
global.document=window.document,global.navigator=window.navigator,global.Tessitura={API:require("./api.js"),Utils:require("./utils.js")},global.$=global.jQuery=require("jquery"),global._=require("underscore"),global.Backbone=require("backbone"),global.JST=require("../templates/jst.js"),global.btoa=function(e){return new Buffer(e).toString("base64")},Backbone.$=$,require("jquery.cookie"),require("bootstrap-sass"),require("../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js"),require("./views/backboneViewMods.js"),module.exports=Tessitura;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer)

},{"../templates/jst.js":55,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":82,"./api.js":5,"./utils.js":19,"./views/backboneViewMods.js":23,"backbone":47,"bootstrap-sass":48,"buffer":1,"jquery":50,"jquery.cookie":49,"underscore":52}],10:[function(require,module,exports){
var ProtectedResource=Tessitura.Model.extend({token:function(){return"Basic "+$.cookie("auth")},klass:"ProtectedResourceModel",destroy:function(e){e=e||{};var t=this;return e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",t.token())},Backbone.Model.prototype.destroy.call(this,e)},fetch:function(e){e=e||{};var t=this;return e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",t.token())},Backbone.Model.prototype.fetch.call(this,e)},save:function(e,t){t=t||{},e=e||this.attributes;var o=this;return t.beforeSend=function(e){e.setRequestHeader("Authorization",o.token())},Backbone.Model.prototype.save.call(this,e,t)},types:function(){return Tessitura.Model.prototype.types().concat(["ProtectedResourceModel","ProtectedResource"])}});module.exports=ProtectedResource;
},{}],11:[function(require,module,exports){
Tessitura=Tessitura||require("../dependencies.js"),Tessitura.ProtectedResourceModel=Tessitura.ProtectedResourceModel||require("./protectedResourceModel.js");var TaskModel=Tessitura.ProtectedResourceModel.extend({urlRoot:function(){return Tessitura.API.tasks.collection($.cookie("userID"))},url:function(){return Tessitura.API.tasks.single(this.get("id"))},defaults:{priority:"Normal",status:"New"},klass:"TaskModel",parent:"ProtectedResourceModel",types:function(){return Tessitura.ProtectedResourceModel.prototype.types().concat(["TaskModel","Task"])},complete:function(){return"Complete"===this.get("status")},displayTitle:function(e){var e=e||60,t=this.get("title");if(t.length>e){var r=t.substring(0,e-1).split(" ");return r.pop(),r.join(" ")+" ..."}return t},incomplete:function(){return"Complete"!=this.get("status")},prettyDeadline:function(){var e=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],t=["January","February","March","April","May","June","July","August","September","October","November","December"],r=new Date(this.escape("deadline")),s=e[r.getDay()]+", "+t[r.getMonth()]+" "+r.getDate()+", "+r.getFullYear();return s},fetch:function(e){return e=e||{},e.url=e.url||this.url(),Tessitura.ProtectedResourceModel.prototype.fetch.call(this,e)},initialize:function(){},save:function(e,t){return e=e||this.attributes,t=t||{},t.url=this.isNew()?this.urlRoot():this.url(),Tessitura.ProtectedResourceModel.prototype.save.call(this,e,t)},validate:function(e){return e.title?void 0:"Title is required"}});module.exports=TaskModel;
},{"../dependencies.js":9,"./protectedResourceModel.js":10}],12:[function(require,module,exports){
...
(function (Buffer){
require("../dependencies.js");var UserModel=Tessitura.Model.extend({urlRoot:Tessitura.API.users.collection,klass:"UserModel",types:function(){return Tessitura.Model.prototype.types().concat(["UserModel","User"])},login:function(e){e=e||{};var t=this;return e.type=e.type||"POST",e.url=Tessitura.API.login,e.beforeSend=function(e){e.setRequestHeader("Authorization","Basic "+btoa(t.get("username")+":"+t.get("password")))},Tessitura.Model.prototype.fetch.call(this,e)},protectedFetch:function(e){e=e||{};return e.url=Tessitura.API.users.single(this.get("id")),e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},Backbone.Model.prototype.fetch.call(this,e)},fetch:function(e){e=e||{};var t=this.get("username")+":"+this.get("password"),s="Basic "+new Buffer(t).toString("base64");return e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",s)},Backbone.Model.prototype.fetch.call(this,e)},initialize:function(e,t){t=t||{},this.tasks=new Tessitura.TaskCollection}});module.exports=UserModel;
}).call(this,require("buffer").Buffer)

},{"../dependencies.js":9,"buffer":1}],14:[function(require,module,exports){
Tessitura=Tessitura||require("../dependencies.js");var AppPresenter=Tessitura.Model.extend({klass:"AppPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["AppPresenter","Presenter"])},isAn:function(e){return this.isA(e)},emitRedirect:function(e){this.trigger("redirect",e)},getHomepage:function(){this.homepageView.render(),this.homepageView.$el.is(":visible")||$("body").html(this.homepageView.$el)},removeAll:function(){this.homepageView.remove()},initialize:function(){this.homepageView=new Tessitura.HomepageView,this.listenTo(this.homepageView,"redirect",this.emitRedirect)}});module.exports=AppPresenter;
},{"../dependencies.js":9}],15:[function(require,module,exports){
var DashboardPresenter=Tessitura.Model.extend({klass:"DashboardPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["Presenter","DashboardPresenter"])},getHome:function(){this.showDash(),this.dashboardView.showHomeView(),this.current="home"},getProfile:function(){this.showDash(),this.dashboardView.showProfileView(),this.current="profile"},getTask:function(){this.showDash(),this.dashboardView.showTaskView(),this.current="task"},emitRedirect:function(e){this.trigger("redirect",e)},removeAll:function(){this.dashboardView.remove()},setUser:function(e,s){var t=this;this.user&&this.user.get("id")===e.get("id")||(this.user=e,this.user.protectedFetch({success:function(){t.user.tasks.fetch({success:function(i){t.dashboardView.setUser(e),s&&s(i)}})}}))},showDash:function(){this.dashboardView.$el.is(":visible")||(this.dashboardView.render(),$("body").html(this.dashboardView.$el))},initialize:function(e){e=e||{},this.dashboardView=new Tessitura.DashboardView,e.user&&this.setUser(e.user),_.bindAll(this,"showDash","getHome","getTask","setUser","emitRedirect","removeAll"),this.listenTo(this.dashboardView,"redirect",this.emitRedirect)}});module.exports=DashboardPresenter;
},{}],16:[function(require,module,exports){
require("../../vendor/backbone-route-filter.js"),Tessitura.Router=Backbone.Router.extend({klass:"Tessitura.Router",types:function(){return["Tessitura.Router","Router","Backbone.Router"]},isA:function(e){return this.types().indexOf(e)>-1?!0:!1},initialize:function(){this.AppPresenter=new Tessitura.AppPresenter,this.DashboardPresenter=new Tessitura.DashboardPresenter,this.listenTo(this.AppPresenter,"redirect",this.navigateTo),this.listenTo(this.DashboardPresenter,"redirect",this.navigateTo)},navigateTo:function(e){e.user&&["dashboard","tasks"].indexOf(e.destination)>-1&&this.DashboardPresenter.setUser(e.user),this.navigate(e.destination,{trigger:!0})},userLoggedIn:function(){return!!$.cookie("userID")&&!!$.cookie("auth")},routes:{"(/)":"displayHomepage","home(/)":"displayHomepage","dashboard(/)":"displayDashboardHome","tasks(/)":"displayDashboardTaskView","logout(/)":"logOut","prepare(/)":"prepareTestEnvironment","profile(/)":"displayProfile","*actions":"defaultAction"},before:{"dashboard(/)":"verifyLoggedIn","tasks(/)":"verifyLoggedIn","(/)":"rerouteIfLoggedIn"},defaultAction:function(e){console.log("No route for ",e)},displayDashboardHome:function(){var e=this,s=new Tessitura.UserModel({id:$.cookie("userID")});s.tasks=new Tessitura.TaskCollection,this.DashboardPresenter.setUser(new Tessitura.UserModel({id:$.cookie("userID")}),function(){e.DashboardPresenter.getHome()})},displayDashboardTaskView:function(){var e=this,s=new Tessitura.UserModel({id:$.cookie("userID")});s.tasks=new Tessitura.TaskCollection,this.DashboardPresenter.setUser(s,function(){e.DashboardPresenter.getTask()})},displayHomepage:function(){this.DashboardPresenter.removeAll(),this.AppPresenter.getHomepage()},displayProfile:function(){var e=this,s=new Tessitura.UserModel({id:$.cookie("userID")});s.tasks=new Tessitura.TaskCollection,this.DashboardPresenter.setUser(s,function(){e.DashboardPresenter.getProfile()})},logOut:function(){$.removeCookie("auth"),$.removeCookie("userID"),this.navigate("",{trigger:!0})},prepareTestEnvironment:function(){$.ajax({type:"DELETE",url:"http://api.canto-test.com:1025/destroy"})},rerouteIfLoggedIn:function(e,s,t){this.userLoggedIn()?(this.AppPresenter.removeAll(),this.navigate("dashboard",{trigger:!0})):t()},verifyLoggedIn:function(e,s,t){this.userLoggedIn()?t():this.navigate("/",{trigger:!0})}}),module.exports=Tessitura.Router;
},{"../../vendor/backbone-route-filter.js":81}],17:[function(require,module,exports){
(function (global){
require("./tessitura.js");var test=require("./apiOptions.js").useTestRouter;global.Router=test===!0?new Tessitura.TestRouter:new Tessitura.Router,Backbone.history.start();
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./apiOptions.js":6,"./tessitura.js":18}],18:[function(require,module,exports){
Tessitura=require("./dependencies.js"),Tessitura.Model=require("./models/tessituraModel.js"),Tessitura.ProtectedResourceModel=require("./models/protectedResourceModel.js"),Tessitura.TaskModel=require("./models/taskModel.js"),Tessitura.UserModel=require("./models/userModel.js"),Tessitura.ProtectedCollection=require("./collections/protectedCollection.js"),Tessitura.TaskCollection=require("./collections/taskCollection.js"),Tessitura.View=require("./views/appViews/tessituraView.js"),Tessitura.DashboardView=require("./views/appViews/dashboardView.js"),Tessitura.HomepageView=require("./views/appViews/homepageView.js"),Tessitura.TaskModelView=require("./views/modelViews/taskViews/taskModelView.js"),Tessitura.QuickAddFormView=require("./views/modelViews/taskViews/quickAddFormView.js"),Tessitura.TaskListItemView=require("./views/modelViews/taskViews/taskListItemView.js"),Tessitura.UserModelView=require("./views/modelViews/userViews/userModelView.js"),Tessitura.UserProfileView=require("./views/modelViews/userViews/userProfileView.js"),Tessitura.TaskCollectionView=require("./views/collectionViews/taskCollectionView.js"),Tessitura.CalendarView=require("./views/partialViews/calendarView.js"),Tessitura.DashboardHomeView=require("./views/partialViews/dashboardHomeView.js"),Tessitura.DashboardSidebarView=require("./views/partialViews/dashboardSidebarView.js"),Tessitura.DashboardTopWidgetView=require("./views/partialViews/dashboardTopWidgetView.js"),Tessitura.DashboardTaskView=require("./views/partialViews/dashboardTaskView.js"),Tessitura.KanbanColumnView=require("./views/partialViews/kanbanColumnView.js"),Tessitura.LoginFormView=require("./views/partialViews/loginFormView.js"),Tessitura.RegistrationFormView=require("./views/partialViews/registrationFormView.js"),Tessitura.TaskPanelView=require("./views/partialViews/taskPanelView.js"),Tessitura.AppPresenter=require("./presenters/appPresenter.js"),Tessitura.DashboardPresenter=require("./presenters/dashboardPresenter.js"),Tessitura.Router=Tessitura.Router||require("./routers/tessituraRouter.js"),Tessitura.TestRouter=require("../spec/support/testRouter.js");
},{"../spec/support/testRouter.js":54,"./collections/protectedCollection.js":7,"./collections/taskCollection.js":8,"./dependencies.js":9,"./models/protectedResourceModel.js":10,"./models/taskModel.js":11,"./models/tessituraModel.js":12,"./models/userModel.js":13,"./presenters/appPresenter.js":14,"./presenters/dashboardPresenter.js":15,"./routers/tessituraRouter.js":16,"./views/appViews/dashboardView.js":20,"./views/appViews/homepageView.js":21,"./views/appViews/tessituraView.js":22,"./views/collectionViews/taskCollectionView.js":24,"./views/modelViews/taskViews/quickAddFormView.js":25,"./views/modelViews/taskViews/taskListItemView.js":26,"./views/modelViews/taskViews/taskModelView.js":27,"./views/modelViews/userViews/userModelView.js":28,"./views/modelViews/userViews/userProfileView.js":29,"./views/partialViews/calendarView.js":30,"./views/partialViews/dashboardHomeView.js":31,"./views/partialViews/dashboardSidebarView.js":32,"./views/partialViews/dashboardTaskView.js":33,"./views/partialViews/dashboardTopWidgetView.js":34,"./views/partialViews/kanbanColumnView.js":35,"./views/partialViews/loginFormView.js":36,"./views/partialViews/registrationFormView.js":37,"./views/partialViews/taskPanelView.js":38}],19:[function(require,module,exports){
...
var DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,klass:"DashboardView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardView","MainDashboardView","Dashboard","MainDashboard","TopLevelView"])},events:{click:"hideDropdownMenus",dblclick:"hideSidebar","click li.dropdown":"toggleDropdownMenu","click .navbar-header":"toggleSidebar","click a.dashboard-link":"redirectToDashboard","click a.task-page-link":"redirectToTaskPage","click a.link":"redirectToHref"},emitRedirect:function(e){"dashboard"===e.destination?this.redirectToDashboard():this.redirectToTaskPage()},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},hideSidebar:function(e){var i=$(e.target);i!=this.sidebarView.$el&&0===this.$(".navbar-static-side").has(i).length&&this.sidebarView.$el.is(":visible")&&this.$(".sidebar-collapse").hide()},redirectToDashboard:function(){this.trigger("redirect",{destination:"dashboard"}),this.$(".sidebar-collapse").slideUp()},redirectToHref:function(e){var i=$(e.target).closest("a"),s=i.attr("href").replace("/#","");this.trigger("redirect",{destination:s})},redirectToTaskPage:function(){this.trigger("redirect",{destination:"tasks"}),this.$(".sidebar-collapse").slideUp()},toggleDropdownMenu:function(e){var i=$(e.target).has("li");i.toggleClass("open"),$(e.target).blur()},toggleSidebar:function(){this.$("li.dropdown").removeClass("open"),this.$(".sidebar-collapse").slideToggle()},setUser:function(e){this.user=e,this.homeView.setUser(e),this.profileView.setUser(e),this.taskView.setUser(e),this.listenTo(this.user,"change:first_name change:last_name",this.render)},showHomeView:function(){this.$el.is(":visible")||this.render();var e=this;_.each(this.childViews,function(i){i.$el.is(":visible")&&i!==e.homeView&&i!==e.sidebarView&&i.remove()}),this.homeView.render(),this.$("nav").after(this.homeView.$el)},showProfileView:function(){this.$el.is(":visible")||this.render();var e=this;_.each(this.childViews,function(i){i.$el.is(":visible")&&i!==e.profileView&&i!==e.sidebarView&&i.remove()}),this.profileView.render(),this.$("nav").after(this.profileView.$el)},showTaskView:function(){this.$el.is(":visible")||this.render();var e=this;_.each(this.childViews,function(i){i.$el.is(":visible")&&i!==e.taskView&&i!==e.sidebarView&&i.remove()}),this.taskView.render(),this.$("nav").after(this.taskView.$el)},initialize:function(e){e=e||{},this.sidebarView=new Tessitura.DashboardSidebarView,this.homeView=new Tessitura.DashboardHomeView,this.profileView=new Tessitura.UserProfileView,this.taskView=new Tessitura.DashboardTaskView,this.childViews=[this.sidebarView,this.homeView,this.profileView,this.taskView],e.user&&this.setUser(e.user),this.listenTo(this.homeView,"all",this.emitRedirect)},remove:function(){this.sidebarView.remove(),Tessitura.View.prototype.remove.call(this),this.homeView.remove(),this.taskView.remove()},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(e.user.attributes),function(){e.sidebarView.render(),e.$("div.sidebar-collapse").html(e.sidebarView.$el)})}});module.exports=DashboardView;
},{}],21:[function(require,module,exports){
var HomepageView=Tessitura.View.extend({template:JST.homepage,id:"homepage-wrapper",events:{"click nav li .login-link":"toggleLoginForm","dblclick #shade":"hideLoginForm"},klass:"HomepageView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["HomepageView","TopLevelView"])},goToDashboard:function(e){var i=_.extend(e,{destination:"dashboard"});this.trigger("redirect",i)},hideLoginForm:function(e){var i=$(e.target);"login-form"!==i.attr("id")&&0===this.loginForm.$el.has(i).length&&(this.$("#shade").hide(),this.$("div.text-vertical-center").children().show())},toggleLoginForm:function(){$.cookie("auth")?this.trigger("redirect",{destination:"dashboard"}):(this.$("div.text-vertical-center").children().toggle(),this.$("#shade").toggle())},initialize:function(){this.loginForm=new Tessitura.LoginFormView,this.registrationForm=new Tessitura.RegistrationFormView,this.childViews=[this.loginForm,this.registrationForm],this.listenTo(this.registrationForm,"userCreated",function(){this.trigger("redirect",{destination:"dashboard"})}),this.listenTo(this.loginForm,"userLoggedIn",this.goToDashboard)},remove:function(){this.loginForm.remove(),this.registrationForm.remove(),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.registrationForm.render(),e.$("section#register div.col-md-12").html(e.registrationForm.$el),e.loginForm.render(),e.$("#shade").html(e.loginForm.$el)})}});module.exports=HomepageView;
},{}],22:[function(require,module,exports){
var TessituraView=Backbone.View.extend({klass:"Tessitura.View",family:"Backbone.View",superFamily:"",types:function(){return Backbone.View.prototype.types().concat(["Tessitura.View"])},isA:function(e){return this.types().indexOf(e)>-1?!0:!1},render:function(e,t,i){return this.$el.html(e),t&&t(i),this.delegateEvents(),this}});module.exports=TessituraView;
...
},{"backbone":47,"underscore":52}],24:[function(require,module,exports){
var TaskCollectionView=Tessitura.View.extend({tagName:"ul",className:"task-list",template:JST["collections/task"],klass:"TaskCollectionView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["TaskCollectionView","TaskView"])},crossOff:function(e){if("Complete"===e.get("status")){var i=this,t=this.retrieveViewForModel(e);setTimeout(function(){t&&t.destroy(),i.collection.remove(e)},750)}},fetchCollection:function(){this.collection.fetch()},removeBacklog:function(){for(var e=this.collection.where({backlog:!0}),i=0;i<e.length;i++){var t=this.retrieveViewForModel(e[i]);this.collection.remove(e[i]),t&&t.destroy()}},removeComplete:function(){for(var e=this.collection.where({status:"Complete"}),i=0;i<e.length;i++){var t=this.retrieveViewForModel(e[i]);this.collection.remove(e[i]),t&&t.destroy()}},showTaskCreateForm:function(){this.trigger("showTaskCreateForm",{collection:this.collection})},removeChildViews:function(){_.each(this.childViews,function(e){e.remove()})},removeStyles:function(){_.each(this.childViews,function(e){e.$el.removeAttr("style")})},renderCollection:function(){var e=this,i=document.createDocumentFragment();this.collection.each(function(t){var o=e.retrieveViewForModel(t)||new Tessitura.TaskListItemView({model:t});-1===e.childViews.indexOf(o)&&e.childViews.push(o),o.render(),i.appendChild(o.el)}),this.$el.append(i)},retrieveViewForModel:function(e){if(!this.childViews.length)return null;var i=_.filter(this.childViews,function(i){return i.model===e});return i[0]},initialize:function(e){e=e||{},this.grouping=e.grouping,this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection,grouping:this.grouping}),this.childViews=[this.quickAddForm],this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"remove",this.removeChildAndRender),this.listenTo(this.collection,"drop",this.removeStyles),this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm)},remove:function(){this.removeChildViews(),Backbone.View.prototype.remove.call(this)},removeChildAndRender:function(e){var i=this.retrieveViewForModel(e),t=this.childViews.indexOf(i);this.childViews.splice(t,1),this.render()},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$("li.quick-add-form").html(e.quickAddForm.$el),e.renderCollection(),e.$el.sortable({items:">*:not(.not-sortable)"})})}});module.exports=TaskCollectionView;
},{}],25:[function(require,module,exports){
var QuickAddFormView=Tessitura.View.extend({tagName:"form",className:"task-form create-form quick-add-form",template:JST["tasks/quickAdd"],events:{"click span.pull-right > i":"showTaskCreateForm",submit:"createTask"},klass:"QuickAddTaskFormView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["QuickAddForm","QuickAddFormView","TaskCollectionView","TaskFormView","TaskCreateFormView"])},createTask:function(e){e.preventDefault();{var t=this,i=Tessitura.Utils.getAttributes(this.$el);require("../../../models/taskModel.js")}if(_.each(this.grouping,function(e,t){i[t]=e}),i.position=i.position||1,i.title){var s=new Tessitura.TaskModel;s.save(i,{success:function(e){t.$el[0].reset(),t.collection.unshift(e)}})}},showTaskCreateForm:function(){this.trigger("showTaskCreateForm")},initialize:function(e){e=e||{},_.extend(this,e)},render:function(e){return Tessitura.View.prototype.render.call(this,this.template())}});module.exports=QuickAddFormView;
},{"../../../models/taskModel.js":11}],26:[function(require,module,exports){
var ListItemView=Tessitura.View.extend({tagName:"li",className:"task-list-item ui-widget-content ui-draggable",id:function(){return"task-"+this.model.get("id")},template:JST["tasks/listItem"],events:{"click i[title=Edit]":"showEditForm","click i[title=Delete]":"deleteTask","click i[title=Backlog]":"backlogTask","click .fa-square-o":"markComplete","click .task-title":"toggleTaskDetails",mouseenter:"showEditIcons",mouseleave:"hideEditIcons"},klass:"TaskListItemView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["TaskListItemView","ListItemView"])},backlogTask:function(){this.model.save({backlog:!0})},deleteTask:function(){this.model.destroy()},hideEditIcons:function(){this.$("span.edit-task").hide()},markComplete:function(){this.model.save({status:"Complete"}),this.$(".fa-square-o").removeClass("fa-square-o").addClass("fa-check-square-o"),this.$("a.task-title").css("text-decoration","line-through")},showEditForm:function(){},showEditIcons:function(){this.$("span.edit-task").show()},toggleTaskDetails:function(e){e&&e.preventDefault(),this.$el.toggleClass("open",{duration:400}),this.$(".task-details").slideToggle()},configureDraggable:function(){var e=this;this.$el.draggable({connectToSortable:".task-list",stop:function(){var t=$(this).closest(".kanban-col").find(".panel-heading").first().text().replace(/^ /,"");if(t)"Backlog"===t?e.model.save({backlog:!0}):e.model.save({backlog:!1,status:t.replace(/^ /,"")},{beforeSend:function(e){e.addRequestHeader("Authorization","Basic "+$.cookie("auth"))}});else{var i=e.$el.closest("ul").children("li.task-list-item"),s=e.model.collection,a=1;_.each(i,function(e){var t=s.get($(e).attr("id").match(/(\d+)/)[0]);t.get("position")!==a&&t.save({position:a})})}e.trigger("drop"),e.render()}})},initialize:function(){this.modelView=new Tessitura.TaskModelView({model:this.model}),this.childViews=[this.modelView]},remove:function(){this.modelView.remove(),Backbone.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.modelView.render(),e.$("td.task-listing").html(e.modelView.$el),e.configureDraggable(),e.$el.removeAttr("style")})}});module.exports=ListItemView;
},{}],27:[function(require,module,exports){
var TaskModelView=Tessitura.View.extend({tagName:"div",className:"task-model",template:JST["tasks/model"],klass:"TaskModelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat("TaskModelView")},renderOnSync:function(){"Complete"!==this.model.get("status")&&this.render()},initialize:function(){this.listenTo(this.model,"sync",this.renderOnSync)},render:function(){return Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}});module.exports=TaskModelView;
},{}],28:[function(require,module,exports){
var UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],klass:"UserModelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","ModelView")},events:{"dblclick span.p":"displayInput"},displayInput:function(e){this.$(".input").hide(),this.$(".p").show(),span=$(e.target)[0].className&&$(e.target)[0].match(/profile-field/)?$(e.target):$(e.target).closest("span.profile-field"),span.find(".input").show(),span.find(".p").hide()},renderOnSync:function(){this.render()},initialize:function(){this.listenTo(this.model,"sync",this.renderOnSync)},render:function(){var e=this;return this.$el.html(this.template({model:e.model})),this}});module.exports=UserModelView;
},{}],29:[function(require,module,exports){
var UserProfileView=Tessitura.View.extend({className:"user-profile",id:"page-wrapper",template:JST["users/profile"],klass:"UserProfileView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","DashboardProfileView")},setUser:function(e){return this.model=e,this.modelView=new Tessitura.UserModelView({model:e}),this.childViews=[this.modelView],this},initialize:function(e){e=e||{},e.model&&this.setUser(e.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template({model:e.model}),function(){e.modelView.render(),e.$("#profile-tab > h4").first().after(e.modelView.$el)})}});module.exports=UserProfileView;
},{}],30:[function(require,module,exports){
var moment=require("moment"),CalendarView=Tessitura.View.extend({template:JST.calendar,id:"calendar",className:"panel dash-widget panel-primary",klass:"CalendarView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["CalendarView","PartialView"])},displayDays:function(){for(var e=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],a=[],i=-1;2>i;i++)a.push(e[moment().add(i,"days").day()]);return a},initialize:function(e){},render:function(){return this.$el.html(this.template({days:this.displayDays()})),this}});module.exports=CalendarView;
},{"moment":51}],31:[function(require,module,exports){
var DashboardHomeView=Tessitura.View.extend({template:JST["partials/dashHome"],id:"page-wrapper",className:"dashboard-home",klass:"DashboardHomeView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardHomeView","PartialView"])},emitRedirect:function(e){this.trigger("redirect",{destination:e.destination})},renderCalendarView:function(){this.calendarView.render(),this.$("div.col-lg-8").first().html(this.calendarView.$el)},renderTaskPanelView:function(){this.taskPanelView.render(),this.$("div.col-lg-4").first().html(this.taskPanelView.$el)},renderTopWidgetView:function(){this.topWidgetView.render(),this.$(".row").first().html(this.topWidgetView.$el)},setUser:function(e){this.user=e,this.collection=this.user.tasks;var i=this;this.taskPanelView=new Tessitura.TaskPanelView({collection:this.collection}),this.topWidgetView=new Tessitura.DashboardTopWidgetView({taskCollection:i.user.tasks,deadlineCount:7,appointmentCount:4,recommendationCount:14}),this.calendarView=new Tessitura.CalendarView({user:this.user}),this.childViews=[this.calendarView,this.taskPanelView,this.topWidgetView],this.listenTo(this.topWidgetView,"redirect",this.emitRedirect)},initialize:function(e){e=e||{},e.user&&this.setUser(e.user)},remove:function(){try{this.calendarView.remove(),this.taskPanelView.remove(),this.topWidgetView.remove()}catch(e){if(!(this.calendarView&&this.taskPanelView&&this.topWidgetView))return}Tessitura.View.prototype.remove.call(this)},render:function(e){e=e||{};var i=this;return Tessitura.View.prototype.render.call(i,i.template(),function(){i.taskPanelView&&i.renderTaskPanelView(),i.topWidgetView&&i.renderTopWidgetView(),i.calendarView&&i.renderCalendarView()})}});module.exports=DashboardHomeView;
},{}],32:[function(require,module,exports){
var DashboardSidebarView=Tessitura.View.extend({tagName:"ul",className:"nav",id:"side-menu",template:JST["partials/sidebar"],events:{"click a.sidebar-link":"toggleSecondLevelNav","click li > .dashboard-link":"goToDashboard","click li > .task-page-link":"goToTaskPage"},klass:"DashboardSidebarView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardView","DashboardSidebarView","PartialView"])},goToDashboard:function(){this.trigger("redirect",{destination:"dashboard"})},goToTaskPage:function(){this.trigger("redirect",{destination:"tasks"})},toggleSecondLevelNav:function(e){var a=$(e.target).closest("li");a.hasClass("active")?a.removeClass("active").find(".nav-second-level").slideUp():(a.siblings("li").removeClass("active"),this.$(".nav-second-level:visible").slideUp(),a.addClass("active").find(".nav-second-level").slideDown()),""===a.className&&a.removeAttr("class")},getLocationHash:function(){return location.hash},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}});module.exports=DashboardSidebarView;
},{}],33:[function(require,module,exports){
var DashboardTaskView=Tessitura.View.extend({template:JST["partials/dashTasks"],id:"page-wrapper",klass:"DashboardTaskView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardTaskView"])},addToBacklog:function(e){this.backlogColumnView.collection.add([e])},changeStatus:function(e){var o=this.findNewCollection(e)||new Tessitura.TaskCollection;o.add([e])},findNewCollection:function(e){var o=this,i=e.get("status");return e.get("backlog")===!0?this.backlogColumnView.collection:void _.each([o.newColumnView,o.inProgressColumnView,o.blockingColumnView],function(e){return e.data.headline===i?e.collection:void 0})},removeFromBacklog:function(e){if(this.backlogColumnView.collection.models.indexOf(e)>-1){this.backlogColumnView.collection.remove(e);var o=this.findNewCollection(e);o.add([e])}},setUser:function(e){this.user=e},initialize:function(e){e=e||{},this.childViews=[],e.user&&this.setUser(e.user)},remove:function(){this.childViews&&this.childViews.length&&_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return this.user.tasks.fetch({success:function(o){o=new Tessitura.TaskCollection(o.models),e.backlogColumnView=new Tessitura.KanbanColumnView({el:e.$("#backlog-tasks"),collection:new Tessitura.TaskCollection(o.where({backlog:!0})),color:"red",icon:"fa-exclamation-circle",headline:"Backlog"}),o.remove(e.backlogColumnView.collection.models),e.newColumnView=new Tessitura.KanbanColumnView({el:e.$("#new-tasks"),collection:new Tessitura.TaskCollection(o.where({status:"New"})),color:"blue",icon:"fa-certificate",headline:"New"}),e.inProgressColumnView=new Tessitura.KanbanColumnView({el:e.$("#in-progress-tasks"),collection:new Tessitura.TaskCollection(o.where({status:"In Progress"})),color:"green",icon:"fa-road",headline:"In Progress"}),e.blockingColumnView=new Tessitura.KanbanColumnView({el:e.$("#blocking-tasks"),collection:new Tessitura.TaskCollection(o.where({status:"Blocking"})),color:"yellow",icon:"fa-minus-circle",headline:"Blocking"}),e.childViews.push(e.backlogColumnView),e.childViews.push(e.newColumnView),e.childViews.push(e.inProgressColumnView),e.childViews.push(e.blockingColumnView),_.each(e.childViews,function(e){e.render()}),e.listenTo(e.backlogColumnView.collection,"change:backlog",e.removeFromBacklog),e.listenTo(e.newColumnView.collection,"change:status",e.changeStatus),e.listenTo(e.inProgressColumnView.collection,"change:status",e.changeStatus),e.listenTo(e.blockingColumnView.collection,"change:status",e.changeStatus),e.listenTo(e.newColumnView.collection,"change:backlog",e.addToBacklog),e.listenTo(e.inProgressColumnView.collection,"change:backlog",e.addToBacklog),e.listenTo(e.blockingColumnView.collection,"change:backlog",e.addToBacklog)}}),Tessitura.View.prototype.render.call(this,this.template())}});module.exports=DashboardTaskView;
},{}],34:[function(require,module,exports){
var DashboardTopWidgetView=Tessitura.View.extend({id:"dashboard-top-widgets",template:JST["partials/topWidgets"],events:{"click .dash-widget":"followLink"},followLink:function(t){var e=$(t.target).hasClass("dash-widget")?$(t.target):$(t.target).closest(".dash-widget");this.trigger("redirect",{destination:e.attr("data-target")})},klass:"DashboardTopWidgetView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardTopWidgetView","PartialView"])},initialize:function(t){this.data=t||{},_.extend(this,this.data),this.listenTo(this.taskCollection,"add remove sync",this.render)},render:function(){Tessitura.View.prototype.render.call(this,this.template(this.data))}});module.exports=DashboardTopWidgetView;
},{}],35:[function(require,module,exports){
var KanbanColumnView=Tessitura.View.extend({template:JST["partials/kanbanCol"],className:"panel dash-widget kanban-column",klass:"KanbanColumnView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["KanbanColumnView","KanbanColumn","PartialView"])},removeTask:function(t){this.groupedBy.backlog&&t.get("backlog")||this.collection.remove(t)},updateTask:function(t){var e=!1;_.each(this.groupedBy,function(i,a){t.get(a)!=i&&(e=!0)}),e&&t.save(this.groupedBy)},setCollection:function(t){this.collection=t,this.collectionView=new Tessitura.TaskCollectionView({collection:this.collection}),this.childViews.push(this.collectionView),this.listenTo(this.collection,"add",this.updateTask),this.listenTo(this.collection,"change:backlog",this.removeTask)},initialize:function(t){this.data=t||{},this.data.color=this.data.color||"primary",this.$el.addClass("panel-"+this.data.color),this.groupedBy="Backlog"===this.data.headline?{backlog:!0}:{status:this.data.headline},this.childViews=[],this.data.collection&&this.setCollection(this.data.collection)},remove:function(){this.childViews.length&&_.each(this.childViews,function(t){t.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var t=this;Tessitura.View.prototype.render.call(this,this.template({data:t.data}),function(){t.collectionView.render(),t.$(".panel-body").html(t.collectionView.$el)})}});module.exports=KanbanColumnView;
},{}],36:[function(require,module,exports){
var LoginFormView=Tessitura.View.extend({template:JST["partials/loginForm"],tagName:"form",id:"login-form",events:{submit:"loginUser","click .login-help-link":"loginHelp"},klass:"LoginFormView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["LoginFormView","LoginForm","PartialView"])},loginHelp:function(e){console.log("Haha, you're boned!")},loginUser:function(e){e.preventDefault();var i=Tessitura.Utils.getAttributes(this.$el),r=btoa(i.username+":"+i.password),o=this,s=new Tessitura.UserModel({username:i.username,password:i.password});s.login({success:function(e){i.remember?$.cookie("auth",r,{expires:365}):$.cookie("auth",r),i.remember?$.cookie("userID",s.id,{expires:365}):$.cookie("userID",s.get("id")),o.trigger("userLoggedIn",{user:e})}})},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}});module.exports=LoginFormView;
},{}],37:[function(require,module,exports){
var RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},klass:"RegistrationFormView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["RegistrationFormView","RegistrationForm","FormView","PartialView"])},reqdFields:["username","password","email","first_name","last_name"],createUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(r)){var a=new Tessitura.UserModel,t=btoa(r.username+":"+r.password),s=this;delete r.passwordConfirmation,delete r.emailConfirmation,a.save(r,{success:function(e){$.cookie("auth",t),$.cookie("userID",e.id),s.trigger("userCreated")}})}},removeError:function(){this.$("fieldset.terms").hasClass("has-error")&&this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){this.$("input[name=acceptTerms]").prop("checked",function(e,r){return!r}),this.removeError()},validateForm:function(e){return e.acceptTerms?(delete e.acceptTerms,this.validCreds(e.username,e.password,e.passwordConfirmation,e.email,e.emailConfirmation)&&this.validName(e.first_name,e.last_name)):(this.$("fieldset.form-group.terms").addClass("has-error"),!1)},validCreds:function(e,r,a,t,s){return this.validPassword(r,a)&&this.validUsername(e)&&this.validEmail(t,s)&&-1===r.indexOf(e)},validEmail:function(e,r){var a=!!e.match(/(\S+)@(\S+)\.(\S+)/)&&!!r&&r===e;return a||this.$("input[name=email]").addClass("has-error"),a},validName:function(e,r){var a=!!e.match(/^[A-Za-z' -]{2,}$/),t=!!r.match(/^[A-Za-z\' -]{2,}$/);return a||this.$("input[name=first_name]").addClass("has-error"),t||this.$("input[name=last_name]").addClass("has-error"),a&&t},validPassword:function(e,r){var a=!!e&&e.length>=8&&!!e.match(/[A-Za-z]/)&&!!e.match(/[0-9]/)&&!!r&&e===r;return a||this.$("input[name=password]").addClass("has-error"),a},validUsername:function(e){var r=!!e&&e.length>=6&&!!e.match(/^[A-Za-z0-9_\- ]*$/);return r||this.$("input[name=username]").addClass("has-error"),r},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}});module.exports=RegistrationFormView;
},{}],38:[function(require,module,exports){
var TaskPanelView=Tessitura.View.extend({id:"task-panel",className:"panel panel-primary dash-widget",template:JST["partials/taskPanel"],events:{"click span.toggle-widget i":"toggleWidget"},klass:"TaskPanelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["TaskPanelView","TaskPanel","TaskView","PartialView"])},addTaskToDisplay:function(){if(this.collection.length>this.collectionView.collection.length){var e=this.collectionView.collection.length-1+1,i=this.collection.at(e);this.collectionView.collection.add(i)}},filterCollection:function(){var e=_.filter(this.collection.models,function(e){return"Blocking"!==e.get("status")&&!e.get("backlog")});return e},removeBacklog:function(){this.collectionView.removeBacklog()},showTaskCreateForm:function(e){this.collectionView.collection;this.trigger("showTaskCreateForm",{collection:this.collection})},toggleWidget:function(e){this.$(".panel-body").slideToggle(),$(e.target).toggleClass("fa-minus fa-plus")},initialize:function(e){this.collection=new Tessitura.TaskCollection(this.filterCollection());var i=new Tessitura.TaskCollection(this.collection.slice(0,10));this.collectionView=new Tessitura.TaskCollectionView({collection:i}),this.childViews=[this.collectionView],this.listenTo(this.collection,"change:backlog",this.removeBacklog),this.listenTo(this.collectionView.collection,"remove",this.addTaskToDisplay)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.collectionView.render(),e.$(".panel-body").html(e.collectionView.$el)})}});module.exports=TaskPanelView;
},{}],39:[function(require,module,exports){
var fixtures=require("../../../spec/support/fixtures/fixtures.js"),SpecWrapper=Tessitura.View.extend({template:JST["spec/dashHome"],el:"body",initialize:function(){this.view=new Tessitura.DashboardHomeView({user:fixtures.user}),this.render()},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.$el.addClass("test"),e.view.render(),e.$("#view").html(e.view.$el)})}});module.exports=SpecWrapper;
},{"../../../spec/support/fixtures/fixtures.js":53}],40:[function(require,module,exports){
var SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/sidebar"],events:{"click a[data-method=showTargetNav]":"showTargetNav","click a[data-method=toggleSecondLevelNav]":"callToggleSecondLevelNav","click a[data-method=showLastNav]":"showLastNav"},callToggleSecondLevelNav:function(e){e.preventDefault();var t=this,a=$.Event("click",{target:t.view.$('a[href=#]:contains("UI Elements")').first()});this.view.toggleSecondLevelNav(a)},showLastNav:function(e){e.preventDefault();var t=this,a=$.Event("click",{target:t.view.$("a[href=#]").last()});this.view.$('a[href="blank.html"]').is(":visible")||this.view.toggleSecondLevelNav(a)},showTargetNav:function(e){e.preventDefault();var t=this,a=$.Event("click",{target:t.view.$('a[href=#]:contains("UI Elements")').first()});this.view.$('a[href="panels-wells.html"]').is(":visible")||this.view.toggleSecondLevelNav(a)},initialize:function(){this.view=new Tessitura.DashboardSidebarView},render:function(){this.$el.html(this.template()),this.$el.addClass("test"),this.delegateEvents(),this.view.render(),this.$("#view").html(this.view.$el),this.view.delegateEvents()}});module.exports=SpecWrapper;
},{}],41:[function(require,module,exports){
var user1=new Tessitura.UserModel({id:1,username:"user1",password:"user1",email:"user1@example.com",first_name:"User",last_name:"One"}),user2=new Tessitura.UserModel({id:2,username:"user2",password:"user2",email:"user2@example.com",first_name:"User",last_name:"Two"}),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/dashboard"],events:{"click a[data-method=hideDropdownMenus]":"callHideDropdownMenus","click a[data-method=hideSidebar]":"callHideSidebar","click a[data-method=redirect]":"callRedirect","click a[data-method=setUser]":"callSetUser","click a[data-method=toggleDropdownMenu]":"callToggleDropdownMenu","click a[data-method=toggleSidebar]":"callToggleSidebar","click a[data-method=showHomeView]":"callShowHomeView","click a[data-method=showTaskView]":"callShowTaskView","click a[data-method=showSidebar]":"callShowSidebar"},callHideDropdownMenus:function(){var e=this,a=$.Event("click",{target:e.view.$("#page-wrapper")});this.view.hideDropdownMenus(a)},callHideSidebar:function(){var e=this,a=$.Event("dblclick",{target:e.view.$el});this.view.hideSidebar(a)},callShowSidebar:function(){var e=this;if(!this.view.$("#side-menu").is(":visible")){var a=$.Event("click",{target:e.view.$(".navbar-brand").first()});e.view.toggleSidebar(a)}},callToggleDropdownMenu:function(){{var e=this;$.Event("click",{target:e.view.$(".navbar-top-links li.dropdown").first()})}this.view.$(".navbar-top-links > li.dropdown > a.dropdown-toggle").first().click()},callToggleSidebar:function(){var e=this,a=$.Event("click",{target:e.view.$(".navbar-brand")});this.view.toggleSidebar(a)},initialize:function(){this.view=new Tessitura.DashboardView({user:user1})},render:function(){this.$el.html(this.template()),this.$el.addClass("test"),this.view.render(),this.$("#view").html(this.view.$el),this.view.delegateEvents()}});module.exports=SpecWrapper;
},{}],42:[function(require,module,exports){
var Fixtures=require("../../../spec/support/fixtures/fixtures.js"),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/topWidgets"],events:{"click a[data-method=changeLinkColor]":"callChangeLinkColor","click a[data-method=changeLinkColorBack]":"callChangeLinkColorBack","click a[data-method=makeLinkColored]":"makeLinkColored","click a[data-method=makeLinkGray]":"makeLinkGray"},callChangeLinkColor:function(e){e.preventDefault();var t=this,i=$.Event("mouseenter",{target:t.view.$(".dash-widget").first()});this.view.callChangeLinkColor(i)},callChangeLinkColorBack:function(e){e.preventDefault();var t=this,i=$.Event("mouseleave",{target:t.view.$(".dash-widget").first()});this.view.callChangeLinkColorBack(i)},makeLinkColored:function(e){e.preventDefault();var t=this,i=this.view.$("panel-heading").css("background-color");if(!this.view.$(".dash-widget").first().css("background-color")===i){var a=$.Event("mouseenter",{target:t.view.$(".dashwidget").first()});this.view.callChangeLinkColor(a)}},makeLinkGray:function(e){e.preventDefault();var t=this,i=this.view.$("panel-heading").css("background-color");if(this.view.$(".dash-widget").first().css("background-color")===i){var a=$.Event("mouseLeave",{target:t.view.$(".dashwidget").first()});this.view.callChangeLinkColorBack(a)}},initialize:function(){var e={taskCollection:Fixtures.collection,deadlineCount:6,appointmentCount:2,recommendationCount:12};this.view=new Tessitura.DashboardTopWidgetView(e),this.render()},render:function(){return this.$el.html(this.template()),this.$el.addClass("test"),this.view.render(),this.$("#view").html(this.view.$el),this.delegateEvents(),this}});module.exports=SpecWrapper;
},{"../../../spec/support/fixtures/fixtures.js":53}],43:[function(require,module,exports){
var SpecWrapper=Tessitura.View.extend({el:"body",template:JST["spec/homepage"],events:{"click a[data-method=showLoginForm]":"showLoginForm","click a[data-method=hideLoginForm]":"callHideLoginForm","click a[data-method=toggleLoginForm]":"callToggleLoginForm"},callHideLoginForm:function(e){e.preventDefault();var i=$.Event("dblclick",{target:this.view.$("#shade")});this.view.hideLoginForm(i)},callToggleLoginForm:function(e){e.preventDefault();var i=$.Event("click",{target:this.view.$(".login-link")});this.view.toggleLoginForm(i)},showLoginForm:function(e){if(e.preventDefault(),!this.view.$("#login-form").is(":visible")){var i=$.Event("click",{target:this.view.$(".login-link")});this.view.toggleLoginForm(i)}},initialize:function(){this.view=new Tessitura.HomepageView,this.render()},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.view.render(),e.$el.addClass("test"),e.$("#view").html(e.view.$el)})}});module.exports=SpecWrapper;
},{}],44:[function(require,module,exports){
var task1=new Tessitura.TaskModel({id:1,title:"Task 1",status:"New",priority:"Normal",position:1}),task2=new Tessitura.TaskModel({id:2,title:"Task 2",status:"New",priority:"Normal",position:2}),task3=new Tessitura.TaskModel({id:3,title:"Task 3",status:"Complete",priority:"Normal",position:3}),collection=new Tessitura.TaskCollection([task1,task2,task3]),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/collection"],events:{"click a[data-method=crossOffIncomplete]":"callCrossOffIncomplete","click a[data-method=crossOffComplete]":"callCrossOffComplete","click a[data-method=reset]":"resetCollection"},callCrossOffIncomplete:function(t){t.preventDefault(),this.view.crossOff(task1)},callCrossOffComplete:function(t){t.preventDefault(),this.view.crossOff(task3)},resetCollection:function(t){t.preventDefault(),task1.set({title:"Task 1",status:"New",priority:"Normal",position:1}),task2.set({id:2,title:"Task 2",status:"New",priority:"Normal",position:2}),task3.set({id:3,title:"Task 3",status:"Complete",priority:"Normal",position:3}),this.collection.reset([task1,task2,task3])},initialize:function(){this.view=new Tessitura.TaskCollectionView({collection:collection}),this.render()},render:function(){return this.$el.html(this.template()),this.$el.addClass("test"),this.delegateEvents(),this.view.render(),this.$("#view").html(this.view.$el),this.view.delegateEvents(),this}});module.exports=SpecWrapper;
},{}],45:[function(require,module,exports){
var task=new Tessitura.TaskModel({id:1,title:"Make tests for the SpecWrapper views"}),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/listItem"],events:{"click a":"callMethod"},callMethod:function(e){e.preventDefault(),this.view[$(e.target).attr("data-method")]()},initialize:function(){this.view=new Tessitura.TaskListItemView({model:task})},render:function(){return this.$el.html(this.template()),this.$el.addClass("test"),this.view.render(),this.$("#dashboard-wrapper").html(this.view.$el),this.delegateEvents(),this}});module.exports=SpecWrapper;
},{}],46:[function(require,module,exports){
var Fixtures=require("../../../spec/support/fixtures/fixtures.js"),SpecWrapper=Backbone.View.extend({el:"body",template:JST["spec/taskPanel"],events:{"click a[data-method=toggleWidget]":"callToggleWidget","click a[data-method=remove]":"remove","click a[data-method=render]":"render","click a[data-method=displayPanelBody]":"displayPanelBody","click a[data-method=hidePanelBody]":"hidePanelBody"},callToggleWidget:function(e){e.preventDefault();var t=$.Event("click",{target:this.view.$(".panel-heading i").last()});this.view.toggleWidget(t)},displayPanelBody:function(){this.$("#task-panel .panel-body").is(":visible")||this.$(".panel-body").slideDown()},hidePanelBody:function(){this.$("#task-panel .panel-body").is(":visible")&&this.$(".panel-body").slideUp()},initialize:function(){this.view=new Tessitura.TaskPanelView({collection:Fixtures.collection}),this.render()},render:function(){return this.$el.html(this.template()),this.$el.addClass("test").attr("id","dashboard-wrapper"),this.delegateEvents(),this.view.render(),this.$("#view").html(this.view.$el),this.view.delegateEvents(),this}});module.exports=SpecWrapper;
},{"../../../spec/support/fixtures/fixtures.js":53}],47:[function(require,module,exports){
...
},{"underscore":52}],48:[function(require,module,exports){
...
require("../../../js/tessitura.js");var testing=require("../../../js/apiOptions.js").useTestRouter,Fixtures={};if(testing){var user=new Tessitura.UserModel({id:1,username:"testuser",password:"testuser",email:"testuser@example.com",first_name:"Test",last_name:"User"}),task1=new Tessitura.TaskModel({id:1,owner_id:1,title:"Task 1",status:"New",priority:"Low",position:1}),task2=new Tessitura.TaskModel({id:2,owner_id:1,title:"Task 2",status:"New",priority:"Normal",position:2}),task3=new Tessitura.TaskModel({id:3,owner_id:1,title:"Task 3",status:"Blocking",priority:"High",position:3}),task4=new Tessitura.TaskModel({id:4,owner_id:1,title:"Task 4",status:"In Progress",priority:"High",backlog:!0,position:4}),task5=new Tessitura.TaskModel({id:5,owner_id:1,title:"Task 5",status:"Complete",priority:"Normal",position:5}),collection=user.tasks=new Tessitura.TaskCollection([task1,task2,task3,task4,task5]);Fixtures={user:user,task1:task1,task2:task2,task3:task3,task4:task4,task5:task5,collection:collection,restoreFixtures:function(){this.user.set({id:1,username:"testuser",password:"testuser",email:"testuser@example.com",first_name:"Test",last_name:"User"},{silent:!0}),this.task1.set({id:1,owner_id:1,title:"Task 1",status:"New",priority:"Low",position:1},{silent:!0}),this.task2.set({id:2,owner_id:1,title:"Task 2",status:"New",priority:"Normal",position:2},{silent:!0}),this.task3.set({id:3,owner_id:1,title:"Task 3",status:"Complete",priority:"Normal",position:3},{silent:!0}),this.collection.reset([task1,task2,task3])}}}module.exports=Fixtures;
},{"../../../js/apiOptions.js":6,"../../../js/tessitura.js":18}],54:[function(require,module,exports){
require("../../js/dependencies.js");var testing=require("../../js/apiOptions.js").useTestRouter,TestRouter=Tessitura.Router.extend({});if(testing){Tessitura.DashboardHomeSpecView=require("../../js/views/specViews/dashboardHomeSpecView.js"),Tessitura.DashboardSidebarSpecView=require("../../js/views/specViews/dashboardSidebarSpecView.js"),Tessitura.DashboardTopWidgetSpecView=require("../../js/views/specViews/dashboardTopWidgetSpecView.js"),Tessitura.DashboardSpecView=require("../../js/views/specViews/dashboardSpecView.js"),Tessitura.TaskListItemSpecView=require("../../js/views/specViews/taskListItemSpecView.js"),Tessitura.HomepageSpecView=require("../../js/views/specViews/homepageSpecView.js"),Tessitura.TaskCollectionSpecView=require("../../js/views/specViews/taskCollectionSpecView.js"),Tessitura.TaskPanelSpecView=require("../../js/views/specViews/taskPanelSpecView.js");var testRoutes=_.extend(Tessitura.Router.prototype.routes,{"listItemViewSpec(/)":"displayListItemView","dashboardHomeViewSpec(/)":"displayDashboardHomeView","dashboardSidebarViewSpec(/)":"displayDashboardSidebarView","dashboardTopWidgetViewSpec(/)":"displayDashboardTopWidgetView","dashboardViewSpec(/)":"displayDashboardView","homepageViewSpec(/)":"displayHomepageView","taskCollectionViewSpec(/)":"displayTaskCollectionView","taskPanelViewSpec(/)":"displayTaskPanelView"});TestRouter=Tessitura.Router.extend({routes:{"listItemViewSpec(/)":"displayListItemView","dashboardHomeViewSpec(/)":"displayDashboardHomeView","dashboardSidebarViewSpec(/)":"displayDashboardSidebarView","dashboardTopWidgetViewSpec(/)":"displayDashboardTopWidgetView","dashboardViewSpec(/)":"displayDashboardView","homepageViewSpec(/)":"displayHomepageView","taskCollectionViewSpec(/)":"displayTaskCollectionView","taskPanelViewSpec(/)":"displayTaskPanelView"},displayListItemView:function(){view=new Tessitura.TaskListItemSpecView,view.render()},displayDashboardHomeView:function(){view=new Tessitura.DashboardHomeSpecView,view.render()},displayDashboardSidebarView:function(){view=new Tessitura.DashboardSidebarSpecView,view.render()},displayDashboardTopWidgetView:function(){view=new Tessitura.DashboardTopWidgetSpecView,view.render()},displayDashboardView:function(){view=new Tessitura.DashboardSpecView,view.render()},displayHomepageView:function(){view=new Tessitura.HomepageSpecView,view.render()},displayTaskCollectionView:function(){view=new Tessitura.TaskCollectionSpecView,view.render()},displayTaskPanelView:function(){view=new Tessitura.TaskPanelSpecView,view.render()}})}module.exports=TestRouter;
},{"../../js/apiOptions.js":6,"../../js/dependencies.js":9,"../../js/views/specViews/dashboardHomeSpecView.js":39,"../../js/views/specViews/dashboardSidebarSpecView.js":40,"../../js/views/specViews/dashboardSpecView.js":41,"../../js/views/specViews/dashboardTopWidgetSpecView.js":42,"../../js/views/specViews/homepageSpecView.js":43,"../../js/views/specViews/taskCollectionSpecView.js":44,"../../js/views/specViews/taskListItemSpecView.js":45,"../../js/views/specViews/taskPanelSpecView.js":46}],55:[function(require,module,exports){
var _=require("underscore"),JST={calendar:_.template(require("./partialTemplates/calendarTemplate.js")),dashboard:_.template(require("./topLevelTemplates/dashboardTemplate.js")),homepage:_.template(require("./topLevelTemplates/homepageTemplate.js")),"collections/task":_.template("<li class='quick-add-form not-sortable'></li>"),"partials/dashHome":_.template(require("./partialTemplates/dashboardHomeTemplate.js")),"partials/dashTasks":_.template(require("./partialTemplates/dashboardTaskTemplate.js")),"partials/kanbanCol":_.template(require("./partialTemplates/kanbanColumnTemplate.js")),"partials/loginForm":_.template(require("./partialTemplates/loginFormTemplate.js")),"partials/sidebar":_.template(require("./partialTemplates/dashboardSidebarTemplate.js")),"partials/regForm":_.template(require("./partialTemplates/registrationFormTemplate.js")),"partials/taskPanel":_.template(require("./partialTemplates/taskPanelTemplate.js")),"partials/topWidgets":_.template(require("./partialTemplates/dashboardTopWidgetTemplate.js")),"tasks/model":_.template(require("./modelTemplates/taskTemplates/taskModelTemplate.js")),"tasks/listItem":_.template(require("./modelTemplates/taskTemplates/listItemTemplate.js")),"tasks/quickAdd":_.template(require("./modelTemplates/taskTemplates/quickAddFormTemplate.js")),"users/model":_.template(require("./modelTemplates/userTemplates/userModelTemplate.js")),"users/profile":_.template(require("./modelTemplates/userTemplates/userProfileTemplate.js")),"spec/dashboard":_.template(require("./specTemplates/dashboardSpecTemplate.js")),"spec/dashHome":_.template(require("./specTemplates/dashboardHomeSpecTemplate.js")),"spec/dashTasks":_.template(require("./specTemplates/dashboardTaskSpecTemplate.js")),"spec/homepage":_.template(require("./specTemplates/homepageSpecTemplate.js")),"spec/listItem":_.template(require("./specTemplates/taskListItemSpecTemplate.js")),"spec/sidebar":_.template(require("./specTemplates/dashboardSidebarSpecTemplate.js")),"spec/collection":_.template(require("./specTemplates/taskCollectionSpecTemplate.js")),"spec/taskPanel":_.template(require("./specTemplates/taskPanelSpecTemplate.js")),"spec/topWidgets":_.template(require("./specTemplates/dashboardTopWidgetSpecTemplate.js"))};module.exports=JST;
},{"./modelTemplates/taskTemplates/listItemTemplate.js":56,"./modelTemplates/taskTemplates/quickAddFormTemplate.js":57,"./modelTemplates/taskTemplates/taskModelTemplate.js":58,"./modelTemplates/userTemplates/userModelTemplate.js":59,"./modelTemplates/userTemplates/userProfileTemplate.js":60,"./partialTemplates/calendarTemplate.js":61,"./partialTemplates/dashboardHomeTemplate.js":62,"./partialTemplates/dashboardSidebarTemplate.js":63,"./partialTemplates/dashboardTaskTemplate.js":64,"./partialTemplates/dashboardTopWidgetTemplate.js":65,"./partialTemplates/kanbanColumnTemplate.js":66,"./partialTemplates/loginFormTemplate.js":67,"./partialTemplates/registrationFormTemplate.js":68,"./partialTemplates/taskPanelTemplate.js":69,"./specTemplates/dashboardHomeSpecTemplate.js":70,"./specTemplates/dashboardSidebarSpecTemplate.js":71,"./specTemplates/dashboardSpecTemplate.js":72,"./specTemplates/dashboardTaskSpecTemplate.js":73,"./specTemplates/dashboardTopWidgetSpecTemplate.js":74,"./specTemplates/homepageSpecTemplate.js":75,"./specTemplates/taskCollectionSpecTemplate.js":76,"./specTemplates/taskListItemSpecTemplate.js":77,"./specTemplates/taskPanelSpecTemplate.js":78,"./topLevelTemplates/dashboardTemplate.js":79,"./topLevelTemplates/homepageTemplate.js":80,"underscore":52}],56:[function(require,module,exports){
...
var string="<div id='view'></div>\n<div id='triggers' style='float: right'>\n  <ul>\n    <li><a href='#' data-method='hideDropdownMenus' onclick='return false'>hideDropdownMenus</a></li>\n    <li><a href='#' data-method='toggleDropdownMenu' onclick='return false'>toggleDropdownMenu</a></li>\n    <li><a href='#' data-method='toggleSidebar' onclick='return false'>toggleSidebar</a></li>\n    <li><a href='#' data-method='redirect' onclick='return false'>redirect</a></li>\n    <li><a href='#' data-method='setUser' onclick='return false'>setUser</a></li>\n    <li><a href='#' data-method='showSidebar' onclick='return false'>showSidebar</a></li>\n    <li><a href='#' data-method='hideSidebar' onclick='return false'>hideSidebar</a></li>\n    <li><a href='#' data-method='showHomeView' onclick='return false'>showHomeView</a></li>\n    <li><a href='#' data-method='showTaskView' onclick='return false'>showTaskView</a></li>\n  </ul>\n</div>\n";module.exports=string;
...
},{"backbone":47,"underscore":52}],82:[function(require,module,exports){

...
Tessitura.DashboardTaskView=Tessitura.View.extend({template:JST["partials/dashTasks"],id:"page-wrapper",klass:"DashboardTaskView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardTaskView"])},addToBacklog:function(e){this.backlogColumnView.collection.add([e])},allocate:function(e){var s=this.findNewCollection(e);s.models.unshift(e),s.render()},changeStatus:function(e){var s=this.findNewCollection(e)||new Tessitura.TaskCollection;s.models.push([e])},currentView:function(e){var s;return _.each(this.childViews,function(e){e.models.indexOf(e)>-1&&(s=e)}),s},findNewCollection:function(e){var s,i=this,n=e.get("status");return e.get("backlog")===!0?this.backlogColumnView:(_.each([i.newColumnView,i.inProgressColumnView,i.blockingColumnView],function(e){e.headline===n&&(s=e)}),s)},changeBacklog:function(e){this.render()},removeAndRender:function(e){var s=this.findNewCollection(e);s.models.splice(s.models.indexOf(e),1),s.render()},setUser:function(e){this.user=e,this.user.tasks=this.user.tasks||new Tessitura.TaskCollection},initialize:function(e){e=e||{},this.childViews=[],e.user&&this.setUser(e.user)},remove:function(){this.childViews&&this.childViews.length&&_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return this.user.tasks.fetch({success:function(s){e.backlogColumnView=new Tessitura.KanbanColumnView({collection:e.user.tasks,el:e.$("#backlog-tasks"),models:e.user.tasks.where({backlog:!0}),color:"red",icon:"fa-exclamation-circle",headline:"Backlog",groupedBy:{backlog:!0}}),e.newColumnView=new Tessitura.KanbanColumnView({collection:e.user.tasks,el:e.$("#new-tasks"),models:e.user.tasks.where({status:"New"}),color:"blue",icon:"fa-certificate",headline:"New",groupedBy:{status:"New"}}),e.inProgressColumnView=new Tessitura.KanbanColumnView({collection:e.user.tasks,el:e.$("#in-progress-tasks"),models:e.user.tasks.where({status:"In Progress"}),color:"green",icon:"fa-road",headline:"In Progress",groupedBy:{status:"In Progress"}}),e.blockingColumnView=new Tessitura.KanbanColumnView({collection:e.user.tasks,el:e.$("#blocking-tasks"),models:e.user.tasks.where({status:"Blocking"}),color:"yellow",icon:"fa-minus-circle",headline:"Blocking",groupedBy:{status:"Blocking"}}),e.childViews.push(e.backlogColumnView),e.childViews.push(e.newColumnView),e.childViews.push(e.inProgressColumnView),e.childViews.push(e.blockingColumnView),_.each(e.childViews,function(e){e.render()}),e.listenTo(e.user.tasks,"change:backlog",e.changeBacklog),e.listenTo(e.user.tasks,"change:status",e.changeStatus),e.listenTo(e.user.tasks,"remove",e.renderOnRemove),e.listenTo(e.user.tasks,"add",e.allocate),e.listenTo(e.user.tasks,"remove",e.removeAndRender)}}),Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.DashboardTaskView;
...
Tessitura.KanbanColumnView=Tessitura.View.extend({template:JST["partials/kanbanCol"],className:"panel dash-widget kanban-column",klass:"KanbanColumnView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["KanbanColumnView","KanbanColumn","PartialView"])},crossOff:function(e){if("Complete"===e.get("status")){var i=this,t=this.retrieveViewForModel(e);setTimeout(function(){t&&(i.childViews.splice(i.childViews.indexOf(t),1),t.destroy()),i.collection.remove(e)},750)}},removeTask:function(e){this.groupedBy.backlog&&e.get("backlog")||this.collection.remove(e)},updateTask:function(e){var i=!1;_.each(this.groupedBy,function(t,s){e.get(s)!=t&&(i=!0)}),i&&e.save(this.groupedBy)},renderModels:function(){for(var e=this,i=document.createDocumentFragment(),t=Object.keys(this.groupedBy)[0],s=0;s<this.models.length;s++){var o=this.models[s];if(!o.get("backlog")||"backlog"===t){var n=e.retrieveViewForModel(o)||new Tessitura.TaskListItemView({model:o});-1===e.childViews.indexOf(n)&&e.childViews.push(n),n.render(),i.appendChild(n.el)}}return this.$("ul.task-list").append(i),this},retrieveViewForModel:function(e){if(this.childViews.length){var i;return _.each(this.childViews,function(t){t.model&&t.model.get("id")===e.get("id")&&(i=t)}),i}},initialize:function(e){e=e||{},_.extend(this,e);var i=this;this.quickAddForm=new Tessitura.QuickAddFormView({collection:i.collection,groupedBy:this.groupedBy}),this.childViews=[this.quickAddForm],this.$el.addClass("panel-"+this.color)},remove:function(){this.childViews.length&&_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;Tessitura.View.prototype.render.call(this,this.template({data:this}),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderModels(),e.$("ul.task-list").sortable({items:">*:not(.not-sortable)"})})}}),module.exports=Tessitura.KanbanColumnView;
...
Tessitura.TaskPanelView=Tessitura.DashWidgetView.extend({id:"task-panel",template:JST["partials/taskPanel"],klass:"TaskPanelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.DashWidgetView.prototype.types().concat(["TaskPanelView","TaskPanel","TaskView","PartialView"])},crossOff:function(e){if("Complete"===e.get("status")){var i=this,t=this.retrieveViewForModel(e);setTimeout(function(){t&&(i.childViews.splice(i.childViews.indexOf(t),1),t.destroy()),i.collection.remove(e)},750)}},retrieveViewForModel:function(e){if(this.childViews.length){var i,t=this;return _.each(t.childViews,function(t){t.model&&t.model.get("id")===e.get("id")&&(i=t)}),i}},showTaskCreateForm:function(e){this.trigger("showTaskCreateForm",{collection:this.collection})},renderCollection:function(){var e=this,i=0,t=document.createDocumentFragment();return this.collection.each(function(s){if(!(i>9||"Blocking"===s.get("status")||"Complete"===s.get("status")||s.get("backlog"))){var o=e.retrieveViewForModel(s)||new Tessitura.TaskListItemView({model:s});-1==e.childViews.indexOf(o)&&e.childViews.push(o),o.render(),t.appendChild(o.el),i++}}),this.$("ul.task-list").append(t),this},initialize:function(e){this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection}),this.childViews=[this.quickAddForm],this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"change:backlog",this.render),this.listenTo(this.collection,"drop",this.removeStyles),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderCollection(),e.$("ul").sortable({items:">*:not(.not-sortable)"})})}}),module.exports=Tessitura.TaskPanelView;

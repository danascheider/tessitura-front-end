...
Tessitura.RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},reqdFields:["username","password","email","first_name","last_name"],createUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(r)){var a=new Tessitura.UserModel,s=btoa(r.username+":"+r.password),t=this;delete r.passwordConfirmation,delete r.emailConfirmation,a.save(r,{success:function(e){$.cookie("auth",s),$.cookie("userID",e.id),t.trigger("userCreated",{user:a})}})}},removeError:function(){this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){var e=!this.$("input[name=acceptTerms]").prop("checked");this.$("input[name=acceptTerms]").prop(e),this.removeError()},validateForm:function(e){var r,a,s,t,i;return r=!!e.acceptTerms,r||(this.$("fieldset.form-group.terms").addClass("has-error"),r=!1),a=this.validPassword(e.password,e.passwordConfirmation),s=this.validUsername(e.username),t=this.validEmail(e.email,e.emailConfirmation),i=this.validName(e.first_name,e.last_name),delete e.acceptTerms,r&&a&&s&&t&&i},validCreds:function(e,r,a,s,t){var i=this.validPassword(r,a),n=this.validUsername(e),o=this.validEmail(s,t);return i&&n&&o&&-1===r.indexOf(e)},validEmail:function(e,r){this.errors=this.errors||[];var a=!0,s=!0;e||(this.errors.push("E-mail is required"),a=!1),r||(this.errors.push("E-mail confirmation is required"),s=!1),e&&!e.match(/(\S+)@(\S+)\.(\S+)/)&&(this.errors.push("Not a valid e-mail address"),a=!1),e&&r&&e!==r&&(this.errors.push("E-mail and e-mail confirmation don't match"),a=!1,s=!1);var t=!!e&&!!e.match(/(\S+)@(\S+)\.(\S+)/)&&!!r&&r===e;return t||this.$("input[name=email]").addClass("has-error"),t},validName:function(e,r){var a=!!e&&!!e.match(/^[A-Za-z' -]{2,}$/),s=!!r&&!!r.match(/^[A-Za-z\' -]{2,}$/);return a||this.$("input[name=first_name]").addClass("has-error"),s||this.$("input[name=last_name]").addClass("has-error"),a&&s},validPassword:function(e,r){var a=!!e&&e.length>=8&&!!e.match(/[A-Za-z]/)&&!!e.match(/[0-9]/)&&!!r&&e===r;return a||this.$("input[name=password]").addClass("has-error"),a},validUsername:function(e){this.errors=this.errors||[];var r=!0;return e||(r=!1,this.errors.push("Username is required")),e&&e.length<6&&(r=!1,this.errors.push("Username must be at least 6 characters long")),e&&!e.match(/^[A-Za-z0-9_\- ]*$/)&&(r=!1,this.errors.push("Username may contain only alphanumeric characters, spaces, _, and -")),r||this.$("input[name=username]").addClass("has-error"),r},initialize:function(){this.errorPanelView=new Tessitura.ErrorPanelView},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.RegistrationFormView;

...
Tessitura.TaskEditFormView=Tessitura.View.extend({tagName:"form",id:"task-edit-form",template:JST["tasks/editForm"],render:function(){return Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}}),module.exports=Tessitura.TaskEditFormView;
...
var string="<input type='text' name='title' value='<%= model.get('title') || 'N/A' %>'>";module.exports=string;

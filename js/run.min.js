...
Tessitura.DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,events:{"click .internal-link":"followLink"},emitRedirect:function(e){this.trigger("redirect",e)},followLink:function(e){var i=$(e.target).closest(".internal-link"),t=i.attr("data-target");this.emitRedirect({destination:t})},setUser:function(e){this.model=e,this.navView.setUser(e)},initialize:function(){this.navView=new Tessitura.DashboardNavView,this.model&&this.setUser(model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,"",function(){e.navView.render(),e.navView.$el.is(":visible")||e.$el.prepend(e.navView.$el)})}}),module.exports=Tessitura.DashboardView;

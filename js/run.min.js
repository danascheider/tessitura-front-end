...
Tessitura.RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},reqdFields:["username","password","email","first_name","last_name"],createUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(r)){var s=new Tessitura.UserModel,a=btoa(r.username+":"+r.password),t=this;delete r.passwordConfirmation,delete r.emailConfirmation,s.save(r,{success:function(e){$.cookie("auth",a),$.cookie("userID",e.id),t.trigger("userCreated",{user:s})}})}},removeError:function(){this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){var e=!this.$("input[name=acceptTerms]").prop("checked");this.$("input[name=acceptTerms]").prop(e),this.removeError()},validateForm:function(e){var r,s,a,t,i;return r=!!e.acceptTerms,r||(this.$("fieldset.form-group.terms").addClass("has-error"),r=!1),s=this.validPassword(e.password,e.passwordConfirmation),a=this.validUsername(e.username),t=this.validEmail(e.email,e.emailConfirmation),i=this.validName(e.first_name,e.last_name),delete e.acceptTerms,r&&s&&a&&t&&i},validCreds:function(e,r,s,a,t){var i=this.validPassword(r,s),n=this.validUsername(e),o=this.validEmail(a,t);return i&&n&&o&&-1===r.indexOf(e)},validEmail:function(e,r){this.errors=this.errors||[];var s=!0;e||(this.errors.push("E-mail is required"),s=!1),r||(this.errors.push("E-mail confirmation is required"),s=!1);var s=!!e&&!!e.match(/(\S+)@(\S+)\.(\S+)/)&&!!r&&r===e;return s||this.$("input[name=email]").addClass("has-error"),s},validName:function(e,r){var s=!!e&&!!e.match(/^[A-Za-z' -]{2,}$/),a=!!r&&!!r.match(/^[A-Za-z\' -]{2,}$/);return s||this.$("input[name=first_name]").addClass("has-error"),a||this.$("input[name=last_name]").addClass("has-error"),s&&a},validPassword:function(e,r){var s=!!e&&e.length>=8&&!!e.match(/[A-Za-z]/)&&!!e.match(/[0-9]/)&&!!r&&e===r;return s||this.$("input[name=password]").addClass("has-error"),s},validUsername:function(e){this.errors=this.errors||[];var r=!0;return e||(r=!1,this.errors.push("Username is required")),e&&e.length<6&&(r=!1,this.errors.push("Username must be at least 6 characters long")),e&&!e.match(/^[A-Za-z0-9_\- ]*$/)&&(r=!1,this.errors.push("Username may contain only alphanumeric characters, spaces, _, and -")),r||this.$("input[name=username]").addClass("has-error"),r},initialize:function(){this.errorPanelView=new Tessitura.ErrorPanelView},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.RegistrationFormView;

...
Tessitura.TaskCreateFormView=Tessitura.View.extend({tagName:"form",id:"task-create-form",template:JST["tasks/createForm"],setCollection:function(e){return this.collection=e,this},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.TaskCreateFormView;
...
var moment=require("moment");Tessitura.CalendarView=Tessitura.DashWidgetView.extend({template:JST.calendar,id:"calendar",types:function(){return Tessitura.DashWidgetView.prototype.types().concat(["CalendarView","PartialView"])},displayDays:function(){for(var e=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],a=[],t=-1;2>t;t++)a.push(e[moment().add(t,"days").day()]);return a},initialize:function(e){},render:function(){return this.$el.html(this.template({days:this.displayDays()})),this}}),module.exports=Tessitura.CalendarView;
},{"moment":46}],32:[function(require,module,exports){
Tessitura.DashboardHomeView=Tessitura.View.extend({template:JST["partials/dashHome"],id:"page-wrapper",className:"dashboard-home",types:function(){return Tessitura.View.prototype.types().concat(["DashboardHomeView","PartialView"])},showTaskCreateForm:function(e){this.trigger("showTaskCreateForm",e)},showEditForm:function(e){this.trigger("showEditForm",e)},renderCalendarView:function(){this.calendarView.render(),this.$("div.col-lg-8").first().html(this.calendarView.$el)},renderTaskPanelView:function(){this.taskPanelView.render(),this.$("div.col-lg-4").first().html(this.taskPanelView.$el)},renderTopWidgetView:function(){this.topWidgetView.render(),this.$(".row").first().html(this.topWidgetView.$el)},setUser:function(e){this.user=e,this.collection=this.user.tasks;var t=this;return this.taskPanelView=new Tessitura.TaskPanelView({collection:this.collection}),this.topWidgetView=new Tessitura.DashboardTopWidgetView({taskCollection:t.user.tasks,deadlineCount:7,appointmentCount:4,recommendationCount:14}),this.calendarView=new Tessitura.CalendarView({user:this.user}),this.childViews=[this.calendarView,this.taskPanelView,this.topWidgetView],this.listenTo(this.taskPanelView,"showEditForm",this.showEditForm),this.listenTo(this.taskPanelView,"showTaskCreateForm",this.showTaskCreateForm),this},initialize:function(e){e=e||{},e.user&&this.setUser(e.user)},remove:function(){try{this.calendarView.remove(),this.taskPanelView.remove(),this.topWidgetView.remove()}catch(e){if(!(this.calendarView&&this.taskPanelView&&this.topWidgetView))return}Tessitura.View.prototype.remove.call(this)},render:function(e){e=e||{};var t=this;return Tessitura.View.prototype.render.call(t,t.template(),function(){t.taskPanelView&&t.renderTaskPanelView(),t.topWidgetView&&t.renderTopWidgetView(),t.calendarView&&t.renderCalendarView()})}}),module.exports=Tessitura.DashboardHomeView;

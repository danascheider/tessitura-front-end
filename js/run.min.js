...
var test=require("./apiOptions.js").useTestAPI,BaseURL=test?"http://api.canto-test.com:3000":"https://api.tessitura.io",API={base:BaseURL,login:BaseURL+"/login",users:{root:BaseURL+"/users",collection:BaseURL+"/users",single:function(s){return BaseURL+"/users/"+s}},tasks:{root:BaseURL+"/tasks",collection:function(s){return BaseURL+"/users/"+s+"/tasks"},fullCollection:function(s){return BaseURL+"/users/"+s+"/tasks/all"},single:function(s){return BaseURL+"/tasks/"+s}},fachs:{root:BaseURL+"/fachs",collection:BaseURL+"/fachs",single:function(s){return BaseURL+"/fachs/"+s}},organizations:{root:BaseURL+"/organizations",collection:BaseURL+"/organizations",single:function(s){return BaseURL+"/organizations/"+s}}};module.exports=API;
},{"./apiOptions.js":6}],6:[function(require,module,exports){
var opts={useTestAPI:!1};module.exports=opts;
},{}],7:[function(require,module,exports){
require("backbone"),require("underscore"),Backbone.Collection.prototype.klass="Backbone.Collection",Backbone.Collection.prototype.types=function(){return["Backbone.Collection"]},Backbone.Collection.prototype.isA=function(e){return this.types().indexOf(e)>-1?!0:!1};
},{"backbone":50,"underscore":55}],8:[function(require,module,exports){
Tessitura.OrganizationCollection=Tessitura.ProtectedCollection.extend({model:Tessitura.OrganizationModel,url:function(){return Tessitura.API.organizations.collection}}),module.exports=Tessitura.OrganizationCollection;
},{}],9:[function(require,module,exports){
var ProtectedCollection=Backbone.Collection.extend({token:function(){return"Basic "+$.cookie("auth")},klass:"ProtectedCollection",family:"ProtectedCollection",superFamily:"Backbone.Collection",types:function(){return Backbone.Collection.prototype.types().concat(["ProtectedCollection"])},destroy:function(){this.reset([]),this.stopListening()},isA:function(e){return this.types().indexOf(e)>-1?!0:!1},fetch:function(e){e=e||{};var t=this;e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",t.token())},Backbone.Collection.prototype.fetch.call(this,e)}});module.exports=ProtectedCollection;
},{}],10:[function(require,module,exports){
var TaskCollection=Tessitura.ProtectedCollection.extend({model:Tessitura.TaskModel,comparator:"position",url:function(){return Tessitura.API.tasks.collection($.cookie("userID"))},klass:"TaskCollection",types:function(){return Tessitura.ProtectedCollection.prototype.types().concat(["TaskCollection"])},passThroughAdd:function(t){-1===this.models.indexOf(t)&&this.add(t)},addAll:function(t){var e=this;return t.each(function(t){-1===e.models.indexOf(t)&&e.add(t)}),this},setChildren:function(t){this.children=t;var e=this;_.each(t,function(t){e.addAll(t),e.listenTo(t,"add",e.passThroughAdd)})},initialize:function(t,e){if(e=e||{},_.extend(this,e),this.children){var o=this;_.each(this.children,function(t,e){o.addAll(t),o.listenTo(t,"add",o.passThroughAdd),o.listenTo(t,"remove",o.remove)})}},fetch:function(t){t=t||{},t.url||(t.url=t.all===!0?Tessitura.API.tasks.fullCollection($.cookie("userID")):this.url()),delete t.all,Tessitura.ProtectedCollection.prototype.fetch.call(this,t)}});module.exports=TaskCollection;
},{}],11:[function(require,module,exports){
Tessitura.FachModel=Tessitura.Model.extend({urlRoot:function(){return Tessitura.API.fachs.collection},displayTitle:function(){var t=this.get("type").charAt(0).toUpperCase()+this.get("type").slice(1);return this.get("quality")&&(t=t.concat(", "+this.get("quality"))),this.get("coloratura")===!0&&(t=t.concat(", coloratura")),t}}),module.exports=Tessitura.FachModel;
},{}],12:[function(require,module,exports){
Tessitura.OrganizationModel=Tessitura.ProtectedResource.extend({urlRoot:"/organizations",klass:"OrganizationModel",cityStateZip:function(){var e=this.get("city")||"",t=this.get("region")||"",i=this.get("postal_code")||"";if(e.length||t.length||i.length){var a=(t+" "+i).replace(/\s+$/,"");return e&&(a=a.length?(e+", "+a).replace(/\s{2,}/," "):e),a}}}),module.exports=Tessitura.OrganizationModel;
},{}],13:[function(require,module,exports){
Tessitura.ProtectedResource=Tessitura.Model.extend({token:function(){return"Basic "+$.cookie("auth")},klass:"ProtectedResourceModel",destroy:function(e){e=e||{};var t=this;return e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",t.token())},Backbone.Model.prototype.destroy.call(this,e)},fetch:function(e){e=e||{};var t=this;return e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization",t.token())},Backbone.Model.prototype.fetch.call(this,e)},save:function(e,t){t=t||{},e=e||this.attributes;var o=this;return t.beforeSend=function(e){e.setRequestHeader("Authorization",o.token())},Backbone.Model.prototype.save.call(this,e,t)},types:function(){return Tessitura.Model.prototype.types().concat(["ProtectedResourceModel","ProtectedResource"])}}),module.exports=Tessitura.ProtectedResource;
},{}],14:[function(require,module,exports){
Tessitura.TaskModel=Tessitura.ProtectedResourceModel.extend({urlRoot:function(){return Tessitura.API.tasks.collection($.cookie("userID"))},url:function(){return Tessitura.API.tasks.single(this.get("id"))},defaults:{priority:"Normal",status:"New"},klass:"TaskModel",parent:"ProtectedResourceModel",types:function(){return Tessitura.ProtectedResourceModel.prototype.types().concat(["TaskModel","Task"])},complete:function(){return"Complete"===this.get("status")},displayTitle:function(t){var t=t||60,e=this.get("title");if(e.length>t){var s=e.substring(0,t-1).split(" ");return s.pop(),s.join(" ")+" ..."}return e},incomplete:function(){return"Complete"!=this.get("status")},prettyDeadline:function(){return Tessitura.Utils.prettyDate(this.escape("deadline"))},fetch:function(t){return t=t||{},t.url=t.url||this.url(),Tessitura.ProtectedResourceModel.prototype.fetch.call(this,t)},initialize:function(){},save:function(t,e){return t=t||this.attributes,e=e||{},e.url=this.isNew()?this.urlRoot():this.url(),Tessitura.ProtectedResourceModel.prototype.save.call(this,t,e)},validate:function(t){return t.title?void 0:"Title is required"}}),module.exports=Tessitura.TaskModel;
},{}],15:[function(require,module,exports){
var TessituraModel=Backbone.Model.extend({klass:"Tessitura.Model",family:"Tessitura.Model",superFamily:"Backbone.Model",types:function(){return["Backbone.Model","Tessitura.Model"]},isA:function(e){return this.types().indexOf(e)>-1?!0:!1}});module.exports=TessituraModel;
},{}],16:[function(require,module,exports){
Tessitura.UserModel=Tessitura.Model.extend({urlRoot:Tessitura.API.users.collection,klass:"UserModel",types:function(){return Tessitura.Model.prototype.types().concat(["UserModel","User"])},login:function(e){e=e||{};var t=this;return e.type=e.type||"POST",e.url=Tessitura.API.login,e.beforeSend=function(e){e.setRequestHeader("Authorization","Basic "+btoa(t.get("username")+":"+t.get("password")))},Tessitura.Model.prototype.fetch.call(this,e)},prettyCreateDate:function(){return Tessitura.Utils.prettyDate(this.get("created_at"))},fetch:function(e){e=e||{};var t=this;e.url=Tessitura.API.users.single(this.get("id")),e.beforeSend=e.beforeSend||function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))};var s=e.success||function(){};return e.success=function(e,r,i){s(e,r,i),e.get("fach_id")&&(t.Fach=new Tessitura.FachModel({id:e.get("fach_id")}),t.Fach.fetch())},Backbone.Model.prototype.fetch.call(this,e)},initialize:function(e){this.tasks=new Tessitura.TaskCollection}}),module.exports=Tessitura.UserModel;
},{}],17:[function(require,module,exports){
Tessitura.AppPresenter=Tessitura.Model.extend({klass:"AppPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["AppPresenter","Presenter"])},isAn:function(e){return this.isA(e)},emitRedirect:function(e){this.trigger("redirect",e)},getHomepage:function(){this.homepageView.render(),this.homepageView.$el.is(":visible")||$("body").html(this.homepageView.$el)},removeAll:function(){this.homepageView.remove()},initialize:function(){this.homepageView=new Tessitura.HomepageView,this.listenTo(this.homepageView,"redirect",this.emitRedirect),this.listenTo(this.homepageView,"top",this.scrollToTop)}}),module.exports=Tessitura.AppPresenter;
},{}],18:[function(require,module,exports){
Tessitura.DashboardPresenter=Tessitura.Model.extend({klass:"DashboardPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["Presenter","DashboardPresenter"])},getHome:function(){this.showDash();var e=this.current!==this.dashboardHomeView;this.current=this.dashboardHomeView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardHomeView.render(),this.dashboardView.$el.append(this.dashboardHomeView.$el))},getLocal:function(){this.showDash();var e=this.current!==this.dashboardLocalView;this.current=this.dashboardLocalView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardLocalView.render(),this.dashboardView.$el.append(this.dashboardLocalView.$el))},getProfile:function(){this.showDash();var e=this.current!==this.dashboardProfileView;this.current=this.dashboardProfileView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardProfileView.render(),this.dashboardView.$el.append(this.dashboardProfileView.$el))},getTask:function(){this.showDash();var e=this.current!==this.dashboardTaskView;this.current=this.dashboardTaskView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardTaskView.render(),this.dashboardView.$el.append(this.dashboardTaskView.$el))},hideShade:function(){this.editForm&&this.editForm.remove(),this.taskCreateForm&&this.taskCreateForm.remove(),this.dashboardView.$("#shade").hide()},emitRedirect:function(e){this.trigger("redirect",e)},showTaskCreateForm:function(e,s){s=s||{},this.taskCreateForm=this.taskCreateForm||new Tessitura.TaskCreateFormView,this.taskCreateForm.status=s.status,this.taskCreateForm.setCollection(e).render(),this.dashboardView.$("#shade").show(),this.dashboardView.$("#shade").html(this.taskCreateForm.$el),this.taskCreateForm.$("input").first().focus(),this.listenTo(this.taskCreateForm,"hideShade",this.hideShade)},showTaskEditForm:function(e){this.editForm=this.editForm||new Tessitura.TaskEditFormView,this.editForm.setModel(e).render(),this.dashboardView.$("#shade").show(),this.dashboardView.$("#shade").html(this.editForm.$el),this.editForm.$("input").first().focus().select(),this.listenTo(this.editForm,"hideShade",this.hideShade)},clearViews:function(){var e=this;_.each(this.views,function(s){s!==e.current&&s!==e.dashboardView&&s.remove()})},removeAll:function(){this.dashboardView.remove()},setUser:function(e,s){var i=this;this.user&&this.user.get("id")===e.get("id")||(this.user=e,this.user.fetch({success:function(){i.user.tasks.fetch({success:function(t){_.each(i.views,function(s){s.setUser&&s.setUser(e)}),s&&s(t)}})}}))},showDash:function(){this.dashboardView.$el.is(":visible")||(this.dashboardView.render(),$("body").html(this.dashboardView.$el))},initialize:function(e){e=e||{},this.dashboardView=new Tessitura.DashboardView,this.dashboardHomeView=new Tessitura.DashboardHomeView,this.dashboardTaskView=new Tessitura.DashboardTaskView,this.dashboardProfileView=new Tessitura.DashboardProfileView,this.dashboardLocalView=new Tessitura.DashboardLocalView,this.views=[this.dashboardView,this.dashboardHomeView,this.dashboardTaskView,this.dashboardProfileView,this.dashboardLocalView],e.user&&this.setUser(e.user),_.bindAll(this,"showDash","getHome","getLocal","getTask","getProfile","setUser","emitRedirect","removeAll"),this.listenTo(this.dashboardView,"redirect",this.emitRedirect),this.listenTo(this.dashboardView,"hideShade",this.hideShade),this.listenTo(this.dashboardHomeView,"showTaskCreateForm",this.showTaskCreateForm),this.listenTo(this.dashboardTaskView,"showTaskCreateForm",this.showTaskCreateForm),this.listenTo(this.dashboardTaskView,"showEditForm",this.showTaskEditForm),this.listenTo(this.dashboardHomeView,"showEditForm",this.showTaskEditForm)}}),module.exports=Tessitura.DashboardPresenter;
},{}],19:[function(require,module,exports){
Tessitura.Router=Backbone.Router.extend({klass:"Tessitura.Router",types:function(){return["Tessitura.Router","Router","Backbone.Router"]},isA:function(e){return this.types().indexOf(e)>-1?!0:!1},initialize:function(){this.AppPresenter=new Tessitura.AppPresenter,this.DashboardPresenter=new Tessitura.DashboardPresenter,this.listenTo(this.AppPresenter,"redirect",this.navigateTo),this.listenTo(this.DashboardPresenter,"redirect",this.navigateTo)},navigateTo:function(e){e.user&&["dashboard","tasks"].indexOf(e.destination)>-1&&this.DashboardPresenter.setUser(e.user),this.navigate(e.destination,{trigger:!0})},userLoggedIn:function(){return!!$.cookie("userID")&&!!$.cookie("auth")},routes:{"(/)":"displayHomepage","home(/)":"displayHomepage","dashboard(/)":"displayDashboardHome","local(/)":"displayDashboardLocal","logout(/)":"logOut","prepare(/)":"prepareTestEnvironment","profile(/)":"displayDashboardProfile","tasks(/)":"displayDashboardTaskView","*actions":"defaultAction"},before:{"dashboard(/)":"verifyLoggedIn","tasks(/)":"verifyLoggedIn","(/)":"rerouteIfLoggedIn"},defaultAction:function(e){console.log("No route for ",e)},displayDashboardHome:function(){var e=this;this.DashboardPresenter.setUser(new Tessitura.UserModel({id:$.cookie("userID")}),function(){e.DashboardPresenter.getHome()})},displayDashboardLocal:function(){var e=this;this.DashboardPresenter.setUser(new Tessitura.UserModel({id:$.cookie("userID")}),function(){e.DashboardPresenter.getLocal()})},displayDashboardProfile:function(){var e=this;this.DashboardPresenter.setUser(new Tessitura.UserModel({id:$.cookie("userID")}),function(){e.DashboardPresenter.getProfile()})},displayDashboardTaskView:function(){var e=this;this.DashboardPresenter.setUser(new Tessitura.UserModel({id:$.cookie("userID")}),function(){e.DashboardPresenter.getTask()})},displayHomepage:function(){this.DashboardPresenter.removeAll(),this.AppPresenter.getHomepage()},logOut:function(){$.removeCookie("auth"),$.removeCookie("userID"),this.navigate("",{trigger:!0})},prepareTestEnvironment:function(){$.ajax({type:"POST",url:"http://api.canto-test.com:1025/destroy"})},rerouteIfLoggedIn:function(e,s,r){this.userLoggedIn()?(this.AppPresenter.removeAll(),this.navigate("dashboard",{trigger:!0})):r()},verifyLoggedIn:function(e,s,r){this.userLoggedIn()?r():this.navigate("/",{trigger:!0})}}),module.exports=Tessitura.Router;
},{}],20:[function(require,module,exports){
(function (global){
require("./tessitura.js"),global.Router=new Tessitura.Router,Backbone.history.start();
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})

},{"./tessitura.js":21}],21:[function(require,module,exports){
(function (global,Buffer){
global.document=window.document,global.navigator=window.navigator,global.$=global.jQuery=require("jquery"),global._=require("underscore"),global.Backbone=Backbone=require("backbone"),global.JST=require("../templates/jst.js"),global.btoa=function(e){return new Buffer(e).toString("base64")},global.atob=function(e){return new Buffer(e,"base64").toString("binary")},Backbone.$=$,require("jquery.cookie"),require("bootstrap-sass"),require("../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js"),require("../vendor/backbone-route-filter.js"),require("./views/backboneViewMods.js"),require("./collections/backboneCollectionMods.js"),global.Tessitura=Tessitura={},Tessitura.API=require("./api.js"),Tessitura.Utils=require("./utils.js"),Tessitura.Model=require("./models/tessituraModel.js"),Tessitura.FachModel=require("./models/fachModel.js"),Tessitura.ProtectedResourceModel=require("./models/protectedResourceModel.js"),Tessitura.OrganizationModel=require("./models/organizationModel.js"),Tessitura.TaskModel=require("./models/taskModel.js"),Tessitura.UserModel=require("./models/userModel.js"),Tessitura.ProtectedCollection=require("./collections/protectedCollection.js"),Tessitura.OrganizationCollection=require("./collections/organizationCollection.js"),Tessitura.TaskCollection=require("./collections/taskCollection.js"),Tessitura.View=require("./views/appViews/tessituraView.js"),Tessitura.DashboardView=require("./views/appViews/dashboardView.js"),Tessitura.HomepageView=require("./views/appViews/homepageView.js"),Tessitura.DashWidgetView=require("./views/appViews/dashWidgetView.js"),Tessitura.FachFormView=require("./views/modelViews/fachViews/fachFormView.js"),Tessitura.OrganizationCollectionView=require("./views/collectionViews/organizationCollectionView"),Tessitura.OrganizationListItemView=require("./views/modelViews/organizationViews/organizationListItemView.js"),Tessitura.QuickAddFormView=require("./views/modelViews/taskViews/quickAddFormView.js"),Tessitura.TaskCreateFormView=require("./views/modelViews/taskViews/taskCreateFormView.js"),Tessitura.TaskEditFormView=require("./views/modelViews/taskViews/taskEditFormView.js"),Tessitura.TaskListItemView=require("./views/modelViews/taskViews/taskListItemView.js"),Tessitura.UserModelView=require("./views/modelViews/userViews/userModelView.js"),Tessitura.UserProfileView=require("./views/modelViews/userViews/userProfileView.js"),Tessitura.CalendarView=require("./views/partialViews/calendarView.js"),Tessitura.DashboardHomeView=require("./views/partialViews/dashboardHomeView.js"),Tessitura.DashboardLocalView=require("./views/partialViews/dashboardLocalView.js"),Tessitura.DashboardNavView=require("./views/partialViews/dashboardNavView.js"),Tessitura.DashboardProfileView=require("./views/partialViews/dashboardProfileView.js"),Tessitura.DashboardSidebarView=require("./views/partialViews/dashboardSidebarView.js"),Tessitura.DashboardTopWidgetView=require("./views/partialViews/dashboardTopWidgetView.js"),Tessitura.DashboardTaskView=require("./views/partialViews/dashboardTaskView.js"),Tessitura.ErrorPanelView=require("./views/partialViews/errorPanelView.js"),Tessitura.KanbanColumnView=require("./views/partialViews/kanbanColumnView.js"),Tessitura.LoginFormView=require("./views/partialViews/loginFormView.js"),Tessitura.RegistrationFormView=require("./views/partialViews/registrationFormView.js"),Tessitura.TaskPanelView=require("./views/partialViews/taskPanelView.js"),Tessitura.AppPresenter=require("./presenters/appPresenter.js"),Tessitura.DashboardPresenter=require("./presenters/dashboardPresenter.js"),Tessitura.Router=Tessitura.Router||require("./routers/tessituraRouter.js");
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer)

},{"../templates/jst.js":57,"../vendor/backbone-route-filter.js":80,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":81,"./api.js":5,"./collections/backboneCollectionMods.js":7,"./collections/organizationCollection.js":8,"./collections/protectedCollection.js":9,"./collections/taskCollection.js":10,"./models/fachModel.js":11,"./models/organizationModel.js":12,"./models/protectedResourceModel.js":13,"./models/taskModel.js":14,"./models/tessituraModel.js":15,"./models/userModel.js":16,"./presenters/appPresenter.js":17,"./presenters/dashboardPresenter.js":18,"./routers/tessituraRouter.js":19,"./utils.js":22,"./views/appViews/dashWidgetView.js":23,"./views/appViews/dashboardView.js":24,"./views/appViews/homepageView.js":25,"./views/appViews/tessituraView.js":26,"./views/backboneViewMods.js":27,"./views/collectionViews/organizationCollectionView":28,"./views/modelViews/fachViews/fachFormView.js":29,"./views/modelViews/organizationViews/organizationListItemView.js":30,"./views/modelViews/taskViews/quickAddFormView.js":31,"./views/modelViews/taskViews/taskCreateFormView.js":32,"./views/modelViews/taskViews/taskEditFormView.js":33,"./views/modelViews/taskViews/taskListItemView.js":34,"./views/modelViews/userViews/userModelView.js":35,"./views/modelViews/userViews/userProfileView.js":36,"./views/partialViews/calendarView.js":37,"./views/partialViews/dashboardHomeView.js":38,"./views/partialViews/dashboardLocalView.js":39,"./views/partialViews/dashboardNavView.js":40,"./views/partialViews/dashboardProfileView.js":41,"./views/partialViews/dashboardSidebarView.js":42,"./views/partialViews/dashboardTaskView.js":43,"./views/partialViews/dashboardTopWidgetView.js":44,"./views/partialViews/errorPanelView.js":45,"./views/partialViews/kanbanColumnView.js":46,"./views/partialViews/loginFormView.js":47,"./views/partialViews/registrationFormView.js":48,"./views/partialViews/taskPanelView.js":49,"backbone":50,"bootstrap-sass":51,"buffer":1,"jquery":53,"jquery.cookie":52,"underscore":55}],22:[function(require,module,exports){
module.exports={getAttributes:function(e){var r=e.serializeArray(),a={};for(var t in r)if(r.hasOwnProperty(t)){var u=r[t].name;""!==r[t].value&&(a[u]=r[t].value)}return a},prettyDate:function(e){if(!e)return"";var r=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],a=["January","February","March","April","May","June","July","August","September","October","November","December"],t=new Date(e),u=r[t.getDay()]+", "+a[t.getMonth()]+" "+t.getDate()+", "+t.getFullYear();return u}};
},{}],23:[function(require,module,exports){
Tessitura.DashWidgetView=Tessitura.View.extend({className:function(){return"panel panel-primary dash-widget"},template:_.template('<div class="panel-heading"><span class="toggle-widget"><i class="fa fa-minus fa-fw"></i></span></div></div><div class="panel-body"></div>'),events:{"click span.toggle-widget > i":"toggleWidget"},toggleWidget:function(e){this.$(".panel-body").slideToggle(),$(e.target).toggleClass("fa-minus fa-plus")},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.DashWidgetView;
},{}],24:[function(require,module,exports){
Tessitura.DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,events:{click:"hideDropdownMenus",dblclick:"hideSidebar","click .internal-link":"followLink","dblclick #shade":"hideShade"},emitRedirect:function(e){this.trigger("redirect",e)},followLink:function(e){var i=$(e.target).closest(".internal-link"),t=i.attr("data-target");this.emitRedirect({destination:t})},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},hideShade:function(e){var i="dblclick"===e.type&&$("form").has(e.target).length;i||this.trigger("hideShade")},hideSidebar:function(e){if(e)var i=$(e.target);i!==this.$("#side-menu")&&0===this.$(".navbar-static-side").has(i).length&&this.$("#side-menu").is(":visible")&&this.$(".sidebar-collapse").slideUp()},setUser:function(e){return this.model=e,this.navView.setUser(e),this},initialize:function(){this.navView=new Tessitura.DashboardNavView,this.childViews=[this.navView],this.model&&this.setUser(this.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.navView.render(),e.navView.$el.is(":visible")||e.$el.prepend(e.navView.$el)})}}),module.exports=Tessitura.DashboardView;
},{}],25:[function(require,module,exports){
Tessitura.HomepageView=Tessitura.View.extend({template:JST.homepage,id:"homepage-wrapper",events:{"click nav li .login-link":"toggleLoginForm","dblclick #shade":"hideLoginForm"},klass:"HomepageView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["HomepageView","TopLevelView"])},goToDashboard:function(e){var i=_.extend(e,{destination:"dashboard"});this.trigger("redirect",i)},hideLoginForm:function(e){var i=$(e.target);"login-form"!==i.attr("id")&&0===this.loginForm.$el.has(i).length&&(this.$("#shade").hide(),this.$("div.text-vertical-center").children().show())},toggleLoginForm:function(){$.cookie("auth")?this.trigger("redirect",{destination:"dashboard"}):(this.$("div.text-vertical-center").children().toggle(),this.$("#shade").toggle())},initialize:function(){this.loginForm=new Tessitura.LoginFormView,this.registrationForm=new Tessitura.RegistrationFormView,this.childViews=[this.loginForm,this.registrationForm],this.listenTo(this.registrationForm,"userCreated",this.goToDashboard),this.listenTo(this.loginForm,"userLoggedIn",this.goToDashboard)},remove:function(){this.loginForm.remove(),this.registrationForm.remove(),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.registrationForm.render(),e.$("section#register div.col-md-12").html(e.registrationForm.$el),e.loginForm.render(),e.$("#shade").html(e.loginForm.$el)})}}),module.exports=Tessitura.HomepageView;
},{}],26:[function(require,module,exports){
Tessitura.View=Backbone.View.extend({klass:"Tessitura.View",family:"Backbone.View",superFamily:"",types:function(){return Backbone.View.prototype.types().concat(["Tessitura.View"])},isA:function(e){return this.types().indexOf(e)>-1?!0:!1},render:function(e,t,i){return this.$el.html(e),t&&t(i),this.delegateEvents(),this}}),module.exports=Tessitura.View;
},{}],27:[function(require,module,exports){
require("backbone"),require("underscore"),Backbone.View.prototype.klass="Backbone.View",Backbone.View.prototype.types=function(){return["Backbone.View"]},Backbone.View.prototype.destroyChildren=function(){if(this.childViews)for(var e=this.childViews.length,t=0;e>t;t++)this.childViews[t].destroy()},Backbone.View.prototype.destroy=function(){this.beforeClose&&this.beforeClose(),this.hasOwnProperty("destroyChildren")&&this.destroyChildren(),this.undelegateEvents(),this.$el.removeData().unbind(),this.remove(),Backbone.View.prototype.remove.call(this)},Backbone.View.prototype.isA=function(e){return this.types().indexOf(e)>-1?!0:!1};
},{"backbone":50,"underscore":55}],28:[function(require,module,exports){
Tessitura.OrganizationCollectionView=Tessitura.View.extend({id:"organization-list",className:"well",template:JST["collections/organization"],renderCollection:function(){var e=this,i=document.createDocumentFragment();return e.collection.each(function(t){var n=e.retrieveViewForModel(t)||new Tessitura.OrganizationListItemView({model:t});-1===e.childViews.indexOf(n)&&e.childViews.push(n),n.render(),i.appendChild(n.el)}),this.$("ul").first().html(i),this},retrieveViewForModel:function(e){if(this.childViews.length){var i,t=this;return _.each(t.childViews,function(t){t.model&&t.model.get("id")===e.get("id")&&(i=t)}),i}},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.renderCollection()})},initialize:function(e){e=e||{},this.childViews=[],this.collection=e.collection||new Tessitura.OrganizationCollection,this.collection.fetch()}}),module.exports=Tessitura.OrganizationCollectionView;
},{}],29:[function(require,module,exports){
Tessitura.FachFormView=Tessitura.View.extend({template:JST["fachs/form"],tagName:"form",render:function(){return Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}}),module.exports=Tessitura.FachFormView;
},{}],30:[function(require,module,exports){
Tessitura.OrganizationListItemView=Tessitura.View.extend({tagName:"li",className:"organization-list-item-view",template:JST["orgs/listItem"],render:function(){return Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}}),module.exports=Tessitura.OrganizationListItemView;
},{}],31:[function(require,module,exports){
Tessitura.QuickAddFormView=Tessitura.View.extend({tagName:"form",className:"task-form create-form quick-add-form",template:JST["tasks/quickAdd"],events:{"click span.pull-right > i":"showTaskCreateForm",submit:"createTask"},createTask:function(e){e.preventDefault();var t=this,i=Tessitura.Utils.getAttributes(this.$el);if(_.each(this.groupedBy,function(e,t){i[t]=e}),i.position=i.position||1,i.title){var s=new Tessitura.TaskModel;s.save(i,{success:function(e){t.$el[0].reset(),t.collection.unshift(e)}})}},showTaskCreateForm:function(){this.trigger("showTaskCreateForm",this.collection,this.groupedBy)},initialize:function(e){e=e||{},_.extend(this,e)},render:function(e){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.QuickAddFormView;
},{}],32:[function(require,module,exports){
Tessitura.TaskCreateFormView=Tessitura.View.extend({tagName:"form",id:"task-create-form",template:JST["tasks/createForm"],events:{submit:"createTask"},createTask:function(e){e.preventDefault();var t=Tessitura.Utils.getAttributes(this.$el),s=this;if(!t.title)return void this.$("input[name=title]").closest(".form-group").addClass("has-error");var r=new Tessitura.TaskModel;r.save(t,{success:function(e){s.trigger("hideShade"),s.collection.unshift(e)}})},setCollection:function(e){return this.collection=e,this},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template({status:e.status}))}}),module.exports=Tessitura.TaskCreateFormView;
},{}],33:[function(require,module,exports){
Tessitura.TaskEditFormView=Tessitura.View.extend({tagName:"form",id:"task-edit-form",template:JST["tasks/editForm"],events:{"click button":"updateTask",submit:"updateTask"},setModel:function(t){return this.model=t,this},updateTask:function(t){t.preventDefault();var e=Tessitura.Utils.getAttributes(this.$el);if(!e.title)return void this.$("input[name=title]").closest(".form-group").addClass("has-error");var s=this;this.model.save(e,{success:function(){s.trigger("hideShade")}})},render:function(){return Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}}),module.exports=Tessitura.TaskEditFormView;
},{}],34:[function(require,module,exports){
Tessitura.ListItemView=Tessitura.View.extend({tagName:"li",className:"task-list-item ui-widget-content ui-sortable-handle",id:function(){return"task-"+this.model.get("id")},template:JST["tasks/listItem"],events:{"click i[title=Edit]":"showEditForm","click i[title=Delete]":"deleteTask","click i[title=Backlog]":"backlogTask","click .fa-square-o":"markComplete","click .task-title":"toggleTaskDetails",mouseenter:"showEditIcons",mouseleave:"hideEditIcons"},backlogTask:function(){this.model.save({backlog:!0})},deleteTask:function(){this.model.destroy()},hideEditIcons:function(){this.$("span.edit-task").hide()},markComplete:function(){this.model.save({status:"Complete"}),this.$(".fa-square-o").removeClass("fa-square-o").addClass("fa-check-square-o"),this.$("a.task-title").css("text-decoration","line-through")},renderOnSync:function(){"Complete"!==this.model.get("status")&&this.render()},showEditForm:function(){this.trigger("showEditForm",this.model)},showEditIcons:function(){this.$("span.edit-task").show()},toggleTaskDetails:function(t){t&&t.preventDefault(),this.$el.toggleClass("open",{duration:400}),this.$(".task-details").slideToggle()},initialize:function(t){t=t||{},_.extend(this,t),this.listenTo(this.model,"sync",this.renderOnSync)},render:function(){var t=this;return Tessitura.View.prototype.render.call(this,this.template({model:t.model,width:t.width}),function(){t.$el.removeAttr("style")})}}),module.exports=Tessitura.ListItemView;
},{}],35:[function(require,module,exports){
Tessitura.UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],events:{"dblclick span.p":"displayForm","keydown input":"triageKeypress","keydown select":"triageKeypress","submit form":"submitUpdate"},displayForm:function(e){var t=e.target?$(e.target).attr("class")&&$(e.target).attr("class").match(/profile-field/)?$(e.target):$(e.target).closest(".profile-field"):$(e);t.find(".p").hide(),t.find(".form").show(),this.resizeInputs(t),t.find("form > input, form > select").focus().select()},handleTab:function(e){e.preventDefault();var t=$(e.target).attr("name"),s=encodeURIComponent($(e.target)[0].value),i="first_name"===$(e.target).closest(".profile-field").attr("id")?this.$("#last_name"):$(e.target).closest("tr").next().find("td > span.profile-field"),a=this.model.get(t)!==s,r=!s||""===s,o=-1===["username","password","email","first_name","last_name"].indexOf(t);!a||r&&o||$(e.target).closest("form").submit(),this.hideInputs(),this.displayForm(i)},submitUpdate:function(e){e.preventDefault();var t={},t=Tessitura.Utils.getAttributes($(e.target));this.model.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},error:function(e,t,s){console.log("Model: ",e),console.log("Response: ",t),console.log("Options: ",s)},success:function(s){if(t.username||t.password){var i=$.cookie(),a=$.cookie("auth");for(var r in i)$.removeCookie(r);var o=t.password||atob(a).split(":")[1];$.cookie("auth",btoa(s.get("username")+":"+o)),$.cookie("userID",s.get("id"))}$(e.target).closest("span.form").hide()}})},triageKeypress:function(e){var t=13===e.keyCode,s=9===e.keyCode,i=27===e.keyCode,a=$(e.target).attr("name"),r=encodeURIComponent($(e.target)[0].value);if(t){e.preventDefault();var o=this.model.get(a)!==r,n=""===r,l=-1===["username","email","password","first_name","last_name"].indexOf(a);this.hideInputs(),!o||n&&l||$(e.target).closest("form").submit()}s&&this.handleTab(e),i&&this.hideInputs()},updateDisplay:function(){var e=this;this.$(".profile-field").each(function(t,s){var i=$(s).attr("id"),a=e.model.get(i);$(s).find(".p").html(a||"N/A"),$(s).find("input").attr("value",a)})},hideInputs:function(){this.$("span.form").hide(),this.$("span.p").show()},resizeInputs:function(e){if(["first_name","last_name"].indexOf(e.attr("id"))>-1){var t=parseInt(e.find(".p").css("width").match(/\d*/)[0])+10;e.find("input").css("width",t+"px")}},initialize:function(){this.fachForm=new Tessitura.FachFormView({model:this.model.fach}),this.listenTo(this.model,"change",this.updateDisplay)},render:function(){var e=this;return Tessitura.View.prototype.render.call(e,e.template({model:e.model}))}}),module.exports=Tessitura.UserModelView;
},{}],36:[function(require,module,exports){
Tessitura.UserProfileView=Tessitura.DashWidgetView.extend({id:"profile-info",template:JST["users/profile"],events:{click:"hideInputs"},hideInputs:function(){this.modelView.hideInputs()},updateTitle:function(){var e=this.model.escape("first_name")+" "+this.model.escape("last_name")+"'s Profile";this.$("h4").html(e)},setUser:function(e){return this.model=e,this.modelView=new Tessitura.UserModelView({model:e}),this.childViews=[this.modelView],this.listenTo(this.model,"change:first_name change:last_name",this.updateTitle),this},initialize:function(e){e=e||{},_.extend(this.events,Tessitura.DashWidgetView.prototype.events),e.model&&this.setUser(e.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template({model:e.model}),function(){e.modelView.render(),e.$("#profile-tab > h4").first().after(e.modelView.$el)})}}),module.exports=Tessitura.UserProfileView;
},{}],37:[function(require,module,exports){
var moment=require("moment");Tessitura.CalendarView=Tessitura.DashWidgetView.extend({template:JST.calendar,id:"calendar",displayDays:function(){for(var a=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],e=[],t=-1;2>t;t++)e.push(a[moment().add(t,"days").day()]);return e},initialize:function(a){},render:function(){return this.$el.html(this.template({days:this.displayDays()})),this}}),module.exports=Tessitura.CalendarView;
},{"moment":54}],38:[function(require,module,exports){
Tessitura.DashboardHomeView=Tessitura.View.extend({template:JST["partials/dashHome"],id:"page-wrapper",className:"dashboard-home",showTaskCreateForm:function(e){this.trigger("showTaskCreateForm",e)},showEditForm:function(e){this.trigger("showEditForm",e)},renderCalendarView:function(){this.calendarView.render(),this.$("div.col-lg-8").first().html(this.calendarView.$el)},renderTaskPanelView:function(){this.taskPanelView.render(),this.$("div.col-lg-4").first().html(this.taskPanelView.$el)},renderTopWidgetView:function(){this.topWidgetView.render(),this.$(".row").first().html(this.topWidgetView.$el)},setUser:function(e){this.user=e,this.collection=this.user.tasks;var i=this;return this.taskPanelView=new Tessitura.TaskPanelView({collection:this.collection}),this.topWidgetView=new Tessitura.DashboardTopWidgetView({taskCollection:i.user.tasks,deadlineCount:7,appointmentCount:4,recommendationCount:14}),this.calendarView=new Tessitura.CalendarView({user:this.user}),this.childViews=[this.calendarView,this.taskPanelView,this.topWidgetView],this.listenTo(this.taskPanelView,"showEditForm",this.showEditForm),this.listenTo(this.taskPanelView,"showTaskCreateForm",this.showTaskCreateForm),this},initialize:function(e){e=e||{},e.user&&this.setUser(e.user)},remove:function(){try{this.calendarView.remove(),this.taskPanelView.remove(),this.topWidgetView.remove()}catch(e){if(!(this.calendarView&&this.taskPanelView&&this.topWidgetView))return}Tessitura.View.prototype.remove.call(this)},render:function(e){e=e||{};var i=this;return Tessitura.View.prototype.render.call(i,i.template(),function(){i.taskPanelView&&i.renderTaskPanelView(),i.topWidgetView&&i.renderTopWidgetView(),i.calendarView&&i.renderCalendarView()})}}),module.exports=Tessitura.DashboardHomeView;
},{}],39:[function(require,module,exports){
Tessitura.DashboardLocalView=Tessitura.View.extend({id:"page-wrapper",template:JST["partials/dashLocal"],setUser:function(e){this.user=e},events:{"submit #location-form":"updateProfile"},updateProfile:function(e){e.preventDefault();var t={},i=this,t=Tessitura.Utils.getAttributes($(e.target));this.user.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},success:function(){i.$("#location-form").closest(".alert").hide()},error:function(e,t){console.log("Unable to update user profile - error ",t)}})},setUser:function(e){this.user=e},initialize:function(e){e=e||{},e.user&&this.setUser(e.user),this.organizationCollectionView=new Tessitura.OrganizationCollectionView,this.childViews=[this.organizationCollectionView]},render:function(){var e=this,t=this.template({model:this.user});return Tessitura.View.prototype.render.call(this,t,function(){e.organizationCollectionView.render(),e.$(".col-md-9").last().html(e.organizationCollectionView.$el)})}}),module.exports=Tessitura.DashboardLocalView;
},{}],40:[function(require,module,exports){
Tessitura.DashboardNavView=Tessitura.View.extend({tagName:"nav",className:"navbar navbar-default navbar-fixed-top",template:JST["partials/dashNav"],klass:"DashboardNavView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashboardView","DashboardNavView","PartialView"])},events:{"click .navbar-brand":"toggleSidebar","click li.dropdown":"toggleDropdownMenu"},emitRedirect:function(e){e=e||{},this.$(".sidebar-collapse").slideUp(),this.trigger("redirect",{destination:e.destination})},redirectToDashboard:function(){this.emitRedirect({destination:"dashboard"})},redirectToProfile:function(){this.emitRedirect({destination:"profile"})},redirectToTaskPage:function(){this.emitRedirect({destination:"tasks"})},toggleDropdownMenu:function(e){var i=$(e.target).has("li");i.toggleClass("open"),$(e.target).blur()},toggleSidebar:function(){this.$("li.dropdown").removeClass("open"),this.$(".sidebar-collapse").slideToggle()},setUser:function(e){this.model=e,this.listenTo(this.model,"change:first_name change:last_name",this.render)},initialize:function(e){e=e||{},this.sidebarView=new Tessitura.DashboardSidebarView,this.childViews=[this.sidebarView],(e.user||e.model)&&this.setUser(e.user||e.model)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(e.model.attributes),function(){e.sidebarView.render(),e.$("div.sidebar-collapse").html(e.sidebarView.$el)})}}),module.exports=Tessitura.DashboardNavView;
},{}],41:[function(require,module,exports){
Tessitura.DashboardProfileView=Tessitura.View.extend({className:"user-profile",id:"page-wrapper",template:JST["partials/profile"],events:{click:"hideInputs"},types:function(){return Tessitura.View.prototype.types().concat("DashboardView","DashboardProfileView")},hideInputs:function(e){$(e.target).is("input")||this.profileView.hideInputs()},setUser:function(e){return this.model=e,this.profileView=new Tessitura.UserProfileView({model:e}),this.childViews=[this.profileView],this},initialize:function(e){e=e||{},e.model&&this.setUser(e.model),_.bindAll(this,"hideInputs")},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.profileView.render(),e.$(".col-md-8").html(e.profileView.$el)})}}),module.exports=Tessitura.DashboardProfileView;
},{}],42:[function(require,module,exports){
Tessitura.DashboardSidebarView=Tessitura.View.extend({tagName:"ul",className:"nav",id:"side-menu",template:JST["partials/sidebar"],events:{"click a.sidebar-link":"toggleSecondLevelNav"},toggleSecondLevelNav:function(e){var a=$(e.target).closest("li");a.hasClass("active")?a.removeClass("active").find(".nav-second-level").slideUp():(a.siblings("li").removeClass("active"),this.$(".nav-second-level:visible").slideUp(),a.addClass("active").find(".nav-second-level").slideDown())},getLocationHash:function(){return location.hash},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.DashboardSidebarView;
},{}],43:[function(require,module,exports){
Tessitura.DashboardTaskView=Tessitura.View.extend({template:JST["partials/dashTasks"],id:"page-wrapper",className:"dashboard-tasks",reassign:function(e,i,o){e=parseInt(e);var s=this.collection.get(e),n=this.findNewView(s);n.collection.remove(s),o.collection.add(s)},showTaskCreateForm:function(e,i){this.trigger("showTaskCreateForm",e,i)},showEditForm:function(e){this.trigger("showEditForm",e)},allocate:function(e){var i=this.findNewView(e);i.collection.add(e)},changeStatus:function(e){if("Complete"!==e.get("status")){var i=this.findNewView(e);i.collection&&i.collection.add([e])}},findNewView:function(e){var i,o=this,s=e.get("status");return e.get("backlog")===!0?this.backlogColumnView:(_.each([o.newColumnView,o.inProgressColumnView,o.blockingColumnView],function(e){e.headline===s&&(i=e)}),i)},setUser:function(e){this.user=e,this.collection=this.user.tasks||new Tessitura.TaskCollection;var i={newCollection:new Tessitura.TaskCollection(this.collection.where({status:"New"})),inProgressCollection:new Tessitura.TaskCollection(this.collection.where({status:"In Progress"})),blockingCollection:new Tessitura.TaskCollection(this.collection.where({status:"Blocking"})),backlogCollection:new Tessitura.TaskCollection(this.collection.where({backlog:!0}))};this.collection.setChildren(i)},initialize:function(e){e=e||{},this.childViews=[],e.user&&this.setUser(e.user)},remove:function(){this.childViews&&this.childViews.length&&_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return this.collection.fetch({success:function(i){e.backlogColumnView=new Tessitura.KanbanColumnView({collection:e.collection.children.backlogCollection,el:e.$("#backlog-tasks"),color:"red",icon:"fa-exclamation-circle",headline:"Backlog",groupedBy:{backlog:!0}}),e.newColumnView=new Tessitura.KanbanColumnView({collection:e.collection.children.newCollection,el:e.$("#new-tasks"),color:"blue",icon:"fa-certificate",headline:"New",groupedBy:{status:"New"}}),e.inProgressColumnView=new Tessitura.KanbanColumnView({collection:e.collection.children.inProgressCollection,el:e.$("#in-progress-tasks"),color:"green",icon:"fa-road",headline:"In Progress",groupedBy:{status:"In Progress"}}),e.blockingColumnView=new Tessitura.KanbanColumnView({collection:e.collection.children.blockingCollection,el:e.$("#blocking-tasks"),color:"yellow",icon:"fa-minus-circle",headline:"Blocking",groupedBy:{status:"Blocking"}}),e.childViews.push(e.backlogColumnView),e.childViews.push(e.newColumnView),e.childViews.push(e.inProgressColumnView),e.childViews.push(e.blockingColumnView),_.each(e.childViews,function(i){i.render(),e.listenTo(i,"showEditForm",e.showEditForm),e.listenTo(i,"showTaskCreateForm",e.showTaskCreateForm),e.listenTo(i,"reassign",e.reassign)}),e.listenTo(e.collection,"change:status",e.changeStatus),e.listenTo(e.collection,"change:backlog add",e.allocate)}}),Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.DashboardTaskView;
},{}],44:[function(require,module,exports){
Tessitura.DashboardTopWidgetView=Tessitura.View.extend({id:"dashboard-top-widgets",template:JST["partials/topWidgets"],initialize:function(t){this.data=t||{},_.extend(this,this.data),this.listenTo(this.taskCollection,"add remove change:status",this.render)},render:function(){Tessitura.View.prototype.render.call(this,this.template(this.data))}}),module.exports=Tessitura.DashboardTopWidgetView;
},{}],45:[function(require,module,exports){
Tessitura.ErrorPanelView=Tessitura.View.extend({className:"panel panel-danger",id:"error-panel",template:JST["partials/errorPanel"],initialize:function(e){this.errors=e},render:function(){var e=this.template({errors:this.errors});return Tessitura.View.prototype.render.call(this,e)}}),module.exports=Tessitura.ErrorPanelView;
},{}],46:[function(require,module,exports){
Tessitura.KanbanColumnView=Tessitura.View.extend({template:JST["partials/kanbanCol"],className:"panel dash-widget kanban-column",crossOff:function(e){if("Complete"===e.get("status")){var t=this,i=this.retrieveViewForModel(e);setTimeout(function(){i&&(t.childViews.splice(t.childViews.indexOf(i),1),i.destroy()),t.collection.remove(e)},750)}},removeTask:function(e){this.groupedBy.backlog&&e.get("backlog")||this.collection.remove(e)},showTaskCreateForm:function(){this.trigger("showTaskCreateForm",this.collection,this.groupedBy)},showEditForm:function(e){this.trigger("showEditForm",e)},updateAndRender:function(e){var t=this.groupedBy,i=this.groupedBy.status&&this.groupedBy.status!==e.get("status"),s=this.groupedBy.backlog&&!e.get("backlog"),o=i||s;if(!this.groupedBy.backlog&&e.get("backlog")&&(t.backlog=!1),o){var r=this;e.save(t,{success:function(){r.render()}})}else this.render()},receiveItem:function(e,t){var i=t.item.attr("id").match(/\d+$/)[0];this.trigger("reassign",i,this.groupedBy,this)},renderModels:function(){for(var e=this,t=document.createDocumentFragment(),i=Object.keys(this.groupedBy)[0],s=0;s<this.collection.length;s++){var o=this.collection.models[s];if(!o.get("backlog")||"backlog"===i){var r=e.retrieveViewForModel(o)||new Tessitura.TaskListItemView({model:o,width:30});-1===e.childViews.indexOf(r)&&e.childViews.push(r),e.listenTo(r,"showEditForm",e.showEditForm),r.render(),t.appendChild(r.el)}}return this.$("ul.task-list").append(t),this},retrieveViewForModel:function(e){if(this.childViews.length){var t;return _.each(this.childViews,function(i){i.model&&i.model.get("id")===e.get("id")&&(t=i)}),t}},setCollection:function(e){this.collection=e,this.listenTo(this.collection,"add",this.updateAndRender),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"change:backlog",this.removeTask)},initialize:function(e){e=e||{},_.extend(this,e),_.extend(this.models,Backbone.Events),this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection,groupedBy:this.groupedBy}),this.childViews=[this.quickAddForm],this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm),_.bindAll(this,"receiveItem"),this.$el.addClass("panel-"+this.color),this.collection&&this.setCollection(this.collection)},remove:function(){this.childViews.length&&_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;Tessitura.View.prototype.render.call(this,this.template({data:this}),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderModels(),e.$("ul.task-list").sortable({connectWith:".ui-sortable",appendTo:".ui-sortable",items:">*:not(.not-sortable)",receive:e.receiveItem})})}}),module.exports=Tessitura.KanbanColumnView;
},{}],47:[function(require,module,exports){
Tessitura.LoginFormView=Tessitura.View.extend({template:JST["partials/loginForm"],tagName:"form",id:"login-form",events:{submit:"loginUser","click .login-help-link":"loginHelp"},loginHelp:function(e){console.log("Haha, you're boned!")},loginUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el),o=btoa(r.username+":"+r.password),i=this,s=new Tessitura.UserModel({username:r.username,password:r.password});s.login({success:function(e){r.remember?$.cookie("auth",o,{expires:365}):$.cookie("auth",o),r.remember?$.cookie("userID",s.id,{expires:365}):$.cookie("userID",s.get("id")),i.trigger("userLoggedIn",{user:e})},error:function(e,r){console.log(r)}})},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.LoginFormView;
},{}],48:[function(require,module,exports){
Tessitura.RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},reqdFields:{username:"Username",password:"Password",passwordConfirmation:"Password confirmation",email:"E-mail",emailConfirmation:"emailConfirmation",first_name:"First name",last_name:"Last name"},createUser:function(r){r.preventDefault();var e=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(e)!==!0)return this.errorPanelView.errors=this.errors,this.errorPanelView.render(),void this.$el.prepend(this.errorPanelView.$el);var s=new Tessitura.UserModel,a=btoa(e.username+":"+e.password),t=this;delete e.passwordConfirmation,delete e.emailConfirmation,s.save(e,{success:function(r){$.cookie("auth",a),$.cookie("userID",r.id),t.trigger("userCreated",{user:s})}})},removeError:function(){this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){var r=!this.$("input[name=acceptTerms]").prop("checked");this.$("input[name=acceptTerms]").prop(r),this.removeError()},validateForm:function(r){this.errors=this.errors||[];var e,s,a;return e=!!r.acceptTerms,e||(this.errors.push("Please accept terms of service"),this.$("fieldset.form-group.terms").addClass("has-error"),e=!1),s=this.validCreds(r.username,r.password,r.passwordConfirmation,r.email,r.emailConfirmation),a=this.validName(r.first_name,r.last_name),delete r.acceptTerms,e&&s&&a},validCreds:function(r,e,s,a,t){this.errors=this.errors||[];var i=this.validPassword(e,s),o=this.validUsername(r),n=this.validEmail(a,t);return e&&-1!==e.indexOf(r)&&(this.errors.push("Password cannot contain username"),i=!1),i&&o&&n},validateRequired:function(r){this.errors=this.errors||[];var e=this,s=!0;return _.each(this.required,function(a,t){r[a]||(e.errors.push(t+" is required"),s=!1)}),s},validEmail:function(r,e){this.errors=this.errors||[];var s=!0,a=!0;return r||(this.errors.push("E-mail is required"),s=!1),e||(this.errors.push("E-mail confirmation is required"),a=!1),r&&!r.match(/(\S+)@(\S+)\.(\S+)/)&&(this.errors.push("Not a valid e-mail address"),s=!1),r&&e&&r!==e&&(this.errors.push("E-mail and e-mail confirmation don't match"),s=!1,a=!1),s||this.$("input[name=email]").addClass("has-error"),a||this.$("input[name=emailConfirmation]").addClass("has-error"),s&&a},validName:function(r,e){this.errors=this.errors||[];var s=!0,a=!0;return r||(this.errors.push("First name is required"),s=!1),e||(this.errors.push("Last name is required"),a=!1),r&&r.length<2&&(this.errors.push("First name must be at least 2 characters long"),s=!1),e&&e.length<2&&(this.errors.push("Last name must be at least 2 characters long"),a=!1),r&&!r.match(/^[A-Za-z\-' ]*$/)&&(this.errors.push("First name may only contain letters, spaces, ', and -"),s=!1),e&&!e.match(/^[A-Za-z\-' ]*$/)&&(this.errors.push("Last name may only contain letters, spaces, ', and -"),a=!1),s||this.$("input[name=first_name]").addClass("has-error"),a||this.$("input[name=last_name]").addClass("has-error"),s&&a},validPassword:function(r,e){this.errors=this.errors||[];var s=!0,a=!0;return r||(this.errors.push("Password is required"),s=!1),e||(this.errors.push("Password confirmation is required"),a=!1),r&&r.length<8&&(this.errors.push("Password must be at least 8 characters long"),s=!1,a=!1),!r||r.match(/[A-Za-z]/)&&r.match(/[0-9]/)||(this.errors.push("Password must contain at least 1 letter and 1 number"),s=!1,a=!1),r&&e&&r!==e&&(this.errors.push("Password and password confirmation don't match"),s=!1,a=!1),s||this.$("input[name=password]").addClass("has-error"),a||this.$("input[name=passwordConfirmation]").addClass("has-error"),s&&a},validUsername:function(r){this.errors=this.errors||[];var e=!0;return r||(e=!1,this.errors.push("Username is required")),r&&r.length<6&&(e=!1,this.errors.push("Username must be at least 6 characters long")),r&&!r.match(/^[A-Za-z0-9_\- ]*$/)&&(e=!1,this.errors.push("Username may contain only alphanumeric characters, spaces, _, and -")),e||this.$("input[name=username]").addClass("has-error"),e},initialize:function(){this.errorPanelView=new Tessitura.ErrorPanelView},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.RegistrationFormView;
},{}],49:[function(require,module,exports){
Tessitura.TaskPanelView=Tessitura.DashWidgetView.extend({id:"task-panel",template:JST["partials/taskPanel"],crossOff:function(e){if("Complete"===e.get("status")){var t=this,i=this.retrieveViewForModel(e);setTimeout(function(){i&&(t.childViews.splice(t.childViews.indexOf(i),1),i.destroy()),t.collection.remove(e)},750)}},reorder:function(e,t){var i=(parseInt(t.item.attr("id").match(/\d+$/)[0]),1),s=this;_.each(this.$(".task-list-item"),function(e){var t=s.collection.get($(e).attr("id").match(/\d+$/)[0]);t.get("postion")!==i&&t.save({position:i}),i++})},retrieveViewForModel:function(e){if(this.childViews.length){var t,i=this;return _.each(i.childViews,function(i){i.model&&i.model.get("id")===e.get("id")&&(t=i)}),t}},showEditForm:function(e){this.trigger("showEditForm",e)},showTaskCreateForm:function(){this.trigger("showTaskCreateForm",this.collection)},renderCollection:function(){var e=this,t=0,i=document.createDocumentFragment();return this.collection.each(function(s){if(!(t>9||"Blocking"===s.get("status")||"Complete"===s.get("status")||s.get("backlog"))){var o=e.retrieveViewForModel(s)||new Tessitura.TaskListItemView({model:s,width:40});e.listenTo(o,"showEditForm",e.showEditForm),-1==e.childViews.indexOf(o)&&e.childViews.push(o),o.render(),i.appendChild(o.el),t++}}),this.$("ul.task-list").append(i),this},initialize:function(e){this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection}),this.childViews=[this.quickAddForm],_.bindAll(this,"reorder"),this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"change:backlog",this.render),this.listenTo(this.collection,"drop",this.removeStyles),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderCollection(),e.$("ul").sortable({items:">*:not(.not-sortable)",stop:e.reorder})})}}),module.exports=Tessitura.TaskPanelView;
...
},{"jquery":53,"underscore":55}],51:[function(require,module,exports){
...
var string="<ul></ul>";module.exports=string;
},{}],57:[function(require,module,exports){
var _=require("underscore"),JST={calendar:_.template(require("./partialTemplates/calendarTemplate.js")),dashboard:_.template("<div id='shade'></div>"),homepage:_.template(require("./topLevelTemplates/homepageTemplate.js")),"collections/organization":_.template(require("./collectionTemplates/organizationCollectionTemplate.js")),"collections/task":_.template("<li class='quick-add-form not-sortable'></li>"),"orgs/listItem":_.template(require("./modelTemplates/organizationTemplates/organizationListItemTemplate.js")),"partials/dashHome":_.template(require("./partialTemplates/dashboardHomeTemplate.js")),"partials/dashLocal":_.template(require("./partialTemplates/dashboardLocalTemplate.js")),"partials/dashNav":_.template(require("./partialTemplates/dashboardNavTemplate.js")),"partials/dashTasks":_.template(require("./partialTemplates/dashboardTaskTemplate.js")),"partials/errorPanel":_.template(require("./partialTemplates/errorPanelTemplate.js")),"partials/kanbanCol":_.template(require("./partialTemplates/kanbanColumnTemplate.js")),"partials/loginForm":_.template(require("./partialTemplates/loginFormTemplate.js")),"partials/profile":_.template(require("./partialTemplates/dashboardProfileTemplate.js")),"partials/sidebar":_.template(require("./partialTemplates/dashboardSidebarTemplate.js")),"partials/regForm":_.template(require("./partialTemplates/registrationFormTemplate.js")),"partials/taskPanel":_.template(require("./partialTemplates/taskPanelTemplate.js")),"partials/topWidgets":_.template(require("./partialTemplates/dashboardTopWidgetTemplate.js")),"tasks/listItem":_.template(require("./modelTemplates/taskTemplates/taskListItemTemplate.js")),"tasks/createForm":_.template(require("./modelTemplates/taskTemplates/taskCreateFormTemplate.js")),"tasks/quickAdd":_.template(require("./modelTemplates/taskTemplates/quickAddFormTemplate.js")),"tasks/editForm":_.template(require("./modelTemplates/taskTemplates/taskEditFormTemplate.js")),"users/model":_.template(require("./modelTemplates/userTemplates/userModelTemplate.js")),"users/profile":_.template(require("./modelTemplates/userTemplates/userProfileTemplate.js")),"fachs/form":_.template(require("./modelTemplates/fachTemplates/fachFormTemplate.js"))};module.exports=JST;
},{"./collectionTemplates/organizationCollectionTemplate.js":56,"./modelTemplates/fachTemplates/fachFormTemplate.js":58,"./modelTemplates/organizationTemplates/organizationListItemTemplate.js":59,"./modelTemplates/taskTemplates/quickAddFormTemplate.js":60,"./modelTemplates/taskTemplates/taskCreateFormTemplate.js":61,"./modelTemplates/taskTemplates/taskEditFormTemplate.js":62,"./modelTemplates/taskTemplates/taskListItemTemplate.js":63,"./modelTemplates/userTemplates/userModelTemplate.js":64,"./modelTemplates/userTemplates/userProfileTemplate.js":65,"./partialTemplates/calendarTemplate.js":66,"./partialTemplates/dashboardHomeTemplate.js":67,"./partialTemplates/dashboardLocalTemplate.js":68,"./partialTemplates/dashboardNavTemplate.js":69,"./partialTemplates/dashboardProfileTemplate.js":70,"./partialTemplates/dashboardSidebarTemplate.js":71,"./partialTemplates/dashboardTaskTemplate.js":72,"./partialTemplates/dashboardTopWidgetTemplate.js":73,"./partialTemplates/errorPanelTemplate.js":74,"./partialTemplates/kanbanColumnTemplate.js":75,"./partialTemplates/loginFormTemplate.js":76,"./partialTemplates/registrationFormTemplate.js":77,"./partialTemplates/taskPanelTemplate.js":78,"./topLevelTemplates/homepageTemplate.js":79,"underscore":55}],58:[function(require,module,exports){
var string="<select name='type'>\n  <option<%= (!model || model.get('type') === 'soprano') ? ' selected' : ''%>>Soprano</option>\n  <option<%= model && model.get('type') === 'mezzo-soprano' ? ' selected' : ''%>>Mezzo-soprano</option>\n  <option<%= model && model.get('type') === 'contralto' ? ' selected' : ''%>>Contralto</option>\n  <option<%= model && model.get('type') === 'countertenor' ? ' selected' : ''%>>Countertenor</option>\n  <option<%= model && model.get('type') === 'tenor' ? ' selected' : ''%>>Tenor</option>\n  <option<%= model && model.get('type') === 'baritone' ? ' selected' : ''%>>Baritone</option>\n  <option<%= model && model.get('type') === 'bass' ? ' selected' : ''%>>Bass</option>\n</select>\n\n<select name='quality' class='hidden'>\n  <option<%= (!model || model.get('quality') === 'lyric') ? ' selected' : '' %>>Lyric</option>\n  <option<%= model && model.get('quality') === 'dramatic' ? ' selected' : '' %>>Dramatic</option>\n</select>\n\n<input name='coloratura' type='checkbox' class='checkbox hidden' />";module.exports=string;
},{}],59:[function(require,module,exports){
var string="<table class='organization-listing' title=\"<%- model.get('name') %>\">\n  <tr>\n    <td><a href='#' class='organization-name'><%- model.get('name') %></a></td>\n  </tr>\n  <% if(model.get('website')) { %>\n    <tr>\n      <td><a href=\"<%- model.get('website') %>\"><%- model.get('website') %></a></td>\n    </tr>\n  <% } %>\n  <% var attributes = ['email_1', 'email_2', 'phone_1', 'phone_2', 'address_1', 'address_2'] %>\n  <% _.each(attributes, function(attribute) { %>\n    <% if(model.get(attribute)) { %>\n      <tr>\n        <td><%- model.get(attribute) %></td>\n      </tr>\n    <% } %>\n  <% }) %>\n\n  <% if(model.cityStateZip()) { %>\n    <tr>\n      <td><%- model.cityStateZip() %></td>\n    </tr>\n  <% } %>\n</table>";module.exports=string;
...
var string="<h3 class='form-title'>Create Task</h3>\n  <table>\n    <tr class='form-group'>\n      <td><label for='title'>Title: </label></td>\n      <td><input class='form-control' type='text' name='title' title='Title' placeholder='Title (required)'></td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='deadline'>Deadline: </label></td>\n      <td><input class='form-control' type='date' name='deadline' title='Deadline' placeholder='Deadline'></td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='status'>Status: </label></td>\n      <td>\n        <select class='form-control half-width left' name='status' title='Status' placeholder='Status'>\n          <option<%= !status || status === 'New' ? ' selected' : ''%>>New</option>\n          <option<%= status === 'In Progress' ? ' selected' : '' %>>In Progress</option>\n          <option<%= status === 'Blocking' ? ' selected' : '' %>>Blocking</option>\n          <option<%= status === 'Complete' ? ' selected' : '' %>>Complete</option>\n        </select>\n      </td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='priority'>Priority: </label></td>\n      <td>\n        <select class='form-control half-width right' name='priority' title='Priority' placeholder='Priority'>\n          <option>Urgent</option>\n          <option>High</option>\n          <option selected=\"selected\">Normal</option>\n          <option>Low</option>\n          <option>Not Important</option>\n        </select>\n      </td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='description'>Notes: </label></td>\n      <td><textarea class='form-control' name='description' title='Notes' placeholder='Notes'></textarea></td>\n    </tr>\n  </table>\n  <button type='submit' title='Create Task' class='btn btn-dark btn-lg btn-block'>Create Task</button>\n</div>";module.exports=string;
},{}],62:[function(require,module,exports){
var string="<h3 class='form-title'>Edit Task</h3>\n  <table>\n    <tr class='form-group'>\n      <td><label for='title'>Title: </label></td>\n      <td><input class='form-control' type='text' name='title' title='Title' value='<%- model.get('title') %>' placeholder='Title (required)'></td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='deadline'>Deadline: </label></td>\n      <td><input class='form-control' type='date' name='deadline' title='Deadline' value='<%- model.get('deadline') %>' placeholder='Deadline'></td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='status'>Status: </label></td>\n      <td>\n        <select class='form-control half-width left' name='status' title='Status'>\n          <option<%- model.get('status') === 'New' ? ' selected' : ''%>>New</option>\n          <option<%- model.get('status') === 'In Progress' ? ' selected' : ''%>>In Progress</option>\n          <option<%- model.get('status') === 'Blocking' ? ' selected' : ''%>>Blocking</option>\n          <option>Complete</option>\n        </select>\n      </td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='priority'>Priority: </label></td>\n      <td>\n        <select class='form-control half-width right' name='priority' title='Priority'>\n          <option<%- model.get('priority') === 'Urgent' ? ' selected' : ''%>>Urgent</option>\n          <option<%- model.get('priority') === 'High' ? ' selected' : ''%>>High</option>\n          <option<%- model.get('priority') === 'Normal' ? ' selected' : ''%>>Normal</option>\n          <option<%- model.get('priority') === 'Low' ? ' selected' : ''%>>Low</option>\n          <option<%- model.get('priority') === 'Not Important' ? ' selected' : ''%>>Not Important</option>\n        </select>\n      </td>\n    </tr>\n    <tr class='form-group'>\n      <td><label for='description'>Notes: </label></td>\n      <td><textarea class='form-control' name='description' title='Notes'><%- model.get('description') %></textarea></td>\n    </tr>\n  </table>\n  <button type='submit' title='Update Task' class='btn btn-dark btn-lg btn-block'>Update Task</button>\n</div>";module.exports=string;
},{}],63:[function(require,module,exports){
var string="<span class='pull-right edit-task'>\n  <i class='fa fa-archive fa-fw' title='Backlog'></i>  <i class='fa fa-pencil fa-fw' title='Edit'></i>  <i class='fa fa-times fa-fw' title='Delete'></i>\n</span>\n<table>\n  <tr>\n    <td style='vertical-align: top'><i class='fa fa-square-o' title=\"Mark complete\"></i></td>\n    <td class='task-listing'>\n      <a href='' class='task-title' title=\"<%- model.get('title') %>\"><%- model.displayTitle(width) %></a>\n      <table class='task-details'>\n        <% if (model.get('deadline')) { %>\n          <tr class='task-deadline-row'>\n            <th>Deadline:</th>\n            <td><%- model.prettyDeadline() %></td>\n          </tr>\n        <% } %>\n        <tr class='task-priority-row'>\n          <th>Priority:</th>\n          <td><%- model.get('priority') %></td>\n        </tr>\n        <tr class='task-status-row'>\n          <th>Status:</th>\n          <td><%- model.get('status') %></td>\n        </tr>\n        <% if (model.get('description')) { %>\n          <tr class='task-description-row'>\n            <th style='vertical-align: text-top'>Notes:</th>\n            <td><%- model.get('description') %></td>\n          </tr>\n        <% } %>\n      </table>\n    </td>\n  </tr>\n</table>";module.exports=string;
},{}],64:[function(require,module,exports){
var string="<% var imgURL = model.get('headshot') %>\n<img id='avatar' height='150' src=\"<%= imgURL || '/vendor/img/avatar.svg' %>\">\n\n<table>\n  <tr data-attribute='name'>\n    <th>Name:</th>\n    <td title='Double-click to edit'><span class='profile-field' id='first_name'><span class='p'><%= model.get('first_name') %></span><span class='form'><form><input name='first_name' type='text' value='<%= model.get('first_name') %>' /></form></span></span> <span class='profile-field' id='last_name'><span class='p'><%=model.get('last_name') %></span><span class='form'><form><input name='last_name' type='text' value='<%= model.get('last_name') %>' /></form></span></span></td>\n  </tr>\n  <tr data-attribute='username'>\n    <th>Username:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='username'>\n        <span class='p'><%= model.get('username') %></span>\n        <span class='form'><form><input name='username' type='text' value='<%= model.get('username') %>'></form></span>\n      </span>\n    </td>\n  </tr>\n  <tr data-attribute='email'>\n    <th>E-mail:</th>\n    <td>\n      <span class='profile-field' id='email' title='Double-click to edit'>\n        <span class='p'><%= model.get('email') %></span>\n        <span class='form'><form><input name='email' type='email' value='<%= model.get('email') %>' /></form></span>\n      </span>\n    </td>\n  </tr>\n  <tr data-attribute='birthdate'>\n    <th>Birthdate:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='birthdate'>\n        <span class='p'><%= model.get('birthdate') || 'N/A' %></span>\n        <span class='form'><form><input name='birthdate' type='date' value='<%= model.get('birthdate') %>' /></form></span>\n      </span>\n    </td>\n  </tr>\n  <tr data-attribute='fach'>\n    <th>Fach:</th>\n    <td title='Double-click to edit'>\n      <% var displayFach = model.Fach ? model.Fach.displayTitle() : 'N/A' %>\n      <span class='profile-field' id='fach'>\n        <span class='p'><%= displayFach %></span>\n        <span class='form'>\n          <form>\n            <% var fach = model.escape('fach') %>\n            <select name='fach'>\n              <option<%- fach === 'Soprano - lyric coloratura' ? ' selected' : '' %>>\n                Soprano - lyric coloratura\n              </option>\n              <option<%- fach === 'Soprano - dramatic coloratura' ? ' selected' : '' %>>\n                Soprano - dramatic coloratura\n              </option>\n              <option<%- fach === 'Soprano - lyric' ? ' selected' : '' %>>\n                Soprano - lyric\n              </option>\n              <option<%- fach === 'Soprano - spinto' ? ' selected' : '' %>>\n                Soprano - spinto\n              </option>\n              <option<%- fach === 'Soprano - dramatic' ? ' selected' : '' %>>\n                Soprano - dramatic\n              </option>\n              <option<%- fach === 'Mezzo-soprano - Rossini' ? ' selected' : '' %>>\n                Mezzo-soprano - Rossini\n              </option>\n              <option<%- fach === 'Mezzo-soprano - lyric' ? ' selected' : '' %>>\n                Mezzo-soprano - lyric\n              </option>\n              <option<%- fach === 'Mezzo-soprano - dramatic' ? ' selected' : '' %>>\n                Mezzo-soprano - dramatic\n              </option>\n              <option<%- fach === 'Contralto' ? ' selected' : '' %>>\n                Contralto\n              </option>\n              <option<%- fach === 'Countertenor' ? ' selected' : '' %>>\n                Countertenor\n              </option>\n              <option<%- fach === 'Tenor leggiero' ? ' selected' : '' %>>\n                Tenor leggiero\n              </option>\n              <option<%- fach === 'Tenor - lyric' ? ' selected' : '' %>>\n                Tenor - lyric\n              </option>\n              <option<%- fach === 'Tenor - spinto' ? ' selected' : '' %>>\n                Tenor - spinto\n              </option>\n              <option<%- fach === 'Heldentenor' ? ' selected' : '' %>>\n                Heldentenor\n              </option>\n              <option<%- fach === 'Lyric baritone' ? ' selected' : '' %>>\n                Lyric baritone\n              </option>\n              <option<%- fach === 'Dramatic baritone' ? ' selected' : '' %>>\n                Dramatic baritone\n              </option>\n              <option<%- fach === 'Lyric bass' ? ' selected' : '' %>>\n                Lyric bass\n              </option>\n              <option<%- fach === 'Basso buffo' ? ' selected' : '' %>>\n                Basso buffo\n              </option>\n              <option<%- fach === 'Basso profondo' ? ' selected' : '' %>>\n                Basso profondo\n              </option>\n              <option<%- fach === 'Other' ? ' selected' : '' %>>\n                Other\n              </option>\n            </select>\n          </form>\n        </span>\n      </span>\n    </td>  \n  </tr>\n  <tr data-attribute='address_1'>\n    <th>Address 1:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='address_1'>\n        <span class='p'><%= model.get('address_1') || 'N/A' %></span>\n        <span class='form'><form><input name='address_1' value='<%= model.get('address_1') %>' /></form></span>\n      </span>\n    </td>\n  </tr>\n  <tr data-attribute='address_2'>\n    <th>Address 2:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='address_2'>\n        <span class='p'><%= model.get('address_2') || 'N/A' %></span>\n        <span class='form'><form><input name='address_1' value='<%= model.get('address_2') %>' /></form></span>\n      </span>\n    </td>\n  </tr>\n  <tr data-attribute='city'>\n    <th>City:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='city'>\n        <span class='p'><%= model.get('city') || 'N/A' %></span>\n        <span class='form'><form><input name='city' value='<%= model.get('city') %>' /></form></span>\n      </span>\n    </td>  \n  </tr>\n  <tr data-attribute='state'>\n    <th>State:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='state'>\n        <span class='p'><%= model.get('state') || 'N/A' %></span>\n        <span class='form'>\n          <form>\n            <% var state = model.get('state'); %>\n            <select name='address_1'>\n              <option<%- state === 'AK' ? ' selected' : '' %>>\n                AK\n              </option>\n              <option<%- state === 'AL' ? ' selected' : '' %>>\n                AL\n              </option>\n              <option<%- state === 'AR' ? ' selected' : '' %>>\n                AR\n              </option>\n              <option<%- state === 'AZ' ? ' selected' : '' %>>\n                AZ\n              </option>\n              <option<%- state === 'CA' ? ' selected' : '' %>>\n                CA\n              </option>\n              <option<%- state === 'CO' ? ' selected' : '' %>>\n                CO\n              </option>\n              <option<%- state === 'CT' ? ' selected' : '' %>>\n                CT\n              </option>\n              <option<%- state === 'DE' ? ' selected' : '' %>>\n                DE\n              </option>\n              <option<%- state === 'FL' ? ' selected' : '' %>>\n                FL\n              </option>\n              <option<%- state === 'GA' ? ' selected' : '' %>>\n                GA\n              </option>\n              <option<%- state === 'HI' ? ' selected' : '' %>>\n                HI\n              </option>\n              <option<%- state === 'IA' ? ' selected' : '' %>>\n                IA\n              </option>\n              <option<%- state === 'ID' ? ' selected' : '' %>>\n                ID\n              </option>\n              <option<%- state === 'IL' ? ' selected' : '' %>>\n                IL\n              </option>\n              <option<%- state === 'IN' ? ' selected' : '' %>>\n                IN\n              </option>\n              <option<%- state === 'KS' ? ' selected' : '' %>>\n                KS\n              </option>\n              <option<%- state === 'KY' ? ' selected' : '' %>>\n                KY\n              </option>\n              <option<%- state === 'LA' ? ' selected' : '' %>>\n                LA\n              </option>\n              <option<%- state === 'MA' ? ' selected' : '' %>>\n                MA\n              </option>\n              <option<%- state === 'MD' ? ' selected' : '' %>>\n                MD\n              </option>\n              <option<%- state === 'ME' ? ' selected' : '' %>>\n                ME\n              </option>\n              <option<%- state === 'MI' ? ' selected' : '' %>>\n                MI\n              </option>\n              <option<%- state === 'MN' ? ' selected' : '' %>>\n                MN\n              </option>\n              <option<%- state === 'MO' ? ' selected' : '' %>>\n                MO\n              </option>\n              <option<%- state === 'MS' ? ' selected' : '' %>>\n                MS\n              </option>\n              <option<%- state === 'MT' ? ' selected' : '' %>>\n                MT\n              </option>\n              <option<%- state === 'NC' ? ' selected' : '' %>>\n                NC\n              </option>\n              <option<%- state === 'ND' ? ' selected' : '' %>>\n                ND\n              </option>\n              <option<%- state === 'NE' ? ' selected' : '' %>>\n                NE\n              </option>\n              <option<%- state === 'NH' ? ' selected' : '' %>>\n                NH\n              </option>\n              <option<%- state === 'NJ' ? ' selected' : '' %>>\n                NJ\n              </option>\n              <option<%- state === 'NM' ? ' selected' : '' %>>\n                NM\n              </option>\n              <option<%- state === 'NV' ? ' selected' : '' %>>\n                NV\n              </option>\n              <option<%- state === 'NY' ? ' selected' : '' %>>\n                NY\n              </option>\n              <option<%- state === 'OH' ? ' selected' : '' %>>\n                OH\n              </option>\n              <option<%- state === 'OK' ? ' selected' : '' %>>\n                OK\n              </option>\n              <option<%- state === 'OR' ? ' selected' : '' %>>\n                OR\n              </option>\n              <option<%- state === 'PA' ? ' selected' : '' %>>\n                PA\n              </option>\n              <option<%- state === 'RI' ? ' selected' : '' %>>\n                RI\n              </option>\n              <option<%- state === 'SC' ? ' selected' : '' %>>\n                SC\n              </option>\n              <option<%- state === 'SD' ? ' selected' : '' %>>\n                SD\n              </option>\n              <option<%- state === 'TN' ? ' selected' : '' %>>\n                TN\n              </option>\n              <option<%- state === 'TX' ? ' selected' : '' %>>\n                TX\n              </option>\n              <option<%- state === 'UT' ? ' selected' : '' %>>\n                UT\n              </option>\n              <option<%- state === 'VA' ? ' selected' : '' %>>\n                VA\n              </option>\n              <option<%- state === 'VT' ? ' selected' : '' %>>\n                VT\n              </option>\n              <option<%- state === 'WA' ? ' selected' : '' %>>\n                WA\n              </option>\n              <option<%- state === 'WI' ? ' selected' : '' %>>\n                WI\n              </option>\n              <option<%- state === 'WV' ? ' selected' : '' %>>\n                WV\n              </option>\n              <option<%- state === 'WY' ? ' selected' : '' %>>\n                WY\n              </option>\n            </select>\n          </form>\n        </span>\n      </span>\n    </td>\n  </tr>\n  <tr data-attribute='zip'>\n    <th>Zip:</th>\n    <td title='Double-click to edit'>\n      <span class='profile-field' id='zip'>\n        <span class='p'><%= model.get('zip') || 'N/A' %></span>\n        <span class='form'><form><input name='zip' value='<%= model.get('zip') %>' /></form></span>\n      </span>\n    </td>  \n  </tr>\n  <tr>\n    <th>Member Since:</th>\n    <td><%= model.prettyCreateDate() %></td>\n  </tr>\n</table>";module.exports=string;
},{}],65:[function(require,module,exports){
var string="<div class='panel-heading'>\n  <i class='fa fa-user fa-fw'></i>  My Account<span class='pull-right toggle-widget'><i class='fa fa-minus fa-fw'></i></span>\n</div>\n\n<div class='panel-body'>\n  <ul class='nav nav-tabs'>\n    <li class='active'>\n      <a href='#profile' data-toggle='tab' aria-expanded='true'>Profile</a>\n    </li>\n    <li>\n      <a href='#materials' data-toggle='tab' aria-expanded='false'>Materials</a>\n    </li>\n    <li>\n      <a href='#security' data-toggle='tab' aria-expanded='false'>Security</a>\n    </li>\n    <li>\n      <a href='#settings' data-toggle='tab' aria-expanded='false'>Settings</a>\n    </li>\n  </ul>\n\n  <div class='tab-content'>\n    <div class='tab-pane fade active in' id='profile-tab'>\n      <h4><%= model.get('first_name') %> <%= model.get('last_name') %>'s Profile</h4>\n    </div>\n    <div class='tab-pane fade' id='materials-tab'>\n      <h4>My Materials</h4>\n    </div>\n    <div class='tab-pane fade' id='security-tab'>\n      <h4>Security Settings</h4>\n    </div>\n    <div class='tab-pane fade' id='settings-tab'>\n      <h4>Account Settings</h4>\n    </div>\n  </div>\n</div>\n";module.exports=string;

...
var opts={useTestAPI:!0};module.exports=opts;
...
Tessitura.RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},reqdFields:["username","password","email","first_name","last_name"],createUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(r)){var a=new Tessitura.UserModel,t=btoa(r.username+":"+r.password),s=this;delete r.passwordConfirmation,delete r.emailConfirmation,a.save(r,{success:function(e){$.cookie("auth",t),$.cookie("userID",e.id),s.trigger("userCreated",{user:a})}})}},removeError:function(){this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){var e=!this.$("input[name=acceptTerms]").prop("checked");this.$("input[name=acceptTerms]").prop(e),this.removeError()},validateForm:function(e){var r,a,t,s,i;return r=!!e.acceptTerms,r||(this.$("fieldset.form-group.terms").addClass("has-error"),r=!1),a=this.validPassword(e.password,e.passwordConfirmation),t=this.validUsername(e.username),s=this.validEmail(e.email,e.emailConfirmation),i=this.validName(e.first_name,e.last_name),delete e.acceptTerms,r&&a&&t&&s&&i},validCreds:function(e,r,a,t,s){var i=this.validPassword(r,a),n=this.validUsername(e),o=this.validEmail(t,s);return i&&n&&o&&-1===r.indexOf(e)},validEmail:function(e,r){var a=!!e&&!!e.match(/(\S+)@(\S+)\.(\S+)/)&&!!r&&r===e;return a||this.$("input[name=email]").addClass("has-error"),a},validName:function(e,r){var a=!!e&&!!e.match(/^[A-Za-z' -]{2,}$/),t=!!r&&!!r.match(/^[A-Za-z\' -]{2,}$/);return a||this.$("input[name=first_name]").addClass("has-error"),t||this.$("input[name=last_name]").addClass("has-error"),a&&t},validPassword:function(e,r){var a=!!e&&e.length>=8&&!!e.match(/[A-Za-z]/)&&!!e.match(/[0-9]/)&&!!r&&e===r;return a||this.$("input[name=password]").addClass("has-error"),a},validUsername:function(e){var r=!!e&&e.length>=6&&!!e.match(/^[A-Za-z0-9_\- ]*$/);return r||this.$("input[name=username]").addClass("has-error"),r},initialize:function(){this.errorPanelView=new Tessitura.ErrorPanelView},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.RegistrationFormView;

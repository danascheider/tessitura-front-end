...
Tessitura.OrganizationCollectionView=Tessitura.View.extend({id:"organization-list",className:"well",initialize:function(i){i=i||{},this.childViews=[],this.collection=i.collection||new Tessitura.OrganizationCollection,this.collection.fetch()}}),module.exports=Tessitura.OrganizationCollectionView;
...
Tessitura.OrganizationListItemView=Tessitura.View.extend({tagName:"li",className:"organization-list-item-view",template:JST["orgs/listItem"],render:function(){Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}}),module.exports=Tessitura.OrganizationListItemView;

...
var UserProfileView=Tessitura.View.extend({template:_.template("<div></div>"),klass:"UserProfileView",setUser:function(e){this.model=e,this.modelView=new Tessitura.UserModelView({model:e}),this.childViews=[this.modelView]},render:function(){return this.$el.html(this.template()),this}});module.exports=UserProfileView;

...
Tessitura.UserProfileView=Tessitura.DashWidgetView.extend({id:"profile-info",template:JST["users/profile"],events:function(){var e=Tessitura.DashWidgetView.prototype.events;return e.click="hideInputs",e},hideInputs:function(){this.modelView.hideInputs()},setUser:function(e){return this.model=e,this.modelView=new Tessitura.UserModelView({model:e}),this.childViews=[this.modelView],this},initialize:function(e){e=e||{},e.model&&this.setUser(e.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template({model:e.model}),function(){e.modelView.render(),e.$("#profile-tab > h4").first().after(e.modelView.$el)})}}),module.exports=Tessitura.UserProfileView;

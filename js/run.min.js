...
Tessitura.DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,events:{click:"hideDropdownMenus",dblclick:"hideSidebar","click .internal-link":"followLink"},klass:"MainDashboardView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat("MainDashboardView","DashboardView","Dashboard","AppView","TopLevelView")},emitRedirect:function(e){this.trigger("redirect",e)},followLink:function(e){var i=$(e.target).closest(".internal-link"),t=i.attr("data-target");this.emitRedirect({destination:t})},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},hideSidebar:function(e){var i=$(e.target);i!=this.$("#side-menu")&&0===this.$(".navbar-static-side").has(i).length&&this.$("#side-menu").is(":visible")&&this.$(".sidebar-collapse").hide()},setUser:function(e){this.model=e,this.navView.setUser(e)},initialize:function(){this.navView=new Tessitura.DashboardNavView,this.childViews=[this.navView],this.model&&this.setUser(this.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,"",function(){e.navView.render(),e.navView.$el.is(":visible")||e.$el.prepend(e.navView.$el)})}}),module.exports=Tessitura.DashboardView;

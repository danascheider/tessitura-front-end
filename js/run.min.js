...
Tessitura.LoginFormView=Tessitura.View.extend({template:JST["partials/loginForm"],tagName:"form",id:"login-form",events:{submit:"loginUser","click .login-help-link":"loginHelp"},loginHelp:function(e){console.log("Haha, you're boned!")},loginUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el),i=btoa(r.username+":"+r.password),s=this,o=new Tessitura.UserModel({username:r.username,password:r.password});o.login({success:function(e){r.remember?$.cookie("auth",i,{expires:365}):$.cookie("auth",i),r.remember?$.cookie("userID",o.id,{expires:365}):$.cookie("userID",o.get("id")),s.trigger("userLoggedIn",{user:e})}})},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.LoginFormView;

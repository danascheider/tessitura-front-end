...
Tessitura.DashboardPresenter=Tessitura.Model.extend({klass:"DashboardPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["Presenter","DashboardPresenter"])},getHome:function(){this.showDash(),this.current!==this.dashboardHomeView&&(this.dashboardHomeView.render(),this.dashboardView.$("nav").after(this.dashboardHomeView.$el),this.current=this.dashboardHomeView)},getProfile:function(){this.showDash(),this.current!==this.dashboardProfileView&&(this.dashboardProfileView.render(),this.dashboardView.$el.after(this.dashboardProfileView.$el),this.current=this.dashboardProfileView)},getTask:function(){this.showDash(),this.current!==this.dashboardTaskView&&(this.dashboardTaskView.render(),this.dashboardView.$("nav").after(this.dashboardTaskView.$el),this.current=this.dashboardTaskView)},emitRedirect:function(e){this.trigger("redirect",e)},removeAll:function(){this.dashboardView.remove()},rerender:function(){this.current&&(this.current.remove(),this.dashboardView.render(),this.dashboardView.$("nav").after(this.current.$el))},setUser:function(e,s){var i=this;this.user&&this.user.get("id")===e.get("id")||(this.user=e,this.user.fetch({success:function(){i.user.tasks.fetch({success:function(r){_.each(i.views,function(s){s.setUser&&s.setUser(e)}),s&&s(r)}})}}),this.listenTo(this.user,"change:first_name change:last_name",this.rerender))},showDash:function(){this.dashboardView.$el.is(":visible")||(this.dashboardView.render(),$("body").html(this.dashboardView.$el))},initialize:function(e){e=e||{},this.dashboardView=new Tessitura.DashboardView,this.dashboardHomeView=new Tessitura.DashboardHomeView,this.dashboardTaskView=new Tessitura.DashboardTaskView,this.dashboardProfileView=new Tessitura.DashboardProfileView,this.views=[this.dashboardView,this.dashboardHomeView,this.dashboardTaskView,this.dashboardProfileView],e.user&&this.setUser(e.user),_.bindAll(this,"showDash","getHome","getTask","setUser","emitRedirect","removeAll"),this.listenTo(this.dashboardView,"redirect",this.emitRedirect)}}),module.exports=Tessitura.DashboardPresenter;
...
},{"backbone":40,"underscore":45}],64:[function(require,module,exports){

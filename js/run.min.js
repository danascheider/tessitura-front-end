...
},{"backbone":41,"underscore":46}],8:[function(require,module,exports){
...
Tessitura.DashboardPresenter=Tessitura.Model.extend({klass:"DashboardPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["Presenter","DashboardPresenter"])},getHome:function(){this.showDash();var e=this.current!==this.dashboardHomeView;this.current=this.dashboardHomeView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardHomeView.render(),this.dashboardView.$el.append(this.dashboardHomeView.$el))},getProfile:function(){this.showDash();var e=this.current!==this.dashboardProfileView;this.current=this.dashboardProfileView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardProfileView.render(),this.dashboardView.$el.append(this.dashboardProfileView.$el))},getTask:function(){this.showDash();var e=this.current!==this.dashboardTaskView;this.current=this.dashboardTaskView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardTaskView.render(),this.dashboardView.$el.append(this.dashboardTaskView.$el))},emitRedirect:function(e){this.trigger("redirect",e)},clearViews:function(){var e=this;_.each(this.views,function(s){s!==e.current&&s!==e.dashboardView&&s.remove()})},removeAll:function(){this.dashboardView.remove()},setUser:function(e,s){var i=this;this.user&&this.user.get("id")===e.get("id")||(this.user=e,this.user.fetch({success:function(){i.user.tasks.fetch({success:function(r){_.each(i.views,function(s){s.setUser&&s.setUser(e)}),s&&s(r)}})}}))},showDash:function(){this.dashboardView.$el.is(":visible")||(this.dashboardView.render(),$("body").html(this.dashboardView.$el))},initialize:function(e){e=e||{},this.dashboardView=new Tessitura.DashboardView,this.dashboardHomeView=new Tessitura.DashboardHomeView,this.dashboardTaskView=new Tessitura.DashboardTaskView,this.dashboardProfileView=new Tessitura.DashboardProfileView,this.views=[this.dashboardView,this.dashboardHomeView,this.dashboardTaskView,this.dashboardProfileView],e.user&&this.setUser(e.user),_.bindAll(this,"showDash","getHome","getTask","setUser","emitRedirect","removeAll"),this.listenTo(this.dashboardView,"redirect",this.emitRedirect)}}),module.exports=Tessitura.DashboardPresenter;
...
Tessitura.DashWidgetView=Tessitura.View.extend({className:function(){return"panel panel-primary dash-widget"},template:_.template('<div class="panel-heading"><span class="toggle-widget"><i class="fa fa-minus fa-fw"></i></span></div></div><div class="panel-body"></div>'),events:{"click span.toggle-widget > i":"toggleWidget"},klass:"DashWidgetView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["DashWidgetView","PartialView"])},toggleWidget:function(e){this.$(".panel-body").slideToggle(),$(e.target).toggleClass("fa-minus fa-plus")},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.DashWidgetView;
},{}],21:[function(require,module,exports){
Tessitura.DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,events:{click:"hideDropdownMenus",dblclick:"hideSidebar","click .internal-link":"followLink"},klass:"MainDashboardView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat("MainDashboardView","DashboardView","Dashboard","AppView","TopLevelView")},emitRedirect:function(e){this.trigger("redirect",e)},followLink:function(e){var i=$(e.target).closest(".internal-link"),t=i.attr("data-target");this.emitRedirect({destination:t})},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},hideSidebar:function(e){if(e)var i=$(e.target);i!==this.$("#side-menu")&&0===this.$(".navbar-static-side").has(i).length&&this.$("#side-menu").is(":visible")&&this.$(".sidebar-collapse").slideUp()},setUser:function(e){this.model=e,this.navView.setUser(e)},initialize:function(){this.navView=new Tessitura.DashboardNavView,this.childViews=[this.navView],this.model&&this.setUser(this.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,"",function(){e.navView.render(),e.navView.$el.is(":visible")||e.$el.prepend(e.navView.$el)})}}),module.exports=Tessitura.DashboardView;
...
Tessitura.RegistrationFormView=Tessitura.View.extend({template:JST["partials/regForm"],tagName:"form",id:"registration-form",events:{"click input[type=checkbox]":"removeError","click label[for=acceptTerms]":"toggleCheckbox",submit:"createUser"},klass:"RegistrationFormView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(["RegistrationFormView","RegistrationForm","FormView","PartialView"])},reqdFields:["username","password","email","first_name","last_name"],createUser:function(e){e.preventDefault();var r=Tessitura.Utils.getAttributes(this.$el);if(this.validateForm(r)){var t=new Tessitura.UserModel,a=btoa(r.username+":"+r.password),s=this;delete r.passwordConfirmation,delete r.emailConfirmation,t.save(r,{success:function(e){$.cookie("auth",a),$.cookie("userID",e.id),s.trigger("userCreated")}})}},removeError:function(){this.$("fieldset.terms").hasClass("has-error")&&this.$("fieldset.terms").removeClass("has-error")},toggleCheckbox:function(){this.$("input[name=acceptTerms]").prop("checked",function(e,r){return!r}),this.removeError()},validateForm:function(e){return e.acceptTerms?(delete e.acceptTerms,this.validCreds(e.username,e.password,e.passwordConfirmation,e.email,e.emailConfirmation)&&this.validName(e.first_name,e.last_name)):(this.$("fieldset.form-group.terms").addClass("has-error"),!1)},validCreds:function(e,r,t,a,s){return this.validPassword(r,t)&&this.validUsername(e)&&this.validEmail(a,s)&&-1===r.indexOf(e)},validEmail:function(e,r){var t=!!e.match(/(\S+)@(\S+)\.(\S+)/)&&!!r&&r===e;return t||this.$("input[name=email]").addClass("has-error"),t},validName:function(e,r){var t=!!e.match(/^[A-Za-z' -]{2,}$/),a=!!r.match(/^[A-Za-z\' -]{2,}$/);return t||this.$("input[name=first_name]").addClass("has-error"),a||this.$("input[name=last_name]").addClass("has-error"),t&&a},validPassword:function(e,r){var t=!!e&&e.length>=8&&!!e.match(/[A-Za-z]/)&&!!e.match(/[0-9]/)&&!!r&&e===r;return t||this.$("input[name=password]").addClass("has-error"),t},validUsername:function(e){var r=!!e&&e.length>=6&&!!e.match(/^[A-Za-z0-9_\- ]*$/);return r||this.$("input[name=username]").addClass("has-error"),r},render:function(){return Tessitura.View.prototype.render.call(this,this.template())}}),module.exports=Tessitura.RegistrationFormView;
},{}],40:[function(require,module,exports){
Tessitura.TaskPanelView=Tessitura.DashWidgetView.extend({id:"task-panel",template:JST["partials/taskPanel"],klass:"TaskPanelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.DashWidgetView.prototype.types().concat(["TaskPanelView","TaskPanel","TaskView","PartialView"])},crossOff:function(e){if("Complete"===e.get("status")){var t=this,i=this.retrieveViewForModel(e);setTimeout(function(){i&&(t.childViews.splice(t.childViews.indexOf(i),1),i.destroy()),t.collection.remove(e)},750)}},retrieveViewForModel:function(e){if(this.childViews.length){var t=_.filter(this.childViews,function(t){return t.model===e});return t[0]}},showTaskCreateForm:function(e){this.trigger("showTaskCreateForm",{collection:this.collection})},renderCollection:function(){var e=this,t=0,i=document.createDocumentFragment();return this.collection.each(function(s){if(!(t>9||"Blocking"===s.get("status")||"Complete"===s.get("status")||s.get("backlog"))){var o=e.retrieveViewForModel(s)||new Tessitura.TaskListItemView({model:s});-1===e.childViews.indexOf(o)&&e.childViews.push(o),o.render(),i.appendChild(o.el),t++}}),this.$("ul.task-list").append(i),this},initialize:function(e){this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection}),this.childViews=[this.quickAddForm],this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"change:backlog",this.render),this.listenTo(this.collection,"drop",this.removeStyles),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderCollection(),e.$("ul").sortable({items:">*:not(.not-sortable)"})})}}),module.exports=Tessitura.TaskPanelView;
...
},{"backbone":41,"underscore":46}],65:[function(require,module,exports){

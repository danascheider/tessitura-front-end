...
Tessitura.TaskPanelView=Tessitura.DashWidgetView.extend({id:"task-panel",template:JST["partials/taskPanel"],crossOff:function(e){if("Complete"===e.get("status")){var t=this,i=this.retrieveViewForModel(e);setTimeout(function(){i&&(t.childViews.splice(t.childViews.indexOf(i),1),i.destroy()),t.collection.remove(e)},750)}},retrieveViewForModel:function(e){if(this.childViews.length){var t,i=this;return _.each(i.childViews,function(i){i.model&&i.model.get("id")===e.get("id")&&(t=i)}),t}},showEditForm:function(e){this.trigger("showEditForm",e)},showTaskCreateForm:function(){this.trigger("showTaskCreateForm",this.collection)},renderCollection:function(){var e=this,t=0,i=document.createDocumentFragment();return this.collection.each(function(s){if(!(t>9||"Blocking"===s.get("status")||"Complete"===s.get("status")||s.get("backlog"))){var o=e.retrieveViewForModel(s)||new Tessitura.TaskListItemView({model:s,width:40});e.listenTo(o,"showEditForm",e.showEditForm),-1==e.childViews.indexOf(o)&&e.childViews.push(o),o.render(),i.appendChild(o.el),t++}}),this.$("ul.task-list").append(i),this},initialize:function(e){this.quickAddForm=new Tessitura.QuickAddFormView({collection:this.collection}),this.childViews=[this.quickAddForm],this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"change:status",this.crossOff),this.listenTo(this.collection,"change:backlog",this.render),this.listenTo(this.collection,"drop",this.removeStyles),this.listenTo(this.collection,"remove",this.render),this.listenTo(this.quickAddForm,"showTaskCreateForm",this.showTaskCreateForm)},remove:function(){_.each(this.childViews,function(e){e.remove()}),Tessitura.View.prototype.remove.call(this)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$(".quick-add-form").prepend(e.quickAddForm.$el),e.renderCollection(),e.$("ul").sortable({items:">*:not(.not-sortable)"})})}}),module.exports=Tessitura.TaskPanelView;

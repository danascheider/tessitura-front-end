...
Tessitura.OrganizationCollection=Tessitura.ProtectedCollection.extend({model:Tessitura.OrganizationModel,url:"/organizations"}),module.exports=Tessitura.OrganizationCollection;
...
Tessitura.OrganizationCollectionView=Tessitura.View.extend({id:"organization-list",className:"well",initialize:function(){this.childViews=[]}}),module.exports=Tessitura.OrganizationCollectionView;
...
Tessitura.DashboardLocalView=Tessitura.View.extend({id:"page-wrapper",template:JST["partials/dashLocal"],setUser:function(e){this.user=e},events:{"submit #location-form":"updateProfile"},updateProfile:function(e){e.preventDefault();var t={},i=this,t=Tessitura.Utils.getAttributes($(e.target));this.user.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},success:function(){i.$("#location-form").closest(".alert").hide()},error:function(e,t){console.log("Unable to update user profile - error ",t)}})},setUser:function(e){this.user=e},initialize:function(e){e=e||{},e.user&&this.setUser(e.user),this.organizationCollectionView=new Tessitura.OrganizationCollectionView,this.childViews=[this.organizationCollectionView]},render:function(){var e=this.template({model:this.user});return Tessitura.View.prototype.render.call(this,e)}}),module.exports=Tessitura.DashboardLocalView;

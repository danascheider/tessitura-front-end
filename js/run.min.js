...
Tessitura.DashboardPresenter=Tessitura.Model.extend({klass:"DashboardPresenter",types:function(){return Tessitura.Model.prototype.types().concat(["Presenter","DashboardPresenter"])},getHome:function(){this.showDash();var e=this.current!==this.dashboardHomeView;this.current=this.dashboardHomeView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardHomeView.render(),this.dashboardView.$el.append(this.dashboardHomeView.$el))},getProfile:function(){this.showDash();var e=this.current!==this.dashboardProfileView;this.current=this.dashboardProfileView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardProfileView.render(),this.dashboardView.$el.append(this.dashboardProfileView.$el))},getTask:function(){this.showDash();var e=this.current!==this.dashboardTaskView;this.current=this.dashboardTaskView,this.clearViews(),e&&(this.dashboardView.hideSidebar(),this.dashboardTaskView.render(),this.dashboardView.$el.append(this.dashboardTaskView.$el))},emitRedirect:function(e){this.trigger("redirect",e)},showTaskEditForm:function(e){this.editForm=this.editForm||new Tessitura.TaskEditFormView,this.editForm.setModel(e).render(),this.dashboardView.$("#shade").show(),this.dashboardView.$("#shade").html(this.editForm.$el)},clearViews:function(){var e=this;_.each(this.views,function(s){s!==e.current&&s!==e.dashboardView&&s.remove()})},removeAll:function(){this.dashboardView.remove()},setUser:function(e,s){var i=this;this.user&&this.user.get("id")===e.get("id")||(this.user=e,this.user.fetch({success:function(){i.user.tasks.fetch({success:function(t){_.each(i.views,function(s){s.setUser&&s.setUser(e)}),s&&s(t)}})}}))},showDash:function(){this.dashboardView.$el.is(":visible")||(this.dashboardView.render(),$("body").html(this.dashboardView.$el))},initialize:function(e){e=e||{},this.dashboardView=new Tessitura.DashboardView,this.dashboardHomeView=new Tessitura.DashboardHomeView,this.dashboardTaskView=new Tessitura.DashboardTaskView,this.dashboardProfileView=new Tessitura.DashboardProfileView,this.views=[this.dashboardView,this.dashboardHomeView,this.dashboardTaskView,this.dashboardProfileView],e.user&&this.setUser(e.user),_.bindAll(this,"showDash","getHome","getTask","getProfile","setUser","emitRedirect","removeAll"),this.listenTo(this.dashboardView,"redirect",this.emitRedirect),this.listenTo(this.dashboardTaskView,"showEditForm",this.showTaskEditForm),this.listenTo(this.dashboardHomeView,"showEditForm",this.showTaskEditForm)}}),module.exports=Tessitura.DashboardPresenter;
...
Tessitura.DashboardView=Tessitura.View.extend({id:"dashboard-wrapper",template:JST.dashboard,events:{click:"hideDropdownMenus",dblclick:"hideSidebar","click .internal-link":"followLink","click .task-list-item .fa-pencil":"showEditForm"},emitRedirect:function(e){this.trigger("redirect",e)},followLink:function(e){var i=$(e.target).closest(".internal-link"),t=i.attr("data-target");this.emitRedirect({destination:t})},hideDropdownMenus:function(e){var i=this.$("li.dropdown");i.is(e.target)||i.has(e.target).length||i.removeClass("open")},hideSidebar:function(e){if(e)var i=$(e.target);i!==this.$("#side-menu")&&0===this.$(".navbar-static-side").has(i).length&&this.$("#side-menu").is(":visible")&&this.$(".sidebar-collapse").slideUp()},setUser:function(e){this.model=e,this.navView.setUser(e)},initialize:function(){this.navView=new Tessitura.DashboardNavView,this.childViews=[this.navView],this.model&&this.setUser(this.model)},render:function(){var e=this;return Tessitura.View.prototype.render.call(this,this.template(),function(){e.navView.render(),e.navView.$el.is(":visible")||e.$el.prepend(e.navView.$el)})}}),module.exports=Tessitura.DashboardView;
...
Tessitura.TaskEditFormView=Tessitura.View.extend({tagName:"form",id:"task-edit-form",template:JST["tasks/editForm"],setModel:function(e){return this.model=e,this},render:function(){return Tessitura.View.prototype.render.call(this,this.template({model:this.model}))}}),module.exports=Tessitura.TaskEditFormView;

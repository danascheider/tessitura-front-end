...
Tessitura.UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],events:{"dblclick span.p":"displayForm","keydown input":"triageKeypress","submit form":"submitUpdate"},displayForm:function(e){var t=e.target?$(e.target).attr("class")&&$(e.target).attr("class").match(/profile-field/)?$(e.target):$(e.target).closest(".profile-field"):$(e);t.find(".p").hide(),t.find(".form").show(),this.resizeInputs(t),t.find("form > input").focus().select()},submitUpdate:function(e){e.preventDefault();var t={},t=Tessitura.Utils.getAttributes($(e.target));this.model.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},error:function(e,t,s){console.log("Model: ",e),console.log("Response: ",t),console.log("Options: ",s)},success:function(s){if(t.username||t.password){var i=$.cookie(),o=$.cookie("auth");for(var a in i)$.removeCookie(a);var r=t.password||atob(o).split(":")[1];$.cookie("auth",btoa(s.get("username")+":"+r)),$.cookie("userID",s.get("id"))}$(e.target).closest("span.form").hide()}})},triageKeypress:function(e){var t=13===e.keyCode,s=9===e.keyCode,i=27===e.keyCode,o=$(e.target).attr("name"),a=encodeURIComponent($(e.target)[0].value);if(t&&(e.preventDefault(),this.hideInputs(),this.model.get(o)!==a&&""!==a&&$(e.target).closest("form").submit()),s){e.preventDefault();var r="first_name"===$(e.target).closest(".profile-field").attr("id")?this.$("#last_name"):$(e.target).closest("tr").next().find("td > span.profile-field");this.model.get(o)!==a&&""!==a&&$(e.target).closest("form").submit(),this.hideInputs(),this.displayForm(r)}i&&this.hideInputs()},updateDisplay:function(){var e=this;this.$(".profile-field").each(function(t,s){var i=$(s).attr("id"),o=e.model.get(i);$(s).find(".p").html(o||"N/A"),$(s).find("input").attr("value",o)})},hideInputs:function(){this.$("span.form").hide(),this.$("span.p").show()},resizeInputs:function(e){if(["first_name","last_name"].indexOf(e.attr("id"))>-1){var t=parseInt(e.find(".p").css("width").match(/\d*/)[0])+10;e.find("input").css("width",t+"px")}},initialize:function(){this.listenTo(this.model,"change",this.updateDisplay)},render:function(){var e=this;return Tessitura.View.prototype.render.call(e,e.template({model:e.model}))}}),module.exports=Tessitura.UserModelView;

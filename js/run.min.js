...
var UserModelView=Tessitura.View.extend({className:"user-model",template:JST["users/model"],klass:"UserModelView",family:"Tessitura.View",superFamily:"Backbone.View",types:function(){return Tessitura.View.prototype.types().concat(this.klass,"UserView","ModelView")},events:{"dblclick span.p":"displayInput","keydown input":"triageKeypress"},displayInput:function(e){var t=e.target?$(e.target).attr("class")&&$(e.target).attr("class").match(/profile-field/)?$(e.target):$(e.target).closest("span.profile-field"):e;t.find(".p").hide(),t.find(".input").show(),this.resizeInputs(t),t.find("input").focus().select()},submitUpdate:function(e){e.preventDefault();var t={};t[$(e.target).attr("name")]=$(e.target)[0].value,this.model.save(t,{beforeSend:function(e){e.setRequestHeader("Authorization","Basic "+$.cookie("auth"))},error:function(e,t,s){console.log(t)},success:function(){$(e.target).closest("span.input").hide()}})},triageKeypress:function(e){var t=13===e.keyCode,s=9===e.keyCode,i=$(e.target).attr("name"),a=$(e.target)[0].value;if(t&&(this.hideInputs(),a!==this.model.get(i)&&""!==a&&this.submitUpdate(e)),s){e.preventDefault();var n=$(e.target).closest("tr").next().find("td > span.profile-field");n="first_name"===$(e.target).closest(".profile-field").attr("id")?this.$("#last_name"):n,(a===this.model.get(i)||""===a)&&this.hideInputs(),(a===this.model.get(i)||""===a)&&this.hideInputs(),this.displayInput(n)}},hideInputs:function(){this.$("span.input").hide(),this.$("span.p").show()},resizeInputs:function(e){if(["first_name","last_name"].indexOf(e.attr("id"))>-1){var t=parseInt(e.find(".p").css("width").match(/\d*/)[0])+10;e.find("input").css("width",t+"px")}},initialize:function(){this.listenTo(this.model,"sync",this.render)},render:function(){var e=this;return Tessitura.View.prototype.render.call(e,e.template({model:e.model}))}});module.exports=UserModelView;

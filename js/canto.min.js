...
},{"../templates/jst.js":39,"../vendor/jquery-ui-1.11.4.custom/jquery-ui.min.js":63,"./api.js":5,"./utils.js":19,"backbone":35,"buffer":1,"jquery":37,"jquery.cookie":36,"underscore":38}],11:[function(require,module,exports){
...
},{"../../vendor/backbone-route-filter.js":62}],18:[function(require,module,exports){
var TestRouter=Canto.Router.extend({routes:{"listItemViewSpec(/)":"displayListItemView","dashboardHomeViewSpec(/)":"displayDashboardHomeView","dashboardSidebarViewSpec(/)":"displayDashboardSidebarView","dashboardTopWidgetViewSpec(/)":"displayDashboardTopWidgetView","dashboardViewSpec(/)":"displayDashboardView","homepageViewSpec(/)":"displayHomepageView","taskCollectionViewSpec(/)":"displayTaskCollectionView","taskPanelViewSpec(/)":"displayTaskPanelView"},displayListItemView:function(){view=new Canto.TaskListItemView,view.render()},displayDashboardHomeView:function(){view=new Canto.DashboardHomeView},displayDashboardSidebarView:function(){view=new Canto.DashboardSidebarView,view.render()},displayDashboardTopWidgetView:function(){view=new Canto.DashboardTopWidgetView},displayDashboardView:function(){view=new Canto.DashboardView,view.render()},displayHomepageView:function(){view=new Canto.HomepageView,view.render()},displayTaskCollectionView:function(){view=new Canto.TaskCollectionView,view.render()},displayTaskPanelView:function(){view=new Canto.TaskPanelView,view.render()}});module.exports=TestRouter;
...
var TaskCollectionView=Canto.View.extend({tagName:"ul",className:"task-list",template:JST["collections/task"],klass:"TaskCollectionView",family:"Canto.View",superFamily:"Backbone.View",types:function(){return Canto.View.prototype.types().concat(["TaskCollectionView","TaskView"])},crossOff:function(e){if("Complete"!==!e.get("status")){var i=this,t=this.retrieveViewForModel(e);t.$("a.task-title").css("text-decoration","line-through"),setTimeout(function(){var o=i.childViews.indexOf(t);i.collection.remove(e),i.childViews.splice(o,1)},750)}},fetchCollection:function(){this.collection.fetch()},removeBacklog:function(){var e=this.collection.where({backlog:"true"});this.collection.remove(e)},removeComplete:function(){var e=this.collection.where({status:"Complete"});this.collection.remove(e)},removeChildViews:function(){_.each(this.childViews,function(e){e.remove(),e.unbind()})},renderCollection:function(){var e=this;this.collection.each(function(i){var t=e.retrieveViewForModel(i)||new Canto.TaskListItemView({model:i});e.childViews.indexOf(t)<=-1&&e.childViews.push(t),t.render(),e.$el.append(t.$el)})},retrieveViewForModel:function(e){if(!this.childViews.length)return null;var i=_.filter(this.childViews,function(i){return i.model===e});return i[0]},initialize:function(e){e=e||{},this.grouping=e.grouping,this.childViews=[],this.quickAddForm=new Canto.QuickAddFormView({collection:this.collection,grouping:this.grouping}),this.listenTo(this.collection,"add fetch",this.render),this.listenTo(this.collection,"remove",this.removeChildAndRender),this.listenTo(this.collection,"change:status",this.crossOff)},remove:function(){this.removeChildViews(),Backbone.View.prototype.remove.call(this)},removeChildAndRender:function(e){var i=this.retrieveViewForModel(e),t=this.childViews.indexOf(i);this.childViews.splice(t,1),this.render()},render:function(){var e=this;return Canto.View.prototype.render.call(this,this.template(),function(){e.quickAddForm.render(),e.$("li.quick-add-form").html(e.quickAddForm.$el),e.renderCollection()})}});module.exports=TaskCollectionView;
...
},{"../../../models/taskModel.js":13}],25:[function(require,module,exports){
...
},{"./modelTemplates/taskTemplates/listItemTemplate.js":40,"./modelTemplates/taskTemplates/modelTemplate.js":41,"./modelTemplates/taskTemplates/quickAddFormTemplate.js":42,"./partialTemplates/dashboardHomeTemplate.js":43,"./partialTemplates/dashboardSidebarTemplate.js":44,"./partialTemplates/dashboardTaskTemplate.js":45,"./partialTemplates/dashboardTopWidgetTemplate.js":46,"./partialTemplates/kanbanColumnTemplate.js":47,"./partialTemplates/loginFormTemplate.js":48,"./partialTemplates/registrationFormTemplate.js":49,"./partialTemplates/taskPanelTemplate.js":50,"./specTemplates/dashboardHomeSpecTemplate.js":51,"./specTemplates/dashboardSidebarSpecTemplate.js":52,"./specTemplates/dashboardSpecTemplate.js":53,"./specTemplates/dashboardTaskSpecTemplate.js":54,"./specTemplates/dashboardTopWidgetSpecTemplate.js":55,"./specTemplates/homepageSpecTemplate.js":56,"./specTemplates/taskCollectionSpecTemplate.js":57,"./specTemplates/taskListItemSpecTemplate.js":58,"./specTemplates/taskPanelSpecTemplate.js":59,"./topLevelTemplates/dashboardTemplate.js":60,"./topLevelTemplates/homepageTemplate.js":61,"underscore":38}],40:[function(require,module,exports){
...
},{"backbone":35,"underscore":38}],63:[function(require,module,exports){
